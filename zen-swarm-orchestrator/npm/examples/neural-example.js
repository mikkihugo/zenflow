...
async function multiAgentExample() {
  ...
  const trainingResult = await manager.trainAgentNetwork(
    'researcher-001',
    trainingData,
  );
  ...
  const adaptationResult = await manager.fineTuneDuringExecution(
    'researcher-001',
    experienceData,
  );
