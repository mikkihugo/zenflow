...
export const __wbg_set_poolmetrics_memory_usage_mb: (
  a: number,
  b: number,
) => void;
...
export const agentmemorypool_deallocate_agent_memory: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const wasmneuralnetwork_randomize_weights: (
  a: number,
  b: number,
  c: number,
) => void;
export const wasmneuralnetwork_set_weights: (
  a: number,
  b: number,
  c: number,
) => void;
export const wasmneuralnetwork_get_weights: (a: number, b: number) => void;
export const wasmneuralnetwork_run: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const wasmagent_add_capability: (
  a: number,
  b: number,
  c: number,
) => void;
export const wasmagent_has_capability: (
  a: number,
  b: number,
  c: number,
) => number;
...
export const wasmswarmorchestrator_spawn: (
  a: number,
  b: number,
  c: number,
  d: number,
) => void;
export const wasmswarmorchestrator_orchestrate: (
  a: number,
  b: number,
  c: number,
) => number;
export const wasmswarmorchestrator_add_agent: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const wasmswarmorchestrator_get_status: (
  a: number,
  b: number,
  c: number,
) => void;
export const __wbg_wasmforecastingmodel_free: (a: number, b: number) => void;
export const wasmforecastingmodel_predict: (
  a: number,
  b: number,
  c: number,
  d: number,
) => void;
export const wasmforecastingmodel_get_model_type: (
  a: number,
  b: number,
) => void;
...
export const performancemonitor_record_load_time: (
  a: number,
  b: number,
) => void;
export const performancemonitor_record_spawn_time: (
  a: number,
  b: number,
) => void;
export const performancemonitor_update_memory_usage: (
  a: number,
  b: number,
) => void;
...
export const performancemonitor_meets_performance_targets: (
  a: number,
) => number;
...
export const optimizedagentspawner_get_performance_report: (
  a: number,
  b: number,
) => void;
export const optimizedagentspawner_get_active_agent_count: (
  a: number,
) => number;
export const optimizedagentspawner_is_within_memory_target: (
  a: number,
) => number;
