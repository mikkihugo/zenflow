...
async function runAllTests() {
  ...
  try {
    ...
    console.log('='.repeat(60));
    console.log(
      `Basic Tests:    ${results.basic.passed}/${results.basic.total} passed`,
    );
    console.log(
      `Coverage Tests: ${results.coverage.passed}/${results.coverage.total} passed`,
    );
    console.log('-'.repeat(60));
    console.log(
      `TOTAL:          ${results.overall.passed}/${results.overall.total} passed`,
    );
    console.log(
