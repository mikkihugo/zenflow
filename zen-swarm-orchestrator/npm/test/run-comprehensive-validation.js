...
async function main() {
  console.log('🚀 zen-swarm Comprehensive Validation');
  console.log('=====================================\n');
...
async function generateSummaryReport(finalReport) {
  const summary = `# zen-swarm Comprehensive Validation Summary
...
---
*Generated by zen-swarm Comprehensive Test Orchestrator*  
