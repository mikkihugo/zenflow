...
class PerformanceAnalyzer {
  ...
  async testInputValidation() {
    ...
    const invalidTests = [
      { cmd: 'npx zen-swarm neural train --iterations -5', expectError: true },
      {
        cmd: 'npx zen-swarm benchmark run --iterations 1000',
        expectError: true,
      },
      {
        cmd: 'npx zen-swarm neural patterns --pattern invalid',
        expectError: false,
      },
    ];
  ...
  async generateReport() {
    ...
    const report = `# zen-swarm v0.2.1 Performance Analysis Report
...
---
*Generated by zen-swarm Performance Analyzer v0.2.1*
`;
