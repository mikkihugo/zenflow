//! Orchestrator implementation using real zen-swarm-core with persistence
//!
//! This module provides a higher-level orchestration interface that wraps
//! the zen-swarm-core Swarm and provides real metrics and persistence.
...
impl SwarmOrchestrator {
    ...
    pub async fn new() -> Self {
        ...
        let db_path = std::env::var("RUV_SWARM_DB_PATH")
            .unwrap_or_else(|_| "zen-swarm-mcp.db".to_string());
