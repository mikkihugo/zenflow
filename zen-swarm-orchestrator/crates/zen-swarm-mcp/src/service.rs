...
impl ServerHandler for RealSwarmService {
    fn get_info(&self) -> ServerInfo {
        ServerInfo {
            instructions: Some("Zen Swarm orchestration for massive GPU agent coordination. Use 'spawn' to create agents, 'orchestrate' to run tasks, 'query' to check status.".into()),
