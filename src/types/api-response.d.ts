 ...
 */
export declare function isApiResponse(obj: unknown): obj is BaseApiResponse;
/**
 * Type guard for checking if response is successful
 */
export declare function isSuccessResponse<T>(response: BaseApiResponse<T>): response is SuccessResponse<T>;
/**
 * Type guard for checking if response is an error
 */
export declare function isErrorResponse(response: BaseApiResponse): response is ErrorResponse;
