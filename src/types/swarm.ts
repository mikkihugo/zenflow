...
export interface SwarmEvents {
  ...
  // Agent events
  'agent-joined': (swarmId = > void;
  'agent-left': (swarmId = > void;
  'agent-assigned': (swarmId = > void;
  'agent-completed': (swarmId = > void;
  'agent-failed': (swarmId = > void;
  
  // Task events
  'task-created': (swarmId = > void;
  'task-queued': (swarmId = > void;
  'task-scheduled': (swarmId = > void;
  'task-started': (swarmId = > void;
  'task-progress': (swarmId = > void;
  'task-completed': (swarmId = > void;
  'task-failed': (swarmId = > void;
  'task-timeout': (swarmId = > void;
  'task-cancelled': (swarmId = > void;
  
  // Coordination events
  'coordination-started': (swarmId = > void;
  'coordination-changed': (swarmId = > void;
  'bottleneck-detected': (swarmId = > void;
  'optimization-triggered': (swarmId = > void;
  'scaling-triggered': (swarmId = > void;
  
  // Quality events
  'quality-check': (swarmId = > void;
  'review-completed': (swarmId = > void;
  'test-completed': (swarmId = > void;
  
  // Performance events
  'milestone-reached': (swarmId = > void;
  'performance-warning': (swarmId = > void;
  'resource-exhausted': (swarmId = > void;
  'sla-violated': (swarmId = > void;
  
  // Learning events
  'pattern-discovered': (swarmId = > void;
  'knowledge-shared': (swarmId = > void;
  'adaptation-triggered': (swarmId = > void;
  'improvement-identified': (swarmId = > void;
  [event = > void;
}
