...
protected
getDatabaseType();
: 'relational' | 'graph' | 'vector' | 'memory' | 'coordination'
{
  return 'coordination';
}
...
private
extractResourceIds(operations: TransactionOperation[])
: string[]
{
...
private
calculateAverageLockDuration(locks: CoordinationLock[])
: number
{
