...
export class GraphDao<T> extends BaseDao<T> implements IGraphDao<T> {
  ...
  async findRelationships(
    ...
    this.logger.debug(`Finding relationships between nodes: ${fromNodeId} -> ${toNodeId}`, { relationshipType });
   ...
   */
  async getNodeDegree(nodeId: string | number, direction: 'in' | 'out' | 'both' = 'both'): Promise<number> {
