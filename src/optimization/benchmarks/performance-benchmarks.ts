...
export class PerformanceBenchmarkSuite {
  ...
  constructor(
    ...
    this.swarmOptimizer =
      optimizers.swarm === undefined ? undefined : optimizers.swarm;
    this.dataOptimizer =
      optimizers.data === undefined ? undefined : optimizers.data;
    this.wasmOptimizer =
      optimizers.wasm === undefined ? undefined : optimizers.wasm;
  }
