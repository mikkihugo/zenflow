...
import { ConversationMemoryFactory } from './memory.js';
import {
  ConversationConfig,
  ConversationMessage,
  MessageType,
    ...
    return [
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            domain: { type: 'string', description: 'Domain context (e.g., backend, frontend, devops)' },
            participants: {
              type: 'array',
              items: {
                type: 'object',
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            messageType: {
              type: 'string',
              enum: ['task_request', 'task_response', 'question', 'answer', 'suggestion', 'critique', 'agreement', 'disagreement', 'clarification', 'summary', 'decision'],
            ...
            requiresResponse: { type: 'boolean', default: false, description: 'Whether message requires a response' },
            tags: {
              type: 'array',
              items: { type: 'string' },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            startDate: { type: 'string', format: 'date-time', description: 'Start date for date range filter' },
            endDate: { type: 'string', format: 'date-time', description: 'End date for date range filter' },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            duration: { type: 'number', description: 'Duration in milliseconds (for temporary actions)' }
          },
