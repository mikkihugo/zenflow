...
async function manageHierarchy(subArgs, flags) {
  ...
  switch (hierarchyCmd) {
    ...
    default:
      ...
      console.log('  claude-zen agent hierarchy create enterprise');
      console.log('  claude-zen agent hierarchy show');
  }
}
...
function showAgentHelp() {
  ...
  console.log();
  console.log('Examples:');
  console.log('  claude-zen agent spawn researcher --name "DataBot"');
  console.log('  claude-zen agent list --verbose');
  console.log('  claude-zen agent hierarchy create enterprise');
  console.log('  claude-zen agent ecosystem status');
}
