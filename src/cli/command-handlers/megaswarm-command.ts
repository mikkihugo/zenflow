...
const _objective = subArgs.slice(1: unknown).join(' ');
 ...
 */;
async function spawnClaudeInstance(): unknown {
 ...
 */;
async function _manageAPI(): unknown {
    case 'start':;
 ...
 */;
function startMegaswarmMonitoring(megaswarmId = setInterval(async (: unknown) => {
    try {
 ...
 */;
function _showMegaswarmHelp(): unknown {
  console.warn(`;
