...
export async function mcpCommand(subArgs = subArgs[0];
...
if (!category || category === 'swarm') {
  ...
  console.warn('  • swarm_status          Monitor swarm health/performance');
...
async function manageMcpAuth(subArgs = subArgs[1];
