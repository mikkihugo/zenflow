...
async function createInteractiveConfig(outputFile) {
  ...
  try {
    ...
    console.log(`4. Run: claude-zen init --config ${outputFile}`);
  } catch (error) {
...
function showBatchManagerHelp() {
  ...
  console.log('USAGE:');
  console.log('  claude-zen batch <command> [options]\n');
  ...
  console.log('  claude-zen batch create-config my-batch.json');
  console.log('  claude-zen batch create-config --interactive');
  console.log('  claude-zen batch validate-config my-batch.json');
  console.log('  claude-zen batch estimate my-batch.json');
  console.log('  claude-zen batch list-templates');
  console.log('  claude-zen batch list-environments\n');

  console.log('INTEGRATION:');
  console.log('  Use created configs with: claude-zen init --config <file>');
  console.log('  Or batch init directly: claude-zen init --batch-init project1,project2');
}
