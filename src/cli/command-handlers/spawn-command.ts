...
if (isAvailable) {
  try {
      ...
      const _spawnResult = await callRuvSwarmLibrary('agent_spawn', {type = > setTimeout(resolve, 800));
  ...
  function displayCoordinatedAgentDetails(agentType = {
      coordinator: any, agentName: any, swarmId: any, spawnResult: any, flags: any): any {
 ...
 */
function getAgentCapabilities(_type: any): any {
