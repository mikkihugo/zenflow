...
describe('Claude-Flow CLI', () => {
  ...
  describe('Help output', () => {
    test('should show help when no arguments provided', async () => {
      ...
      const output = consoleLogSpy.mock.calls.join('\n');      expect(output).toContain('Claude-Flow v2.0.0');      expect(output).toContain('USAGE');    });    test('should show help for --help flag', async () => {
  ...
  describe('Command execution', () => {
    ...
    test('should parse boolean flags correctly', () => {
      let flags = parseFlags(['--force', '--verbose']);
