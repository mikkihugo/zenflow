...
jest.mock('../simple-commands/init.js', () => ({ initCommand: jest.fn() }));
jest.mock('../simple-commands/memory.js', () => ({ memoryCommand: jest.fn() }));
jest.mock('../simple-commands/agent.js', () => ({ agentCommand: jest.fn() }));
jest.mock('../simple-commands/task.js', () => ({ taskCommand: jest.fn() }));
jest.mock('../simple-commands/swarm.js', () => ({ swarmCommand: jest.fn() }));
jest.mock('../simple-commands/config.js', () => ({ configCommand: jest.fn() }));
