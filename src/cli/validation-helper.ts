...
export class ValidationHelper {
   ...
   */
  static validateEnum(value, paramName, validOptions, commandPath): any {
   ...
   */
  static validateNumber(value, paramName, min, max, commandPath): any {
    ...
    if(min !== undefined && num < min) {
      ...
      console.error(
        HelpFormatter.formatError(
          `${paramName} must be at most ${max}.Got = === 'string' && value.trim() === '')) 
      console.error(
        HelpFormatter.formatError(
   ...
   */
  static validateBoolean(value, paramName, commandPath): any {
