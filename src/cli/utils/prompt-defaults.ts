...
this.environmentDefaults = new Map<string, any>();
this.loadConfig();
...
else
{
   ...
   */
  public exportConfig(): PromptDefaultsConfig
{
...
this.saveConfig();
   ...
   */
  public clearDefaults(scope?: string, target?: string): void
{
 ...
 */
export function getPromptDefaultsManager(configPath?): PromptDefaultsManager {
  if (!instance) {
 ...
 * @param options - Configuration options
 */
export function setPromptDefault(promptId = {}): void {
