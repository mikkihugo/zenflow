...
class ConfigurationManager {
  ...
  getConfigPath() {
    ...
    const possiblePaths = [
      ...
      path.join(process.cwd(), '.claude-flow.json'),
      path.join(process.cwd(), 'claude-flow.config.json'),
      path.join(os.homedir(), '.config', 'claude-flow', 'config.json'),
      path.join(os.homedir(), '.claude-flow.json')
    ].filter(Boolean);
    ...
    const defaultPath = path.join(os.homedir(), '.config', 'claude-flow', 'config.json');
