...
🚀 INSTALLATION & ENTERPRISE SETUP:
  npx claude-flow@2.0.0 init  # Enterprise + ruv-swarm integration
...
Use the claude-flow workflow commands to leverage this environment:

\`\`\`bash
# List available modes
claude-flow workflow modes

# Run specific mode
claude-flow workflow run code "implement user authentication"

# Execute full TDD workflow  
claude-flow workflow tdd "payment processing system"

# Use custom workflow
claude-flow workflow execute .roo/workflows/basic-tdd.json
\`\`\`
...
## Project Overview
This project uses systematic workflow methodology for Test-Driven Development with AI assistance through Claude-Flow orchestration.

## Workflow Development Commands

### Core Workflow Commands
- \`npx claude-flow workflow modes\`: List all available workflow development modes
- \`npx claude-flow workflow run <mode> "<task>"\`: Execute specific workflow mode for a task
- \`npx claude-flow workflow tdd "<feature>"\`: Run complete TDD workflow
- \`npx claude-flow workflow info <mode>\`: Get detailed information about a specific mode
...
npx claude-flow workflow run planning "Define user authentication requirements"
\`\`\`
...
npx claude-flow workflow run architect "Design authentication service architecture"
\`\`\`
...
npx claude-flow workflow tdd "implement user authentication system"
\`\`\`
...
npx claude-flow workflow run integration "integrate authentication with user management"
\`\`\`
