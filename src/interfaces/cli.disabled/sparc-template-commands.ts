...
import type { ProjectSpecification } from '../../coordination/swarm/sparc/types/sparc-types.ts';
 ...
 * @example
 */
function formatSpecificationAsMarkdown(specification: unknown): string {
