...
export const monitoringTools: AdvancedMCPTool[] = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        metric: {
          type: 'string',
          enum: ['performance', 'resource', 'task', 'all'],
          default: 'all',
        },
  ...
  },
  {
    ...
    version: '2.0.0',
    permissions: [
      { type: 'read', resource: 'system' },
      { type: 'execute', resource: 'diagnostics' },
    ],
    priority: 'high',
    metadata: {
      author: 'claude-zen',
    ...
    inputSchema: {
      ...
      properties: {
        component: {
          type: 'string',
          enum: ['swarm', 'agents', 'resources', 'network', 'all'],
          default: 'all',
        },
        checkType: {
          type: 'string',
  ...
  },
  {
    ...
    handler: async (params) => ({
      success: true,
      data: { action: params.action, alerts: 5, active: 2, resolved: 3 },
    }),
  },
  {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        errorType: {
          type: 'string',
          enum: ['all', 'critical', 'runtime', 'network'],
          default: 'all',
        },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        ml_model: {
          type: 'string',
          enum: ['isolation-forest', 'one-class-svm', 'lstm'],
    ...
    handler: async (params) => ({
      success: true,
      data: { anomalies: 3, severity: 'medium', confidence: 95, model: params.ml_model },
    }),
  },
];
