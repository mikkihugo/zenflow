...
import { createDefaultDataServiceAdapterConfig, DataServiceAdapter } from '../data-service-adapter';
...
describe('DataServiceAdapter', () => {
  ...
  describe('Error Handling and Retry Logic (London TDD)', () => {
    ...
    it('should retry failed operations according to configuration', async () => {
      // Arrange
      mockWebDataService?.getSystemStatus?.mockRejectedValueOnce(new Error('Temporary failure'))
