...
export const TerminalApp: React.FC<TerminalAppProps> = ({ commands, flags, onExit }) => {
  ...
  const generateHelpContent = () => {
    ...
    return {
      ...
      description: 'Intelligent project scaffolding, real-time swarm coordination, and automated development workflows',
      ...
      examples: [
        {
          ...
          command: 'claude-zen create my-project --type=neural-ai --complexity=enterprise --ai-features=all'
        },
        {
          description: 'Monitor swarm execution with real-time dashboard',
          command: 'claude-zen swarm monitor --real-time --interactive-dashboard --performance-metrics'
        },
        {
          description: 'Generate optimized code from specification',
          command: 'claude-zen generate from-spec api-requirements.yaml --optimize-performance --add-tests'
        },
        {
