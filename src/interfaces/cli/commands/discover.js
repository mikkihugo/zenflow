...
var DiscoverCommand = /** @class */ (function () {
    ...
    DiscoverCommand.prototype.execute = function (projectPath, options) {
        return __awaiter(this, void 0, void 0, function () {
            var resolvedPath, confidence, maxIterations, maxAgents, projectAnalyzer, projectContext, documentSystem, domainBridge, discoveredDomains, memoryStore, agui, confidenceBuilder, confidenceResult, swarmCoordinator, hiveSync, swarmFactory, swarmConfigs, _i, swarmConfigs_1, config, duration, error_1;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        this.stats.documentsProcessed = ((_a = projectContext.documents) === null || _a === void 0 ? void 0 : _a.length) || 0;
                        logger.info("\u2705 Analyzed project: ".concat(projectContext.name || 'Unknown'));
                        if (projectContext.isMonorepo) {
                            logger.info("\uD83D\uDCE6 Detected monorepo with ".concat(((_b = projectContext.packages) === null || _b === void 0 ? void 0 : _b.length) || 0, " packages"));
                        }
                    ...
                    case 3:
                        ...
                        domainBridge = new domain_discovery_bridge_1.DomainDiscoveryBridge(documentSystem, {}, // DomainAnalysisEngine - will be mocked for now
                        projectAnalyzer);
                    ...
                    case 4:
                        ...
                        logger.info("\u2705 Discovered ".concat(discoveredDomains.length, " potential domains"));
                        if (discoveredDomains.length === 0) {
                            logger.warn('⚠️  No domains discovered. Try analyzing a larger codebase or adjusting sensitivity.');
                            return [2 /*return*/];
                        }
                    ...
                    case 5:
                        ...
                        memoryStore = new memory_1.SessionMemoryStore({
                            backendConfig: { type: 'json', path: "".concat(resolvedPath, "/.claude-zen/memory.json") },
                        });
                        return [4 /*yield*/, memoryStore.initialize()];
                    case 6:
                        _c.sent();
                        agui = (0, agui_adapter_1.createAGUI)(options.skipValidation ? 'mock' : 'terminal');
                        confidenceBuilder = new progressive_confidence_builder_1.ProgressiveConfidenceBuilder(domainBridge, memoryStore, agui, {
                        ...
                        confidenceBuilder.on('progress', function (event) {
                            if (options.verbose) {
                                logger.info("\uD83D\uDCCA Iteration ".concat(event.iteration, ": ").concat((event.confidence * 100).toFixed(1), "% confidence"));
                            }
                        });
                        return [4 /*yield*/, confidenceBuilder.buildConfidence({
                                projectPath: resolvedPath,
                                existingDomains: discoveredDomains.map(function (d) { return ({
                                    name: d.name,
                                    path: d.path,
                                    files: d.files || [],
                    ...
                    case 7:
                        ...
                        logger.info("\u2705 Built confidence: ".concat((confidenceResult.confidence.overall * 100).toFixed(1), "%"));
                        logger.info("\uD83D\uDCCB Validated domains: ".concat(confidenceResult.domains.size));
                        if (confidenceResult.domains.size === 0) {
                            logger.warn('⚠️  No confident domains found. Consider lowering confidence threshold or adding more documentation.');
                            return [2 /*return*/];
                        }
                    ...
                    case 9:
                        ...
                        swarmFactory = new auto_swarm_factory_1.AutoSwarmFactory(swarmCoordinator, hiveSync, memoryStore, agui, {
                        ...
                        swarmFactory.on('swarm:created', function (event) {
                            if (options.verbose) {
                                logger.info("\uD83D\uDC1D Created swarm for ".concat(event.domain, ": ").concat(event.config.topology.type, " topology"));
                            }
                        });
                    ...
                    case 10:
                        ...
                        this.stats.agentsDeployed = swarmConfigs.reduce(function (sum, config) {
                            return sum + config.agents.reduce(function (agentSum, agent) { return agentSum + agent.count; }, 0);
                        }, 0);
                        logger.info("\u2705 Created ".concat(swarmConfigs.length, " swarms with ").concat(this.stats.agentsDeployed, " total agents"));
                        // Show swarm details
                        if (options.verbose) {
                    ...
                    case 14:
                        ...
                        logger.info("\uD83C\uDF89 Auto-discovery completed in ".concat(duration.toFixed(2), "s"));
                        return [3 /*break*/, 16];
                    case 15:
                        error_1 = _c.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var waitUntilExit = (0, ink_1.render)(react_1.default.createElement(tui_1.InteractiveDiscoveryTUI, {
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        summary = {
                            ...
                            deployedSwarms: Array.from(((_a = results.deploymentStatus) === null || _a === void 0 ? void 0 : _a.entries()) || []).map(function (_a) {
                                var domain = _a[0], status = _a[1];
                                return ({
                                    domain: domain,
                            ...
                            configurations: Array.from(((_b = results.swarmConfigs) === null || _b === void 0 ? void 0 : _b.entries()) || []).map(function (_a) {
                                var domain = _a[0], config = _a[1];
                                return ({
                                    domain: domain,
    ...
    DiscoverCommand.prototype.generateInteractiveMarkdownReport = function (results) {
        return "# Interactive Discovery Results\n\n## Summary\n- **Timestamp**: ".concat(results.timestamp, "\n- **Selected Domains**: ").concat(results.selectedDomains.length, "\n- **Deployed Swarms**: ").concat(results.deployedSwarms.length, "\n\n## Selected Domains\n").concat(results.selectedDomains.map(function (domain) { return "- ".concat(domain); }).join('\n'), "\n\n## Deployed Swarms\n").concat(results.deployedSwarms
            .map(function (swarm) { return "\n### ".concat(swarm.domain, "\n- **Status**: ").concat(swarm.status, "\n- **Agents**: ").concat(swarm.agents, "\n- **Message**: ").concat(swarm.message, "\n"); })
            .join('\n'), "\n\n## Configurations\n").concat(results.configurations
            .map(function (config) { return "\n### ".concat(config.domain, "\n- **Topology**: ").concat(config.topology, "\n- **Max Agents**: ").concat(config.maxAgents, "\n- **Memory**: ").concat(config.resources.memory, "\n- **CPU**: ").concat(config.resources.cpu, "\n- **Persistence**: ").concat(config.persistence, "\n"); })
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        results = {
                            summary: {
                                ...
                                finalConfidence: "".concat((confidenceResult.confidence.overall * 100).toFixed(1), "%"),
                            ...
                            relationships: confidenceResult.relationships.map(function (rel) { return ({
                    ...
                    case 2: return [4 /*yield*/, this.showMarkdownResults(results)];
                    case 3:
                        _b.sent();
                        return [3 /*break*/, 6];
                    case 4: // console
                    ...
                    case 10:
                        content = JSON.stringify(results, null, 2);
                        _b.label = 11;
                    case 11: return [4 /*yield*/, fs.writeFile(outputPath, content, 'utf-8')];
                    case 12:
                        _b.sent();
    ...
    DiscoverCommand.prototype.showMarkdownResults = function (results) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.generateMarkdownReport(results)];
                    case 1:
                        _markdown = _a.sent();
                        return [2 /*return*/];
                }
    ...
    DiscoverCommand.prototype.generateMarkdownReport = function (results) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, "# Auto-Discovery Results\n\n## Summary\n- **Duration**: ".concat(summary.duration, "\n- **Domains Discovered**: ").concat(summary.domainsDiscovered, "\n- **Confident Domains**: ").concat(summary.confidenceDomains, "\n- **Final Confidence**: ").concat(summary.finalConfidence, "\n- **Swarms Created**: ").concat(summary.swarmsCreated, "\n- **Agents Deployed**: ").concat(summary.agentsDeployed, "\n- **Human Validations**: ").concat(summary.validationsPerformed, "\n- **Research Queries**: ").concat(summary.researchQueries, "\n\n## Discovered Domains\n\n").concat(results.domains
                        .map(function (domain) { return "### ".concat(domain.name, "\n- **Path**: `").concat(domain.path, "`\n- **Confidence**: ").concat(domain.confidence, "\n- **Files**: ").concat(domain.files, "\n- **Concepts**: ").concat(domain.concepts.join(', '), "\n- **Technologies**: ").concat(domain.technologies.join(', '), "\n- **Validations**: ").concat(domain.validations, "\n- **Research**: ").concat(domain.research, "\n"); })
                        .join('\n'), "\n\n## Domain Relationships\n\n").concat(results.relationships
                        .map(function (rel) {
                        return "- **".concat(rel.from, "** ").concat(rel.type, " **").concat(rel.to, "** (").concat(rel.confidence, ")\n  - Evidence: ").concat(rel.evidence);
                    })
                        .join('\n'), "\n\n## Confidence Metrics\n\n").concat(results.confidenceMetrics
                        .map(function (metric) { return "- **".concat(metric.metric, "**: ").concat(metric.score); })
                        .join('\n'), "\n\n## Next Steps\n\n").concat(summary.swarmsCreated > 0
