...
describe('DI System Comprehensive Integration', () => {
  ...
  describe('Core DI Container Functionality', () => {
    ...
    it('should register and resolve transient services', () => {
      ...
      // Act
      container.register(TEST_TOKEN, new TransientProvider(() => ({
        id: `instance-${++counter}`
      })));
    ...
    it('should handle scoped services correctly', () => {
      ...
      container.register(TEST_TOKEN, new ScopedProvider(() => ({
  ...
  describe('Decorator-Based Injection', () => {
    it('should inject dependencies using decorators', () => {
      ...
      container.register(createToken<TestService>('TestService'), 
        new SingletonProvider(c => new TestService(c.resolve(LOGGER_TOKEN))));
  ...
  describe('Domain-Specific Token Integration', () => {
    ...
    it('should support swarm domain tokens', () => {
      ...
      // Act
      container.register(SWARM_TOKENS.SwarmCoordinator, new SingletonProvider(() => mockSwarmCoordinator));
      container.register(SWARM_TOKENS.AgentRegistry, new SingletonProvider(() => mockAgentRegistry));
  ...
  describe('Performance and Scalability', () => {
    ...
    it('should handle concurrent resolutions safely', async () => {
      ...
      container.register(TEST_TOKEN, new SingletonProvider(() => ({
        id: ++creationCount
      })));
