...
export class RealFannEngine {
     ...
     */
    postprocessInference(inferenceResult, prompt, modelName): any {
    ...
    async loadNativeBindings() 
        try {
            ...
            {name = this.nativeBinding.createNetwork(
                ...
                networkHandle = {id = 'code-completion', options = {}): any {
    ...
    postprocessOutput(outputVector, prompt, modelName): any {
    ...
    generateGenericCode(prompt): any {
