...
class WasmModuleLoader {
    ...
    switch (moduleName) {
      case 'neural':
        return {
          ...baseImports,
          neural: {
            log_training_progress: (_epoch, _loss) => {},
          },
        };
      case 'forecasting':
        return {
  ...
  createPlaceholderModule(moduleName) {
    ...
    const placeholderExports = {
      ...
      __wbindgen_malloc: (_size) => 0,
      __wbindgen_realloc: (ptr, _oldSize, _newSize) => ptr,
      __wbindgen_free: (_ptr, _size) => {},
    };
