...
export interface WASMNeuralAccelerator {
    ...
    trainModel(modelId: string, trainingData: WASMTrainingData, options?: WASMOptimizationOptions): Promise<WASMPerformanceMetrics>;
...
export type ActivationFunction = 'sigmoid' | 'tanh' | 'relu' | 'leaky_relu' | 'elu' | 'swish' | 'gelu' | 'softmax';
...
//# sourceMappingURL=wasm-types.d.ts.map