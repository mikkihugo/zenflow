  ...
  router.get(
    ...
    asyncHandler(async (req: Request, res: Response) => {
      ...
      const result = {
        ...
        layers: [
          { type: 'input' as const, size: 784, activation: 'linear' as const },
          { type: 'hidden' as const, size: 128, activation: 'relu' as const },
          { type: 'hidden' as const, size: 64, activation: 'relu' as const },
          { type: 'output' as const, size: 10, activation: 'softmax' as const },
        ],
        accuracy: 0.95,
