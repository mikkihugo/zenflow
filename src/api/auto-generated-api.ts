 ...
 */
private
handleWebSocketMessage(ws: WebSocket, message: unknown)
: void
{
  switch (message.type) {
    case 'subscribe':
 ...
 */
private
handleSubscribe(ws: WebSocket, message: unknown)
: void
{
 ...
 */
private
handleUnsubscribe(ws: WebSocket, message: unknown)
: void
{
  const { channel } = message;
...
private
async
handleWebSocketExecute(ws: WebSocket, message: unknown)
: Promise<void>
{
...
private
async
executeCommand(session: CommandExecutionSession, ws?: WebSocket)
: Promise<void>
{
  try {
