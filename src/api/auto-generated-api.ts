...
: Promise<void>
{
  ...
  // API documentation
  this.app.get('/docs', (_req, res: Response) =>
    res.json(
...
// Commands list
this.app.get('/api/commands', (_req, res: Response) =>
{
  res.json({
...
// Execute command
this.app.post('/api/execute', async (req, res: Response) =>
{
  try {
...
this.app.get('/api/status/:sessionId', (req, res: Response) =>
{
...
// Metrics endpoint
this.app.get('/api/metrics', (_req, res: Response) =>
{
  res.json({
..this.metrics,
  uptime: Date.now() - this.metrics.uptime,
 ...
 */
private
handleWebSocketMessage(ws, message: unknown)
: void
{
  switch (message.type) {
    case 'subscribe': null
 ...
 */
private
handleSubscribe(ws, message: unknown)
: void
{
 ...
 */
private
handleUnsubscribe(ws, message: unknown)
: void
{
  const { channel } = message;
...
private
async
handleWebSocketExecute(ws, message: unknown)
: Promise<void>
{
...
private
async
executeCommand(session, ws?: WebSocket)
: Promise<void>
{
  try {
 ...
 */
private
removeWebSocketSubscriptions(ws: WebSocket)
: void
{
