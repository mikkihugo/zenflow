...
import { type TypeSchema } from '../../core/domain-boundary-validator';
...
export declare class WorkflowGateRequestProcessor extends EventEmitter {
     ...
     */
    createWorkflowGateRequest(workflowId: string, stepName: string, gateType: WorkflowGateRequest['gateType'], question: string, context: unknown, workflowContext: Partial<WorkflowContext>, options?: {
    ...
    private executeConditionOperator;
    ...
    private evaluateEmpty;
    private evaluateIn;
    private evaluateBetween;
    private evaluateTypeIs;
 ...
 */
export declare function createCheckpointGate(workflowId: string, stepName: string, checkpointData: unknown, options?: {
 ...
 */
export declare function createEmergencyGate(workflowId: string, stepName: string, emergencyContext: unknown, stakeholders: string[]): WorkflowGateRequest;
