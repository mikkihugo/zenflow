 ...
 */
import type { AgentId, AgentMetrics, AgentStatus, AgentType } from './types/interfaces';
...
export interface CubeInfo {
    id: string;
    name: string;
    type: 'OPS-CUBE' | 'DEV-CUBE' | 'RESEARCH-CUBE' | 'SECURITY-CUBE' | 'DATA-CUBE';
    matron: string;
    queens: string[];
...
export interface CubePerformanceMetrics {
    ...
    efficiency: number;
    borgRating: 'optimal' | 'acceptable' | 'inefficient' | 'requires-assimilation';
}
...
//# sourceMappingURL=collective-types.d.ts.map