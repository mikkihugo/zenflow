...
import { SwarmDatabaseManager, type SwarmDatabaseConfig } from './swarm-database-manager.js';
import { SwarmMaintenanceManager, type MaintenanceConfig } from './swarm-maintenance.js';
import { SwarmBackupManager, type BackupConfig } from './backup-manager.js';
...
export function registerSwarmProviders(
  ...
  container.register(SWARM_TOKENS.DatabaseManager, {
    type: 'singleton',
    create: (container) => new SwarmDatabaseManager(
  ...
  container.register(SWARM_TOKENS.MaintenanceManager, {
    type: 'singleton',
    create: (container) => new SwarmMaintenanceManager(
      {
  ...
  container.register(SWARM_TOKENS.BackupManager, {
    type: 'singleton',
    create: (container) => new SwarmBackupManager(
      {
        ...defaultBackupConfig,
        ...customConfig?.backup
      },
