 ...
 */
import type { SPARCTemplate } from '../types/sparc-types';
export declare const SWARM_COORDINATION_TEMPLATE: SPARCTemplate;
//# sourceMappingURL=swarm-coordination-template.d.ts.map