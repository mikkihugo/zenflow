...
export const CLAUDE_FLOW_AGENTS: Record<string, string[]> = {
  'Core Development': [
    ...
    'tester', 'architect', 'debug', 'specialist'
  ],
  'Swarm Coordination': [
    'adaptive-coordinator', 'hierarchical-coordinator', 
    'mesh-coordinator', 'memory-coordinator', 
    'orchestrator-task', 'collective-intelligence-coordinator'
  ],
  'Consensus & Distributed': [
    'consensus-builder', 'quorum-manager', 
    'raft-manager', 'byzantine-coordinator', 'gossip-coordinator'
  ],
  'Performance & Optimization': [
    'cache-optimizer', 'memory-manager', 
    'latency-reducer', 'performance-analyzer'
  ],
  'GitHub & Repository': [
    'github-pr-manager', 'code-review-swarm', 'issue-tracker',
    'release-manager', 'repo-architect', 'workflow-automation',
    'pr-manager', 'sync-coordinator'
  ],
  'SPARC Methodology': [
    'specification', 'architecture', 'refinement', 
    'pseudocode', 'sparc-coordinator', 'implementer-sparc-coder',
    'quality-gate-agent'
  ],
  'Specialized Development': [
    'ui-ux-designer', 'data-scientist', 'mobile-developer',
    'cloud-architect', 'frontend-dev', 'backend-dev',
    'fullstack-dev', 'api-dev'
  ],
  'Testing & Validation': [
    'unit-tester', 'integration-tester', 'e2e-tester',
    'performance-tester', 'production-validator'
  ],
  'Migration & Planning': [
    'migration-planner', 'legacy-analyzer', 'modernization-agent'
  ]
};
...
export const OUR_AGENT_CATEGORIES: Record<string, AgentType[]> = {
  'Core Foundation': [
    'coder', 'analyst', 'researcher', 'coordinator', 'tester', 
    'architect', 'debug', 'queen', 'specialist', 'reviewer', 
    'optimizer', 'documenter', 'monitor', 'planner'
  ],
  'Development Agents': [
  ...
  'Architecture Agents': [
    'arch-system-design', 'database-architect', 
    'cloud-architect', 'security-architect'
  ],
  'DevOps Agents': [
    'ops-cicd-github', 'infrastructure-ops', 
    'monitoring-ops', 'deployment-ops'
  ],
  'Documentation Agents': [
    'docs-api-openapi', 'user-guide-writer', 
    'technical-writer', 'readme-writer'
  ],
  'Analysis Agents': [
    'analyze-code-quality', 'performance-analyzer', 
    'security-analyzer', 'refactoring-analyzer'
  ],
  'Data Agents': [
    'data-ml-model', 'etl-specialist', 
    'analytics-specialist', 'visualization-specialist'
  ],
  'Specialized Agents': [
    'spec-mobile-react-native', 'embedded-specialist', 
    'blockchain-specialist', 'ai-ml-specialist'
  ],
  'UI/UX Enhancement': [
  ...
  'Swarm Coordination': [
    'adaptive-coordinator', 'hierarchical-coordinator', 
    'mesh-coordinator', 'coordinator-swarm-init', 
    'orchestrator-task', 'memory-coordinator', 
  ...
  'Performance & Optimization': [
    ...
    'resource-allocator', 'topology-optimizer', 'cache-optimizer',
    'memory-optimizer', 'latency-optimizer', 'bottleneck-analyzer'
  ],
  'SPARC Methodology': [
    'specification', 'architecture', 'refinement', 'pseudocode', 
    'sparc-coordinator', 'implementer-sparc-coder', 
    'quality-gate-agent', 'validation-specialist'
  ],
  'Migration & Planning': [
    'automation-smart-agent', 'base-template-generator', 
    'migration-plan', 'legacy-analyzer', 'modernization-agent', 
...
export function performGapAnalysis(): GapAnalysisResult {
  ...
  const ourAgentCount = Object.values(OUR_AGENT_CATEGORIES)
    .flat()
    .filter((agent, index, array) => array.indexOf(agent) === index) // Remove duplicates
    .length;
