...
import type { EventListener, SystemEvent } from '../interfaces/events/core/interfaces';
...
export type EventMiddleware = (event: string | symbol, payload: unknown, next: () => void) => void;
 ...
 * @example
 */
export declare class EventBus extends EventEmitter implements EventBus {
