...
// Mock data
const mockProjects = [
  { id: 'proj-1', name: 'Claude Code Zen', description: 'AI-powered swarm coordination', status: 'active' },
  { id: 'proj-2', name: 'Neural Analytics', description: 'Advanced neural processing', status: 'development' }
];
...
// Health endpoint
app.get('/api/v1/coordination/health', (req, res) => {
  res.json({
    status: 'healthy',
...
// Projects endpoints
app.get('/api/v1/coordination/projects', (req, res) => {
  res.json({
...
// Agents endpoints
app.get('/api/v1/coordination/agents', (req, res) => {
  res.json({
    agents: mockAgents,
...
// Tasks endpoints
app.get('/api/v1/coordination/tasks', (req, res) => {
  res.json({
    tasks: mockTasks,
