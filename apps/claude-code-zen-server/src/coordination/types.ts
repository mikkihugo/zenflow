...
// This prevents "Type"X is not assignable" "rrors in coordination domain
...
export interface AgentState {
  ...
  lastUpdate: Date;
  health: 'healthy' | 'degraded' | 'error' | numbe';
  lastHeartbeat?: Date;
...
}; environment?: AgentEnvironment; config?: AgentConfig; workload?: number; errorHistory?: AgentError[]; performance?: Record<string, unknown>; capabilities?: AgentCapabilities; load?: number
}
...
}; data?: any; executionTime?: number; agentId?: string; metadata?: Record<string, unknown>
}
...
export interface SwarmStrategy {
  ...
  assignTaskToAgent(agentId: string,
