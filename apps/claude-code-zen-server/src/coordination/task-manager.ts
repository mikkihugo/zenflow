...
export class TaskCoordinator {
  ...
  private sparcSwarm?: any; // NEW: SPARC swarm
   ...
   * @param document
   */
  private isComplexDocument(document: any): boolean {
    return (
...
// Placeholder functions that need to be imported or defined elsewhere
function mapToClaudeSubAgent(agentType: AgentType): string {
  return agentType;
}

function generateSubAgentConfig(agentType: AgentType): {
  tools: string[];
  capabilities: Record<string, boolean>;
  systemPrompt: string;
} {
