...
import type { ADRDocumentEntity, EpicDocumentEntity, FeatureDocumentEntity, PRDDocumentEntity, TaskDocumentEntity, VisionDocumentEntity } from '../../database/entities/product-entities';
import type { DocumentManager } from "../services/document/document-service";
import { WorkflowAGUIAdapter, type WorkflowAGUIConfig } from '../../interfaces/agui/workflow-agui-adapter';
import type { StepExecutionResult, WorkflowContext, WorkflowDefinition, WorkflowEngineConfig } from '../../workflows/types';
import type { SPARCPhase, SPARCProject } from '../swarm/sparc/types/sparc-types';
import type { WorkflowGateRequest, WorkflowGateResult } from '../workflows/workflow-gate-request';
import type { WorkflowHumanGate } from './workflow-gates';
...
export declare class ProductWorkflowEngine extends EventEmitter {
     ...
     */
    getWorkflowDecisionHistory(workflowId: string): import("../../interfaces/agui/workflow-agui-adapter").WorkflowDecisionAudit[];
    /**
