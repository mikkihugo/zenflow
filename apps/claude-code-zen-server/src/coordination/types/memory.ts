...
export type MemoryType =
  | 'working'      // Temporary workin' memory
  | 'persistent'   // Long-'erm persistent memory
  | 'shared'       // Share' between agents
  | 'cached'       // Cache' data with TTL
  | 'session'      // Sessio'-specific memory
...
export interface MemoryQuery {
  ...
  key?: string;
  keyPattern?: string;
  // Regex pattern for key matching
  tags?: string[];
...
export interface SharedMemory {
   ...
   */
  get<T = unknown>(namespace: string,
...
export interface MemoryCompression {
   ...
   */
  getCompressionRatio(original: any,
  compressed: Buffer): number
