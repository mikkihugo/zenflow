...
import type { WorkflowContext, WorkflowDefinition } from '../workflows/types';
import { Domain, type DomainBoundaryValidator, type Result, type TypeSchema } from './domain-boundary-validator';
import type { EventBus } from './interfaces/base-interfaces';
/**
...
export interface InterfaceEvent extends BaseEvent {
    readonly domain: Domain.NTERFACES;
}
 ...
 */
export declare class TypeSafeEventBus extends EventEmitter implements EventBus {
 ...
 */
export declare function getEventType<TEvent extends BaseEvent>(eventClass: new (...args: unknown[]) => TEvent): string;
