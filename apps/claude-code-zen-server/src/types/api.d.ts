...
export type RouteHandler = (req: unknown, res: unknown, next?: unknown) => void | Promise<void>;
...
export declare function isPaginatedResponse<T>(obj: unknown): obj is PaginatedResponse<T>;
