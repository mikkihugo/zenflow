...
export type AgentType =
  ...
  | 'queen'
  | 'specialist'
  // Performance op'imization agents
  | 'cache-optimizer'
  | 'memory-optimizer'
  | 'latency-optimizer'
  | 'bottleneck-analyzer'
  | 'performance-analyzer'
  // Mig'ation and planning agents
  | 'legacy-analyzer'
  | 'modernization-agent'
  | 'migration-coordinator'
  | 'migration-plan'
  | 'system-architect'
  // SPARC me'hodology agents
  | 'quality-gate-agent'
  | 'validation-specialist'
  // UI/UX enhancemen' agents
  | 'ux-designer'
  | 'ui-designer'
  ...
  | 'security-manager'
  | 'benchmark-suite'
  // Additional gap analysis ag'nt types
  | 'load-balancer'
  | 'performance-monitor'
  | 'resource-allocator'
  | 'topology-optimizer'
