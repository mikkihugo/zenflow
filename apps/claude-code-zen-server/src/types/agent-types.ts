...
export type AgentType =
  | 'researcher | coder' | 'analyst''' | '''optimizer | coordinator' | 'architect''' | '''tester | security' | 'data''' | '''ops | debug' | 'queen''' | '''specialist'// Performance optimization agents'' | '''cache-optimizer''' | '''memory-optimizer''' | '''latency-optimizer''' | '''bottleneck-analyzer''' | '''performance-analyzer'// Migration and planning agents'' | '''legacy-analyzer''' | '''modernization-agent''' | '''migration-coordinator''' | '''migration-plan''' | '''system-architect'// SPARC methodology agents'' | '''quality-gate-agent''' | '''validation-specialist'// UI/UX enhancement agents'' | '''ux-designer''' | '''ui-designer''' | '''accessibility-specialist''' | '''user-guide-writer'// Testing agents'' | '''unit-tester''' | '''integration-tester''' | '''e2e-tester''' | '''performance-tester''' | '''tdd-london-swarm''' | '''production-validator'// Development agents'' | '''developer''' | '''fullstack-dev''' | '''dev-backend-api''' | '''api-dev'// Analysis agents'' | '''analyze-code-quality''' | '''security-analyzer''' | '''refactoring-analyzer'// Additional specialized agents'' | '''database-architect''' | '''devops-engineer''' | '''documentation-specialist'// Gap analysis agents'' | '''reviewer | documenter' | 'monitor''' | '''planner''' | '''requirements-engineer''' | '''design-architect''' | '''task-planner''' | '''steering-author''' | '''frontend-dev''' | '''arch-system-design''' | '''cloud-architect''' | '''security-architect''' | '''ops-cicd-github''' | '''infrastructure-ops''' | '''monitoring-ops''' | '''deployment-ops''' | '''docs-api-openapi''' | '''technical-writer''' | '''readme-writer''' | '''data-ml-model''' | '''etl-specialist''' | '''analytics-specialist''' | '''visualization-specialist''' | '''spec-mobile-react-native''' | '''embedded-specialist''' | '''blockchain-specialist''' | '''ai-ml-specialist''' | '''code-review-swarm''' | '''github-modes''' | '''issue-tracker''' | '''multi-repo-swarm''' | '''pr-manager''' | '''project-board-sync''' | '''release-manager''' | '''release-swarm''' | '''repo-architect''' | '''swarm-issue''' | '''swarm-pr''' | '''sync-coordinator''' | '''workflow-automation''' | '''github-pr-manager''' | '''adaptive-coordinator''' | '''hierarchical-coordinator''' | '''mesh-coordinator''' | '''coordinator-swarm-init''' | '''orchestrator-task''' | '''memory-coordinator''' | '''swarm-memory-manager''' | '''collective-intelligence-coordinator''' | '''byzantine-coordinator''' | '''consensus-builder''' | '''crdt-synchronizer''' | '''gossip-coordinator''' | '''performance-benchmarker''' | '''quorum-manager''' | '''raft-manager''' | '''security-manager''' | '''benchmark-suite'// Additional gap analysis agent types'' | '''load-balancer''' | '''performance-monitor''' | '''resource-allocator''' | '''topology-optimizer''' | '''specification | architecture' | 'refinement''' | '''pseudocode''' | '''sparc-coordinator''' | '''implementer-sparc-coder''' | '''automation-smart-agent''' | '''base-template-generator'// Underscore variants'' | '''requirements_analyst | design_architect' | 'task_planner''' | '''implementation_coder | quality_reviewer' | 'steering_documenter');
