 ...
 * ```typescript
 * import { ApiSwarmResponse, ApiTaskRequest } from './api-translation-layer';
...
export interface ApiSystemStatusResponse {
  /** System configuration from foundation */
...
export interface ApiSwarmResponse extends BaseEntity {
  ...
  /** Current swarm status (from brain domain types) */
  status: SwarmStatus;
  
  /** Swarm configuration (comprehensive brain domain type) */
...
export interface ApiTaskResponse extends TimestampedEntity {
  ...
  /** Current task status (from workflow domain types) */
  status: WorkflowStatus;
  
  /** Workflow definition (comprehensive workflow domain type) */
...
export interface ApiTaskExecutionResponse {
  ...
  /** Execution result (from workflow domain types) */
 ...
 */
export interface ApiDocumentResponse extends BaseEntity {
  /** Document identifier */
  id: string;
...
export interface ApiUpdateSettingsRequest {
  /** Settings to update (partial update supported) */
  settings: Partial<ApiSettingsResponse>;
 ...
 */
export type ApiEntityStatus = EntityStatus | SwarmStatus | WorkflowStatus;
 ...
 */
export function isApiSuccessResponse<T>(response: ApiResponse<T> | ApiErrorResponse): response is ApiResponse<T> {
 ...
 */
export function isApiErrorResponse(response: ApiResponseUnion): response is ApiErrorResponse {
