...
export type WebSocketEventType =' | ''system:status''' | '''swarm:update''' | '''swarm:created''' | '''swarm:stopped''' | '''performance:update''' | '''task:created''' | '''task:updated''' | '''task:completed''' | '''logs:new''' | '''llm:stats');
