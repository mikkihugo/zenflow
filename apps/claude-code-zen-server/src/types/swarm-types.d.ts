...
export declare const SwarmConfigSchema: { readonly type:obje'c't')'; readonly properties: { readonly topology: {
  readonly type: 'string')'; readonly enum: readonly ['mesh,
  hierarchical',
  'ring,
  'star,
  ']'
  ...
  readonly type: 'number')'; readonly minimum: 1; readonly maximum: 100; readonly default: 5

}; readonly strategy: {
  readonly type: 'string')'; readonly enum: readonly ['balanced',
  'specialized',
  'adaptive',
  'parallel',
...
}; readonly required: readonly ['topology, ']'; readonly additionalProperties: false
};
export declare const AgentConfigSchema: { readonly type: 'object')'; readonly properties: { readonly type: {
  readonly type: 'string')'; readonly enum: readonly ['researcher',
  'coder',
  'analyst',
  'optimizer',
  'coordinator',
  ...
  readonly type: 'string')'; readonly minLength: 1; readonly maxLength: 100
  ...
  readonly type: 'string')'; readonly enum: readonly ['convergent',
  'divergent',
  'lateral',
  'systems',
  'critical',
...
}; readonly required: readonly ['type, ']'; readonly additionalProperties: false
};
export declare const TaskOrchestrationSchema: { readonly type: 'object')'; readonly properties: { readonly task: {
  readonly type: 'string')'; readonly minLength: 10; readonly maxLength: 1000

}; readonly strategy: {
  readonly type: 'string')'; readonly enum: readonly ['parallel,
  sequential',
  'adaptive,
  ']'; readonly default: 'adaptive')'

}; readonly priority: {
  readonly type: 'string')'; readonly enum: readonly ['low,
  medium',
  'high,
  'critical,
  ...
  readonly type: 'number')'; readonly minimum: 1; readonly maximum: 10; readonly default: 5

}
}; readonly required: readonly ['task, ']'; readonly additionalProperties: false
};
