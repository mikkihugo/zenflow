...
export type SystemEvent = 'startup' | 'shutdown' | 'error' | 'config-change' | 'health-check';
...
export declare function isSystemConfig(obj: unknown): obj is SystemConfig;
export declare function isSystemHealth(obj: unknown): obj is SystemHealth;
