...
export interface NeuralDecisionPoint {
  ...
  readonly confidenceRequired: number;
  // 0-1
...
export interface ContinuousMonitoringConfig {
  ...
  readonly alertThresholds: Record<string,
  number>;
...
export interface AdaptiveThresholdConfig {
  ...
  readonly learningWindow: number;
  // days
...
export interface NeuralPerformanceMetrics {
  ...
  readonly consensusEfficiency: number;
  // 0-1
...
export interface SwarmIntelligenceMetrics {
  readonly swarmCoherence: number;
  // 0-1
  readonly emergentBehaviorStrength: number;
  // 0-1
  readonly collectiveIntelligence: number;
  // 0-1
  readonly distributedDecisionEfficiency: number;
  // 0-1
...
export interface LearningProgressMetrics {
  ...
  // 0-1
  readonly expertiseEvolution: number;
  // 0-1
...
export interface AutonomyMetrics {
  readonly autonomousDecisionRate: number;
  // 0-1
  readonly humanInterventionRate: number;
  // 0-1
  readonly errorCorrectionRate: number;
  // 0-1
  readonly selfOptimizationEfficiency: number;
  // 0-1
...
export function createClaudeZenIntegrationConfig(): ClaudeZenIntegrationConfig  {
  return {
    // Base configuration
    enabledFeatures: ['auto-sparc-project-creation',
      'real-time-progress-sync',
      'automated-quality-gates',
      'predictive-analytics',
      'cross-framework-reporting',
      'intelligent-escalation', ],
    sychronizationSettings: {
  ...
  // 1 hour
      ...
      notificationCannels: ['email', 'slack', 'dashboard],
