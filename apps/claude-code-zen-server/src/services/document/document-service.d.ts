/**
 * @file Document Service - Business Logic Layer for Document Management
 *
 * High-level document operations with business logic and workflow management.
 * Uses the database domain for data access while implementing application-level features.
 */
import type { DocumentType } from '../../workflows/types';
import type { ADRDocumentEntity, BaseDocumentEntity, DocumentWorkflowStateEntity, EpicDocumentEntity, FeatureDocumentEntity, PRDDocumentEntity, ProjectEntity, TaskDocumentEntity, VisionDocumentEntity } from '../../database/entities/document-entities';
...
export declare class DocumentManager {
     ...
     * @param results
     */
    advanceDocumentWorkflow(documentId: string, nextStage: string, results?: Record<string, unknown>): Promise<DocumentWorkflowStateEntity>;
    /**
