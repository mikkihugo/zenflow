...
(function (DatabaseErrorCode) {
    // Coordination Errors
    DatabaseErrorCode["COORDINATION_FAILED"] = "DATABASE_COORDINATION_FAILED";
    DatabaseErrorCode["ENGINE_SELECTION_FAILED"] = "DATABASE_ENGINE_SELECTION_FAILED";
    DatabaseErrorCode["ROUTING_FAILED"] = "DATABASE_ROUTING_FAILED";
    DatabaseErrorCode["LOAD_BALANCING_FAILED"] = "DATABASE_LOAD_BALANCING_FAILED";
    // Engine Errors
    DatabaseErrorCode["ENGINE_UNAVAILABLE"] = "DATABASE_ENGINE_UNAVAILABLE";
    DatabaseErrorCode["ENGINE_OVERLOADED"] = "DATABASE_ENGINE_OVERLOADED";
    DatabaseErrorCode["ENGINE_TIMEOUT"] = "DATABASE_ENGINE_TIMEOUT";
    DatabaseErrorCode["ENGINE_CONNECTION_FAILED"] = "DATABASE_ENGINE_CONNECTION_FAILED";
    DatabaseErrorCode["ENGINE_INITIALIZATION_FAILED"] = "DATABASE_ENGINE_INITIALIZATION_FAILED";
    // Query Errors
    DatabaseErrorCode["QUERY_INVALID"] = "DATABASE_QUERY_INVALID";
    DatabaseErrorCode["QUERY_TIMEOUT"] = "DATABASE_QUERY_TIMEOUT";
    DatabaseErrorCode["QUERY_OPTIMIZATION_FAILED"] = "DATABASE_QUERY_OPTIMIZATION_FAILED";
    DatabaseErrorCode["QUERY_EXECUTION_FAILED"] = "DATABASE_QUERY_EXECUTION_FAILED";
    DatabaseErrorCode["QUERY_RESULT_INVALID"] = "DATABASE_QUERY_RESULT_INVALID";
    // Performance Errors
    DatabaseErrorCode["PERFORMANCE_DEGRADED"] = "DATABASE_PERFORMANCE_DEGRADED";
    DatabaseErrorCode["CACHE_MISS_RATE_HIGH"] = "DATABASE_CACHE_MISS_RATE_HIGH";
    DatabaseErrorCode["LATENCY_THRESHOLD_EXCEEDED"] = "DATABASE_LATENCY_THRESHOLD_EXCEEDED";
    DatabaseErrorCode["THROUGHPUT_LOW"] = "DATABASE_THROUGHPUT_LOW";
    // Transaction Errors
    ...
    DatabaseErrorCode["TRANSACTION_ROLLBACK_FAILED"] = "DATABASE_TRANSACTION_ROLLBACK_FAILED";
    DatabaseErrorCode["DEADLOCK_DETECTED"] = "DATABASE_DEADLOCK_DETECTED";
    DatabaseErrorCode["CONSISTENCY_VIOLATION"] = "DATABASE_CONSISTENCY_VIOLATION";
    // Resource Errors
    DatabaseErrorCode["RESOURCE_EXHAUSTED"] = "DATABASE_RESOURCE_EXHAUSTED";
    DatabaseErrorCode["CAPACITY_EXCEEDED"] = "DATABASE_CAPACITY_EXCEEDED";
    DatabaseErrorCode["CONNECTION_POOL_EXHAUSTED"] = "DATABASE_CONNECTION_POOL_EXHAUSTED";
    DatabaseErrorCode["MEMORY_LIMIT_EXCEEDED"] = "DATABASE_MEMORY_LIMIT_EXCEEDED";
    // System Errors
    DatabaseErrorCode["CONFIGURATION_INVALID"] = "DATABASE_CONFIGURATION_INVALID";
    DatabaseErrorCode["SYSTEM_UNAVAILABLE"] = "DATABASE_SYSTEM_UNAVAILABLE";
    DatabaseErrorCode["UNKNOWN_ERROR"] = "DATABASE_UNKNOWN_ERROR";
...
export class DatabaseErrorClassifier {
    ...
    static classifyDatabaseError(error) {
        let category;
    ...
    static inferRetryStrategy(error) {
        const message = error.message.toLowerCase();
