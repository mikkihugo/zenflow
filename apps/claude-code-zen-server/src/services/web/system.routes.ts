...
const SYSTEM_ERROR_MESSAGES = {
  internalServerError: 'Internal server error',} as const;
...
export class SystemCapabilityRoutes {
  ...
  private async handleGetStatus(req:Request, res:Response): Promise<void> {
    try {
      ...
      res.json({
        ...
        data:statusData,
        meta:{
          endpoint: 'status',          timestamp:new Date().toISOString(),
},
});
} catch (error) {
  ...
  private async handleGetFacades(req:Request, res:Response): Promise<void> {
    try {
      ...
      res.json({
        ...
        data:facadesData,
        meta:{
          endpoint: 'facades',          timestamp:new Date().toISOString(),
  ...
  private async handleGetSuggestions(
    ...
    try {
      ...
      res.json({
        ...
        meta:{
          endpoint: 'suggestions',          timestamp:new Date().toISOString(),
  ...
  private async handleGetDetailed(req:Request, res:Response): Promise<void> {
    try {
      ...
      res.json({
        ...
        data:detailedData,
        meta:{
          endpoint: 'detailed',          timestamp:new Date().toISOString(),
  ...
  private async handleGetHealth(req:Request, res:Response): Promise<void> {
    try {
      ...
      const response = {
        status:isHealthy ? 'healthy' : ' degraded',        timestamp:new Date().toISOString(),
        health:{
