...
function getWebDashboardURL(options) {
...
export const apiUtils = {
     ...
     */
    createWebSocketUrl: (baseUrl) => `${baseUrl.replace(/^http/, 'ws').replace(/\/$/, '')}/ws`,
    /**
     ...
     */
    validateConfig: (config) => Boolean(config?.baseUrl || config?.websocketUrl),
    /**
     * Parse API response.
     *
