 ...
 */
import type { GateEscalationLevel, WorkflowContext, WorkflowGateRequest } from '../../coordination/workflows/workflow-gate-request';
import { type TypeSafeEventBus } from '../../core/type-safe-event-system';
import { TerminalAGUI, type ValidationQuestion } from './agui-adapter';
/**
