...
import type { Service, ServiceFactory, ServiceConfig } from './core/interfaces';
import {
...
export interface IntegrationServiceFactoryOptions {
  ...
  /** Default database type for Architecture Storage integrations */ defaultDatabaseType?:
    | 'postgresql'
    | 'sqlite'
    | 'mysql';
  ...
  implements ServiceFactory<ServiceConfig>
{
  ...
  /** * ServiceFactory implementation - create service from configuration. * * @param config */
  ...
  /** * Check if factory can handle the given service type. * * @param type */
  ...
  /** * Check if a service with the given name exists. * * @param name */
  has(name: string): boolean {
    return this.createdServices.has(name);
  }
  /** * Remove and destroy a service instance. * * @param name */
  async remove(name: string): Promise<boolean> {
    return await this.removeService(name);
  }
  /** * Check if factory supports the given service type. * * @param type */
    ...
    const startPromises = Array.from(this.createdServices?.values()).map(
      async (service) => {
        try {
          ...
          this.logger.error(
            'Error starting service ' + service.name + ':',
            error
          );
        }
      }
  ...
  /** * Validate configuration. * * @param config */
  ...
  /** * Get configuration schema. * * @param type */
  ...
  /** * Create Architecture Storage integration adapter. * * @param name * @param databaseType * @param options */
  ...
  /** * Create Safe API integration adapter. * * @param name * @param baseURL * @param options */
  ...
  /** * Create Protocol Management integration adapter. * * @param name * @param supportedProtocols * @param options */
  ...
  /** * Create unified integration adapter (all features enabled). * * @param name * @param options. * @param options */
  ...
  /** * Create Web Data integration adapter(
    specialized for web-based data operations). * * @param name * @param baseURL * @param options. * @param options */
  ...
  /** * Create Document integration adapter(
    specialized for document operations). * * @param name * @param databaseType * @param options. * @param options */
  async createDocumentIntegrationAdapter(
    ...
    const config = createDefaultIntegrationServiceAdapterConfig(name, {
      ...
      retry: {
        ...
        // Gentler backoff for database operations
        retryableOperations: [
          'architecture-save',
          'architecture-retrieve',
          'architecture-update',
      ...
      security: {
        ...
        // Documents might contain special content
  ...
  /** * Remove service from tracking. * * @param name */
  ...
  getFactoryStats(): {
    ...
    return {
      ...
      // All tracked services are active
      serviceTypes,
      memoryUsage,
    };
  }
  ...
  /** * Convert ServiceConfig to IntegrationServiceAdapterConfig. * * @param config */
...
export const IntegrationServiceHelpers = {
  /** * Create architecture storage service. * * @param name * @param databaseType */
  ...
  /** * Create safe API service. * * @param name * @param baseURL */
  async createSafeAPI(
    name: string,
    baseURL: string
  ): Promise<IntegrationServiceAdapter> {
  ...
  /** * Create protocol management service. * * @param name * @param protocols */
  ...
  /** * Create unified integration service. * * @param name * @param options * @param options.baseURL * @param options.databaseType * @param options.supportedProtocols */
  ...
  /** * Create web data integration service. * * @param name * @param baseURL */
  ...
  /** * Create document integration service. * * @param name * @param databaseType */
