...
export function createAgentCoordinationConfig(name: string, options?: {
  ...
  return createDefaultCoordinationServiceAdapterConfig(
    name,
    {
...
export const CoordinationConfigPresets = {
   ...
   * @param name
   */
  BASIC: (name: string) => createDefaultCoordinationServiceAdapterConfig(
    name,
    {
      type: ServiceType.COORDINATION,
   ...
   * @param name
   */
  ADVANCED: (name: string) => createAgentCoordinationConfig(
    name,
    {
      maxAgents: 100,
   ...
   * @param name
   */
  SESSION_MANAGEMENT: (name: string) => createSessionCoordinationConfig(
    name,
    {
      maxSessions: 20,
   ...
   * @param name
   */
  DATA_ANALYSIS: (name: string) => createDAACoordinationConfig(
    name,
    {
      enableMetaLearning: true,
      enableCognitive: true,
   ...
   * @param name
   */
  HIGH_PERFORMANCE: (name: string) => createHighPerformanceCoordinationConfig(
    name,
    {
      maxConcurrency: 100,
