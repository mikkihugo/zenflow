...
export { CoordinationServiceAdapter, type CoordinationServiceAdapterConfig, createCoordinationServiceAdapter, createDefaultCoordinationServiceAdapterConfig,
} from "./coordination-service-adapter";
export { CoordinationServiceFactory, coordinationServiceFactory,
} from "./coordination-service-factory";
export * from "./coordination-service-helpers";
// Data service adapter exports
// Factory integration
export { createDataServiceAdapter, createDefaultDataServiceAdapterConfig, DataServiceAdapter, type DataServiceAdapterConfig,
} from "./data-service-adapter";
export { DataServiceFactory, globalDataServiceFactory,
} from "./data-service-factory";
// Re-export types for convenience
export type { BatchOperationConfig, DataAggregationOptions, DataOperationResult, DataValidationResult, EnhancedSearchOptions, TransformationStep,
...
export { createDefaultInfrastructureServiceAdapterConfig, createInfrastructureServiceAdapter, InfrastructureServiceAdapter, type InfrastructureServiceAdapterConfig,
} from "./infrastructure-service-adapter";
export { createInfrastructureService, createInfrastructureServiceFactory, getInfrastructureServiceFactory, InfrastructureServiceFactory,
} from "./infrastructure-service-factory";
export * from "./infrastructure-service-helpers";
// Integration service adapter exports
export { createDefaultIntegrationServiceAdapterConfig, createIntegrationServiceAdapter, IntegrationServiceAdapter, type IntegrationServiceAdapterConfig,
} from "./integration-service-adapter";
export { IntegrationServiceFactory, integrationServiceFactory,
 ...
 * });` * ```
 */
export function registerDataServiceFactory(): void { // Register the specialized data service factory for DATA, WEB_DATA, and DOCUMENT types globalServiceRegistry.registerFactory( ServiceType.DATA, globalDataServiceFactory as ServiceFactory<ServiceConfig> ); globalServiceRegistry.registerFactory( ServiceType.WEB_DATA, globalDataServiceFactory as ServiceFactory<ServiceConfig> ); globalServiceRegistry.registerFactory( ServiceType.DOCUMENT, globalDataServiceFactory as ServiceFactory<ServiceConfig> );
}
 ...
 * });` * ```
 */
export function registerCoordinationServiceFactory(): void { // Register the specialized coordination service factory for COORDINATION, DAA, and SESSION_RECOVERY types globalServiceRegistry.registerFactory( ServiceType.COORDINATION, coordinationServiceFactory as ServiceFactory<ServiceConfig> ); globalServiceRegistry.registerFactory( ServiceType.DAA, coordinationServiceFactory as ServiceFactory<ServiceConfig> ); globalServiceRegistry.registerFactory( ServiceType.SESSION_RECOVERY, coordinationServiceFactory as ServiceFactory<ServiceConfig> );
}
 ...
 * });` * ```
 */
export function registerIntegrationServiceFactory(): void { // Register the specialized integration service factory for API, SAFE_API, and ARCHITECTURE_STORAGE types globalServiceRegistry.registerFactory( ServiceType.API, integrationServiceFactory as ServiceFactory<ServiceConfig> ); globalServiceRegistry.registerFactory( ServiceType.SAFE_API, integrationServiceFactory as ServiceFactory<ServiceConfig> ); globalServiceRegistry.registerFactory( ServiceType.ARCHITECTURE_STORAGE, integrationServiceFactory as ServiceFactory<ServiceConfig> );
}
 ...
 * });` * ```
 */
export function registerInfrastructureServiceFactory(): void { // Register the specialized infrastructure service factory for NFRASTRUCTURE, SYSTEM, and MONITORING types const infrastructureFactory = getInfrastructureServiceFactory(); globalServiceRegistry.registerFactory( ServiceType.NFRASTRUCTURE, infrastructureFactory as ServiceFactory<ServiceConfig> ); globalServiceRegistry.registerFactory( ServiceType.SYSTEM, infrastructureFactory as ServiceFactory<ServiceConfig> ); globalServiceRegistry.registerFactory( ServiceType.MONITORING', infrastructureFactory as ServiceFactory<ServiceConfig> );
}
...
export default { DataServiceAdapter, DataServiceFactory: globalDataServiceFactory, DataServiceHelper, DataServiceUtils, globalDataServiceFactory, registerDataServiceFactory, CoordinationServiceAdapter, CoordinationServiceFactory, coordinationServiceFactory, registerCoordinationServiceFactory, IntegrationServiceAdapter, IntegrationServiceFactory: integrationServiceFactory, integrationServiceFactory, registerIntegrationServiceFactory, InfrastructureServiceAdapter, InfrastructureServiceFactory, getInfrastructureServiceFactory, registerInfrastructureServiceFactory,
};`