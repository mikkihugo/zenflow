...
export class ClaudeZenServerImpl implements UnifiedClaudeZenServer {
  ...
  private readonly eventBus: TypedEventBase;
  private readonly serviceContainer: Awaited<ReturnType<typeof createServiceContainer>>;
  ...
  constructor(config: Partial<ServerConfig> = {}) {
    ...
    this.eventBus = new TypedEventBase();
    this.serviceContainer = null as unknown as Awaited<ReturnType<typeof createServiceContainer>>;
  ...
  async initialize(): Promise<Result<void, Error>> {
    ...
    return safeAsync(async () => {
      ...
      Object.assign(this, { serviceContainer: await createServiceContainer(`server-${this.id}`) });
