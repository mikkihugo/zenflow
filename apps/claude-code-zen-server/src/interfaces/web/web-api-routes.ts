...
export class WebApiRoutes {
  ...
  private llmStatsService = new LLMStatsService();
  private workspaceApi: WorkspaceApiRoutes;
  ...
  setupRoutes(app: Express): void {
    ...
    // ========================================
    // COLLECTIVE NTELLIGENCE CONTROL APIs (NEW!)
    // ========================================
   ...
   */
  private async handleGetLLMStats(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  private async handleExportLLMStats(req: Request, res: Response): Promise<void> {
    try {
      const format = (req.query.format as string) || 'json';
      const data = this.llmStatsService.exportStats(format as 'json' | 'csv');
   ...
   */
  private async handleGetLLMHealth(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  private async handleGetLLMProviders(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  private async handleClearLLMHistory(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  private async handleGetConsultations(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  private async handleCreateConsultation(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  private async handleGetExperts(req: Request, res: Response): Promise<void> {
    try {
      const experts = [
        {
          domain: 'system-architecture',
   ...
   */
  private async handleGetRecommendations(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  private async handleGetMatronMetrics(req: Request, res: Response): Promise<void> {
    try {
      const metrics = {
   ...
   */
  private async handleGetRoadmaps(req: Request, res: Response): Promise<void> {
    try {
      const roadmaps = [
        {
          id: 'rm-zen-001',
   ...
   */
  private async handleCreateRoadmap(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  private async handleGetMilestones(req: Request, res: Response): Promise<void> {
    try {
      const milestones = [
        {
          id: 'ms-zen-001',
   ...
   */
  private async handleCreateMilestone(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  private async handleGetVisionStatements(req: Request, res: Response): Promise<void> {
    try {
      const visions = [
        {
          id: 'vs-zen-001',
   ...
   */
  private async handleGetRoadmapMetrics(req: Request, res: Response): Promise<void> {
    try {
   ...
   * Swagger UI endpoint.
   */
  private async handleSwaggerUI(req: Request, res: Response): Promise<void> {
    try {
  ...
  private async handleGetAGUWorkflows(req: Request, res: Response): Promise<void> {
    try {
      const workflows = [
        {
          id: 'wf-001',
  ...
  private async handleApproveWorkflow(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
  ...
  private async handleRejectWorkflow(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
      const { decision, rationale } = req.body;
  ...
  private async handleEscalateWorkflow(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
  ...
  private async handleGetAGUApprovals(req: Request, res: Response): Promise<void> {
    try {
      const approvals = [
        {
          id: 'app-001',
  ...
  private async handleGetAGUGovernance(req: Request, res: Response): Promise<void> {
    try {
      const governance = {
        status: 'active',
        policies: [
  ...
  private async handleGetAGUMetrics(req: Request, res: Response): Promise<void> {
    try {
      const metrics = {
        totalTasks: 152,
        approvedTasks: 89,
  ...
  private async handleGetDevCommHistory(req: Request, res: Response): Promise<void> {
    try {
      const history = [
        {
          id: Date.now() - 1000,
  ...
  private async handleSendDevComm(req: Request, res: Response): Promise<void> {
    try {
  ...
  private async handleClearDevCommHistory(req: Request, res: Response): Promise<void> {
    try {
  ...
  private async handleGetSystemPerformance(req: Request, res: Response): Promise<void> {
    try {
      const performance = {
  ...
  private async handleGetSystemSwarms(req: Request, res: Response): Promise<void> {
    try {
      const swarms = [
   ...
   */
  private setupApidogMiddleware(app: Express, apiPrefix: string): void {
   ...
   */
  private setupSwaggerDocs(app: Express, apiPrefix: string): void {
    ...
    try {
      ...
      app.get(`${apiPrefix}/docs/spec`, (req: Request, res: Response) => {
        res.setHeader('Content-Type', 'application/json');
        res.json(specs);
      });
      
      // API documentation endpoint
      app.get(`${apiPrefix}/docs/info`, (req: Request, res: Response) => {
        res.json({
          success: true,
          data: {
            title: 'Claude Code Zen API Documentation',
  ...
  // ========================================
  // COLLECTIVE NTELLIGENCE CONTROL HANDLERS
  // ========================================

  /**
   * Collective health endpoint - Real system status.
   */
  private async handleCollectiveHealth(_req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  private async handleCollectiveStatus(_req: Request, res: Response): Promise<void> {
    try {
      const collective = getCollectiveFACT();
      const isActive = collective !== null;
   ...
   */
  private async handleCollectiveSearch(req: Request, res: Response): Promise<void> {
    try {
      ...
      const searchQuery = {
        ...
        ...(domain && { domains: [domain as string] })
      };
   ...
   */
  private async handleCollectiveStats(_req: Request, res: Response): Promise<void> {
    try {
      const collective = getCollectiveFACT();
   ...
   */
  private async handleCollectiveRefresh(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  private async handleCollectiveClearCache(_req: Request, res: Response): Promise<void> {
    try {
      const collective = getCollectiveFACT();
