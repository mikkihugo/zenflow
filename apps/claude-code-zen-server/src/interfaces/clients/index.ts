...
export class UACL {
   ...
   * console.log(`Max Clients: ${status(configuration as any).maxClients}`);
   * console.log(`Health Checks: ${status(configuration as any).enableHealthChecks ? 'Enabled : Disabled'}`);
   * ```
   */
