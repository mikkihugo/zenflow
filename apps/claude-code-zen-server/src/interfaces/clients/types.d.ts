...
export declare const McpConstants: {
    ...
    readonly NOTIFICATIONS: {
        readonly NITIALIZED: "notifications/initialized";
...
export declare const TypeGuards: {
    readonly isClientType: (value: unknown) => value is ClientType;
    readonly isProtocolType: (value: unknown) => value is ProtocolType;
    readonly isAuthType: (value: unknown) => value is AuthType;
    readonly isHttpMethod: (value: unknown) => value is HttpMethod;
    readonly isClientStatus: (value: unknown) => value is ClientStatus;
};
