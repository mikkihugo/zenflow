/**
 * @fileoverview Unified API Client Layer (UACL) - Core Interfaces
 *
...
export interface ClientFactory {
  ...
  validateConfig(protocol: ProtocolType,
  config: ClientConfig): boolean
...
export interface HttpClient<T = any> extends Client<T> {
  ...
  /** POST request */
  post<R = any>(path: string,
  data?: T,
  options?: RequestOptions): Promise<R>;

  /** PUT request */
  put<R = any>(path: string,
  data?: T,
  options?: RequestOptions): Promise<R>;

  /** DELETE request */
  delete<R = any>(path: string,
  options?: RequestOptions): Promise<R>;
  ...
  /** Set request headers */
  setHeaders(headers: Record<string,
  string>): void;
  ...
  getLastResponseHeaders(): Record<string,
  string>
...
export interface WebSocketClient<T = any> extends Client<T> {
  ...
  callback: (data: T) => void): Promise<string>;
