...
import type { AuthenticationConfig, ClientConfig, ClientMetrics, ClientResponse, ClientStatus, Client, RequestOptions, RetryConfig } from '../core/interfaces';
/**
 ...
 * ```
 */
export declare class WebSocketClientAdapter extends EventEmitter implements Client {
     ...
     */
    post<T = any>(endpoint: string, data?: unknown, options?: RequestOptions): Promise<ClientResponse<T>>;
    /**
     * Generic PUT request (UACL interface).
     */
    put<T = any>(endpoint: string, data?: unknown, options?: RequestOptions): Promise<ClientResponse<T>>;
    /**
     ...
     */
    on(event: 'connect' | 'disconnect' | 'error' | 'retry' | string, handler: (...args: unknown[]) => void): void;
    /**
