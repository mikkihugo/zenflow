...
export class ClientManager extends TypedEventBase {
  ...
  getHealthStatus(): {
    ...
    const overall = healthyPercentage >= 0.8 ? 'healthy' : healthyPercentage >= 0.5 ? 'warning' : 'critical';
