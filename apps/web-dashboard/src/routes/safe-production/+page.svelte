<script lang="ts">
  ...
  let userRole: 'team_member' | 'scrum_master' | 'po' | 'rte' | 'architect' | 'business_owner' = 'team_member';
  ...
  onMount(() => {
    ...
    userRole = (params.get('userRole') as any) || localStorage.getItem('safeUserRole') || userRole;
    immersionLevel = (params.get('immersionLevel') as any) || localStorage.getItem('safeImmersionLevel') || immersionLevel;
