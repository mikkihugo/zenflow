#!/usr/bin/env node
/**
 * Document Stack Web Server - GitHub Models-like Interface
 * 
 * Run documents through the stack with human feedback via web UI
 * Similar to how GitHub models provides an interactive interface
 */
...
const server = http.createServer(async (req, res) => {
  ...
  if (parsedUrl.pathname === '/' && req.method === 'GET') {
  ...
  else if (parsedUrl.pathname === '/api/create' && req.method === 'POST') {
    let body = '';
    ...
    req.on('end', async () => {
      try {
        ...
        // Create document through the stack
...
server.listen(PORT, () => {
  console.log(`
🚀 Document Stack Web Server Running!
   
📍 Open in your browser: http://localhost:${PORT}

This provides a GitHub Models-like interface where you can:
- Create documents with automatic metadata generation
- See routing and approval requirements
- Provide human feedback on the processing
- View how documents flow through the stack
