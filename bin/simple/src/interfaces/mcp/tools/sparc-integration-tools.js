export function createSPARCIntegrationTools(_documentService) {
    return [
        {
                ...
                try {
                    ...
                    const result = {
                        ...
                        data: {
                            ...
                            algorithms: pseudocodeStructure.algorithms.map((alg) => ({
                                name: alg.name,
                                purpose: alg.purpose,
                                inputs: alg.inputs,
                                outputs: alg.outputs,
                            ...
                            summary: {
                                ...
                                overallComplexity: pseudocodeStructure.complexityAnalysis?.timeComplexity ||
                                    'Unknown',
                            },
                    ...
                    return {
                        ...
                        data: {
                            ...
                            algorithms: algorithms.map((alg) => ({
                                name: alg.name,
                                purpose: alg.purpose,
                                inputs: alg.inputs.map((i) => ({
                                    name: i.name,
                                    type: i.type,
                                    description: i.description,
                                })),
                                outputs: alg.outputs.map((o) => ({
                                    name: o.name,
                                    type: o.type,
                            ...
                            summary: {
                                ...
                                totalOptimizations: algorithms.reduce((sum, alg) => sum + alg.optimizations.length, 0),
                            },
                            generatedAt: new Date().toISOString(),
                        },
                    };
...
//# sourceMappingURL=sparc-integration-tools.js.map