        ...
        const workflowContext = {
            ...
            impactAssessment: {
                ...
                complianceImpact: {
                    ...
                    deadlines: [new Date(Date.now() + 86400000 * 45)],
                },
        ...
        const workflowContext = {
            ...
            impactAssessment: {
                ...
                complianceImpact: {
                    ...
                    deadlines: [new Date(Date.now() + 86400000 * 21)],
                },
        ...
        const securityContext = {
            ...
            impactAssessment: {
                ...
                complianceImpact: {
                    ...
                    deadlines: [new Date(Date.now() + 86400000 * 14)],
                },
        ...
        const workflowContext = {
            ...
            impactAssessment: {
                ...
                complianceImpact: {
                    ...
                    deadlines: [new Date(Date.now() + 86400000 * 30)],
                },
...
//# sourceMappingURL=workflow-gate-system-integration.js.map