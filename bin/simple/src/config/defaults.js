...
export const PRODUCTION_VALIDATION_SCHEMA = {
    ...
    validation: {
        ...
        ANTHROPIC_API_KEY: (value) => process.env['NODE_ENV'] === 'production'
...
export const PORT_ALLOCATION_BY_ENV = {
    ...
    production: {
        'interfaces.mcp.http.port': Number.parseInt(process.env['CLAUDE_MCP_PORT'] || '3000', 10),
        'interfaces.web.port': Number.parseInt(process.env['CLAUDE_WEB_PORT'] || '3456', 10),
        'monitoring.dashboard.port': Number.parseInt(process.env['CLAUDE_MONITOR_PORT'] || '3457', 10),
    },
    test: {
