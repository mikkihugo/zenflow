...
export class DAA_MCPTools {
    ...
    async daa_agent_create(params) {
        ...
        try {
            await this.ensureInitialized();
            const { id, capabilities = [], cognitivePattern = 'adaptive', learningRate = 0.001, enableMemory = true, } = params;
            if (!id) {
    ...
    async daa_knowledge_share(params) {
        ...
        try {
            await this.ensureInitialized();
            const { source_agent, sourceAgentId, target_agents, targetAgentIds, knowledgeDomain, knowledgeContent, } = params;
...
//# sourceMappingURL=mcp-daa-tools.js.map