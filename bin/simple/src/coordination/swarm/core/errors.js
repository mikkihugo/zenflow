...
class SwarmError extends ZenSwarmError {
    ...
    getSuggestions() {
        ...
        else if (this.message.includes('capacity') ||
...
class AgentError extends ZenSwarmError {
    ...
    getSuggestions() {
        ...
        else if (this.message.includes('busy') ||
...
class WasmError extends ZenSwarmError {
    ...
    getSuggestions() {
        const suggestions = [];
        if (this.message.includes('not loaded') ||
...
class PersistenceError extends ZenSwarmError {
    ...
    getSuggestions() {
        ...
        else if (this.message.includes('not found') ||
        ...
        else if (this.message.includes('locked') ||
