...
class CLIDatabaseAdapter {
    coordinationDao = null;
    async ensureConnection() {
        if (!this.coordinationDao) {
            try {
                this.coordinationDao = await createDao(EntityTypes.CoordinationEvent, DatabaseTypes?.Coordination);
            }
            catch (error) {
...
export function createArchitectureCLI() {
...
function createSamplePseudocode() {
    return {
...
function displayArchitectureSummary(architecture) {
...
//# sourceMappingURL=architecture-commands.js.map