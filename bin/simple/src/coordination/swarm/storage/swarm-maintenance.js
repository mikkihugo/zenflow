...
export class SwarmMaintenanceManager extends EventEmitter {
    ...
    async createSwarmStorage(swarmId, metadata) {
    ...
    async archiveSwarm(swarmId) {
        ...
        await new Promise((resolve, reject) => {
            ...
            tar.on('close', (code) => code === 0 ? resolve(void 0) : reject(new Error(`tar failed: ${code}`)));
        });
    ...
    async cleanupOldArchives() {
        ...
        try {
            ...
            for (const monthDir of monthDirs) {
                ...
                const monthDate = new Date(Number.parseInt(yearStr), Number.parseInt(monthStr) - 1);
    ...
    async getStorageStats() {
        ...
        const sizeResult = await new Promise((resolve, reject) => {
            ...
            du.on('close', (code) => code === 0 ? resolve(output) : reject(new Error(`du failed: ${code}`)));
        });
...
//# sourceMappingURL=swarm-maintenance.js.map