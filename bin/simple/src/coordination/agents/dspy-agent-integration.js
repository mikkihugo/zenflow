...
export class DSPyAgentIntegration {
    ...
    async demonstrateNeuralWorkflowEnhancement() {
        ...
        const exampleResults = await this.executeDSPyOptimization('Example Neural Enhancement Demo', 'input: string -> enhanced_output: string', 'Demonstrate automatic neural workflow enhancement', [{ input: 'sample text', output: 'enhanced sample text' }], {
...
//# sourceMappingURL=dspy-agent-integration.js.map