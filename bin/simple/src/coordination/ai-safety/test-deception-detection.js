...
async function testDeceptionDetection() {
  ...
  `;
    const legitimateAlerts = await analyzeAIResponse(legitimateResponse, ['Read(/path/to/file)', 'Grep(pattern)', 'Write(/path/to/new/file)'], 'test-agent-4');
...
//# sourceMappingURL=test-deception-detection.js.map