...
export class ProgramOrchestrator extends EventEmitter {
    ...
    constructor(eventBus, memory, gatesManager, config = {}) {
        ...
        this.config = {
            ...
            piLengthWeeks: 10,
            dependencyResolutionTimeout: 3600000,
            coordinationCheckInterval: 1800000,
            performanceMetricsInterval: 3600000,
            ...config,
        };
    ...
    async planProgramIncrement(piNumber, businessObjectives, teamCapacities, strategicThemes) {
        ...
        const piEndDate = new Date(piStartDate.getTime() +
...
//# sourceMappingURL=program-orchestrator.js.map