...
import { getErrorSeverity, } from './errors.ts';
...
export class ErrorStorage {
    ...
    calculateErrorRate(trendKey) {
        ...
        const timeSpanMinutes = Math.max(timeSpanMs / 60000, 1);
    ...
    calculateTrending(trend) {
        ...
        const recentRate = recentReports.length / 5;
...
export class ErrorMonitor {
    ...
    startMonitoring(intervalMs = 60000) {
        this.monitoringInterval = setInterval(async () => {
            ...
            healthMetrics.errorRate = recentErrors.length / 5;
