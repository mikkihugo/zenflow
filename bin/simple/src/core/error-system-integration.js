...
import { BaseClaudeZenError, FACTError, NetworkError, RAGError, SwarmError, SystemError, WASMError, } from './errors.ts';
...
export class IntegratedErrorHandler {
    ...
    async checkEmergencyThresholds() {
        ...
        try {
            ...
            const memoryUsagePercent = (resilienceStatus.resources.memoryUsageMB / 512) * 100;
