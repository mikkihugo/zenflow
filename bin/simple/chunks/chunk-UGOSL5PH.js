...
var require_signal_exit = __commonJS({
  "node_modules/ink/node_modules/signal-exit/index.js"(exports, module) {
    ...
    var processOk = /* @__PURE__ */ __name(function(process14) {
  ...
  "node_modules/react-reconciler/cjs/react-reconciler.development.js"(exports, module) {
    ...
    module.exports = function($$$config) {
      ...
      HooksDispatcherOnMountInDEV = {
        ...
        useEffect: /* @__PURE__ */ __name(function(create2, createDeps) {
        ...
        useMemo: /* @__PURE__ */ __name(function(create2, deps) {
...
var iTerm = {
  setCwd: /* @__PURE__ */ __name((cwd2 = cwdFunction()) => `${OSC}50;CurrentDir=${cwd2}${BEL}`, "setCwd"),
...
__name(reduceAnsiCodes2, "reduceAnsiCodes");
...
__name(findNumberIndex2, "findNumberIndex");
...
__name(parseAnsiCode2, "parseAnsiCode");
...
var renderer = /* @__PURE__ */ __name((node) => {
  if (node.yogaNode) {
...
var create = /* @__PURE__ */ __name((stream, { showCursor = false } = {}) => {
...
function ErrorOverview({ error }) {
  ...
  return import_react10.default.createElement(
    ...
    origin && filePath && import_react10.default.createElement(
      Box_default,
      { marginTop: 1 },
      import_react10.default.createElement(
        Text,
    ...
    origin && excerpt && import_react10.default.createElement(Box_default, { marginTop: 1, flexDirection: "column" }, excerpt.map(({ line, value }) => import_react10.default.createElement(
      Box_default,
      { key: line },
      import_react10.default.createElement(
        Box_default,
      ...
      import_react10.default.createElement(Text, { key: line, backgroundColor: line === origin.line ? "red" : void 0, color: line === origin.line ? "white" : void 0 }, " " + value)
    ))),
    error.stack && import_react10.default.createElement(Box_default, { marginTop: 1, flexDirection: "column" }, error.stack.split("\n").slice(1).map((line) => {
      const parsedLine = stackUtils.parseLine(line);
      if (!parsedLine) {
        return import_react10.default.createElement(
          Box_default,
          { key: line },
          import_react10.default.createElement(Text, { dimColor: true }, "- "),
          import_react10.default.createElement(Text, { dimColor: true, bold: true }, line)
        );
      }
      return import_react10.default.createElement(
        Box_default,
        { key: line },
        import_react10.default.createElement(Text, { dimColor: true }, "- "),
        import_react10.default.createElement(Text, { dimColor: true, bold: true }, parsedLine.function),
        import_react10.default.createElement(
          Text,
...
var shiftTab = "\x1B[Z";
var escape = "\x1B";
var App = class extends import_react11.PureComponent {
  static {
    __name(this, "App");
  }
        ...
        import_react11.default.createElement(
          ...
          import_react11.default.createElement(
            ...
            import_react11.default.createElement(
              ...
              this.state.error ? import_react11.default.createElement(ErrorOverview, { error: this.state.error }) : this.props.children
            )
          )
        )
      )
  ...
  handleSetRawMode = /* @__PURE__ */ __name((isEnabled) => {
  ...
  handleReadable = /* @__PURE__ */ __name(() => {
    let chunk;
  ...
  handleInput = /* @__PURE__ */ __name((input) => {
  ...
  handleExit = /* @__PURE__ */ __name((error) => {
    if (this.isRawModeSupported()) {
      this.handleSetRawMode(false);
    }
    this.props.onExit(error);
  }, "handleExit");
  enableFocus = /* @__PURE__ */ __name(() => {
    this.setState({
      isFocusEnabled: true
    });
  }, "enableFocus");
  disableFocus = /* @__PURE__ */ __name(() => {
    this.setState({
      isFocusEnabled: false
    });
  }, "disableFocus");
  focus = /* @__PURE__ */ __name((id) => {
  ...
  addFocusable = /* @__PURE__ */ __name((id, { autoFocus }) => {
    this.setState((previousState) => {
  ...
  removeFocusable = /* @__PURE__ */ __name((id) => {
    this.setState((previousState) => ({
  ...
  activateFocusable = /* @__PURE__ */ __name((id) => {
    this.setState((previousState) => ({
  ...
  deactivateFocusable = /* @__PURE__ */ __name((id) => {
    this.setState((previousState) => ({
      activeFocusId: previousState.activeFocusId === id ? void 0 : previousState.activeFocusId,
      focusables: previousState.focusables.map((focusable) => {
        if (focusable.id !== id) {
  ...
  findNextFocusable = /* @__PURE__ */ __name((state) => {
  ...
  findPreviousFocusable = /* @__PURE__ */ __name((state) => {
    const activeIndex = state.focusables.findIndex((focusable) => {
      return focusable.id === state.activeFocusId;
    });
...
var Ink = class {
  ...
  render(node) {
    const tree = import_react12.default.createElement(App, { stdin: this.options.stdin, stdout: this.options.stdout, stderr: this.options.stderr, writeToStdout: this.writeToStdout, writeToStderr: this.writeToStderr, exitOnCtrlC: this.options.exitOnCtrlC, onExit: this.unmount }, node);
...
var render = /* @__PURE__ */ __name((node, options) => {
  ...
  return {
    ...
    cleanup: /* @__PURE__ */ __name(() => instances_default.delete(inkOptions.stdout), "cleanup"),
...
function Static(props) {
  ...
  const itemsToRender = (0, import_react13.useMemo)(() => {
  ...
  return import_react13.default.createElement("ink-box", { internal_static: true, style }, children);
}
...
function Transform({ children, transform }) {
  ...
  return import_react14.default.createElement("ink-text", { style: { flexGrow: 0, flexShrink: 1, flexDirection: "row" }, internal_transform: transform }, children);
}
...
function Newline({ count = 1 }) {
  return import_react15.default.createElement("ink-text", null, "\n".repeat(count));
}
...
function Spacer() {
  return import_react16.default.createElement(Box_default, { flexGrow: 1 });
}
...
var useApp = /* @__PURE__ */ __name(() => (0, import_react19.useContext)(AppContext_default), "useApp");
var use_app_default = useApp;

// node_modules/ink/build/hooks/use-stdout.js
var import_react20 = __toESM(require_react(), 1);
var useStdout = /* @__PURE__ */ __name(() => (0, import_react20.useContext)(StdoutContext_default), "useStdout");
var use_stdout_default = useStdout;

// node_modules/ink/build/hooks/use-stderr.js
var import_react21 = __toESM(require_react(), 1);
var useStderr = /* @__PURE__ */ __name(() => (0, import_react21.useContext)(StderrContext_default), "useStderr");
...
var useFocus = /* @__PURE__ */ __name(({ isActive = true, autoFocus = false, id: customId } = {}) => {
  ...
  const { activeId, add, remove, activate, deactivate, focus } = (0, import_react22.useContext)(FocusContext_default);
  const id = (0, import_react22.useMemo)(() => {
...
var useFocusManager = /* @__PURE__ */ __name(() => {
  const focusContext = (0, import_react23.useContext)(FocusContext_default);
  return {
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UGOSL5PH.js.map
