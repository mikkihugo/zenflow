...
var GitHubCodeAnalyzer = class {
  ...
  inferFilePurpose(filePath) {
    ...
    if (filePath.includes("model") || filePath.includes("schema")) return "Data modeling";
...
var github_code_analyzer_default = GitHubCodeAnalyzer;
export {
  GitHubCodeAnalyzer,
  github_code_analyzer_default as default
};
//# sourceMappingURL=github-code-analyzer-MYCYN5ET.js.map
