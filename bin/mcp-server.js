    ...
    try {
      switch (action) {
        case 'create':
          ...
          console.error(`[${new Date().toISOString()}] INFO [claude-flow-mcp] Created service document: ${documentKey}`);
        ...
        case 'update':
          ...
          console.error(`[${new Date().toISOString()}] INFO [claude-flow-mcp] Updated service document: ${documentKey}`);
    ...
    try {
      switch (action) {
        case 'queue':
          ...
          console.error(`[${new Date().toISOString()}] INFO [claude-flow-mcp] Queued document for approval: ${documentId}`);
        ...
        case 'approve':
          ...
          console.error(`[${new Date().toISOString()}] INFO [claude-flow-mcp] Approved document: ${documentId} by ${approver}`);
        ...
        case 'reject':
          ...
          console.error(`[${new Date().toISOString()}] INFO [claude-flow-mcp] Rejected document: ${documentId} by ${approver}`);
    ...
    try {
      switch (validateType) {
        case 'single-document':
          ...
          console.error(`[${new Date().toISOString()}] INFO [claude-flow-mcp] Validated single document: ${documentKey}`);
        ...
        case 'cross-service':
          ...
          console.error(`[${new Date().toISOString()}] INFO [claude-flow-mcp] Cross-service validation for: ${serviceName}`);
        ...
        case 'project-wide':
          ...
          console.error(`[${new Date().toISOString()}] INFO [claude-flow-mcp] Project-wide validation for: ${project}`);
