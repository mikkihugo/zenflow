...
class SwarmCoordinator {
  ...
  buildAgentCommand(agentType, config) {
    ...
    const specializations = {
      jsdoc:
        'Focus on JSDoc documentation violations. Fix missing file overviews, incomplete documentation, and example formatting.',
      typescript:
        'Focus on TypeScript violations. Replace explicit any types with proper types, fix unused variables, use nullish coalescing.',
      style:
        'Focus on code style violations. Fix semicolons, quotes, indentation, trailing spaces, and line endings.',
      imports:
        'Focus on import/export violations. Organize imports, remove duplicates, and optimize import statements.',
    };
