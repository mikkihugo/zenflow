...
export interface SAFeWorkflowMapping {
    ...
    readonly programMapping: {
        readonly artTrains: string[];
        readonly programIncrements: string[];
        readonly features: string[];
    };
...
export declare enum EnablerStatus {
    BACKLOG = "backlog",
    IN_PROGRESS = "in_progress",
    DONE = "done"
}
export declare enum SAFeMetricType {
    VELOCITY = "velocity",
...
declare const _default: {
    ...
    Story: any;
    Enabler: any;
    SAFeWorkflowMapping: any;
    SAFeIntegrationConfig: any;
    SAFeTransformationRules: any;
    SAFeImplementationConfig: any;
    ThemeStatus: typeof ThemeStatus;
    CapabilityStatus: typeof CapabilityStatus;
    PIStatus: typeof PIStatus;
    ObjectiveStatus: typeof ObjectiveStatus;
    FeatureStatus: typeof FeatureStatus;
    StoryStatus: typeof StoryStatus;
    EnablerStatus: typeof EnablerStatus;
    SAFeMetricType: typeof SAFeMetricType;
};
export default _default;
export type { SAFePortfolio, StrategicTheme, ValueStream, Solution, Capability, AgileReleaseTrain, ProgramIncrement, PIObjective, Feature, ARTTeam, Story, Enabler, SAFeWorkflowMapping, SAFeIntegrationConfig, SAFeTransformationRules, TransformationRule, DependencyMappingRule, SAFeImplementationConfig, SAFeFrameworkConfig, SAFeCeremoniesConfig, SAFeMetricsConfig, SAFeGovernanceConfig, TimeHorizon, Customer, ValueFlowStep, ValueStreamMetrics, SolutionIntent, SolutionArchitecture, Risk, Dependency, LeanBudget, Guardrail, PortfolioKPI, };
