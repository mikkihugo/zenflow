...
class HealthMonitor {
    _config;
    _logger;
    constructor(_config, // For future health check configuration
    _logger // For health monitoring logs
    ) {
    ...
    checkResponsiveness(agent) {
        ...
        if (timeSinceLastSeen > 60000)
            return 0; // No activity in 1 minute
        if (timeSinceLastSeen > 30000)
            return 0.5; // No activity in 30 seconds
        return 1.0;
    }
...
class PerformanceTracker {
    _config;
    _logger;
    constructor(_config, // For future performance thresholds
    _logger // For performance tracking logs
    ) {
        this._config = _config;
        this._logger = _logger;
