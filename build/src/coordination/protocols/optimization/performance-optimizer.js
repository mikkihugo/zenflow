...
export class PerformanceOptimizer extends EventEmitter {
    ...
    getOptimizationStatus() {
        ...
        const lastOptimization = this.optimizationHistory.length > 0 && lastItem ? lastItem?.timestamp : new Date(0);
    ...
    async measureOptimizationImpact(_action) {
        ...
        const throughputImprovement = (currentMetrics?.throughput?.requestsPerSecond -
            ...
            baselineMetrics.throughput.requestsPerSecond;
        const resourceImprovement = (baselineMetrics.resourceUsage.cpuUsage - currentMetrics?.resourceUsage?.cpuUsage) /
            baselineMetrics.resourceUsage.cpuUsage;
        // Weighted average of improvements
        const impact = latencyImprovement * 0.4 + throughputImprovement * 0.4 + resourceImprovement * 0.2;
