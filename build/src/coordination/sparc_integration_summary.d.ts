 ...
 */
export declare const SPARC_SWARM_INTEGRATION_SUMMARY: {
    readonly implemented: true;
    readonly architecture: "database-driven + sparc-swarm-coordination";
    readonly components: readonly ["SPARCSwarmCoordinator", "DatabaseSPARCBridge", "Enhanced TaskCoordinator", "CLI Commands", "Integration Examples"];
    readonly methodology: "SPARC phases applied by specialized swarm agents";
    readonly status: "integration-complete";
    readonly usage: "claude-zen sparc-swarm [command]";
};
//# sourceMappingURL=sparc_integration_summary.d.ts.map