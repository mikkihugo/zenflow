...
export class HiveTools {
    ...
    async hiveQuery(params = {}) {
        try {
            ...
            const allResults = [...localSearch, ...memorySearch, ...swarmSearchResults].sort((a, b) => b.confidence - a.confidence);
            const results = {
                query,
                domain,
