...
export class ArchitecturePhaseEngine {
    ...
    async generateInterfaceMethods(component) {
        const methods = [];
        if (component.type === 'service') {
            methods.push({ name: 'execute', parameters: ['input'], returns: 'Promise<Result>' }, { name: 'validate', parameters: ['input'], returns: 'ValidationResult' }, { name: 'getStatus', parameters: [], returns: 'ServiceStatus' });
        }
        else if (component.type === 'data-manager') {
            methods.push({ name: 'create', parameters: ['data'], returns: 'Promise<string>' }, { name: 'read', parameters: ['id'], returns: 'Promise<Data>' }, { name: 'update', parameters: ['id', 'data'], returns: 'Promise<void>' }, { name: 'delete', parameters: ['id'], returns: 'Promise<void>' });
        }
        return methods;
    }
