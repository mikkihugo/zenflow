 ...
 */
import type { AlgorithmPseudocode, ControlFlowDiagram, DataStructureDesign, DetailedSpecification, FunctionalRequirement, LogicValidation, OptimizationSuggestion, PseudocodeEngine, PseudocodeStructure, PseudocodeValidation } from '../../types/sparc-types.ts';
