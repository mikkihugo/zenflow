 ...
 */
import type { SPARCTemplate } from '../types/sparc-types.ts';
export declare const MEMORY_SYSTEMS_TEMPLATE: SPARCTemplate;
//# sourceMappingURL=memory-systems-template.d.ts.map