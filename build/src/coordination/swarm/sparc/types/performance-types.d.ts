...
export type OptimizationType = 'performance' | 'memory' | 'network' | 'algorithm' | 'architecture' | 'caching' | 'database' | 'parallelization';
export type BottleneckType = 'cpu' | 'memory' | 'network' | 'disk' | 'algorithm' | 'database' | 'external_api' | 'concurrency';
