...
export class SwarmKnowledgeSync extends EventEmitter {
    ...
    getFallbackKnowledge(_query, domain) {
        ...
        const relevantLearning = this.learningHistory.find((learning) => learning.domain === domain && learning.outcome.success && learning.confidence > 0.8);
        if (relevantLearning) {
            return {
