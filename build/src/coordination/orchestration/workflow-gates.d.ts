...
import { GateEscalationLevel, type WorkflowGateRequest } from '../workflows/workflow-gate-request.ts';
/**
...
export declare class GatePersistenceManager {
    ...
    addHistoryEntry(gateId: string, action: string, actor: string, data?: any): Promise<void>;
