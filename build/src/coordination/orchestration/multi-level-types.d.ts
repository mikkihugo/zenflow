 ...
 */
export declare enum PortfolioPriority {
 ...
 */
export declare enum PortfolioGateType {
 ...
 */
export declare enum ProgramPriority {
 ...
 * Program gate types
 */
export declare enum ProgramGateType {
 ...
 */
export declare enum AIAssistanceLevel {
    NONE = "none",
    ADVISORY = "advisory",
 ...
 */
export declare enum HumanOversightLevel {
    MINIMAL = "minimal",
    PERIODIC = "periodic",
 ...
 */
export declare enum SwarmExecutionPriority {
    URGENT = "urgent",
    HIGH = "high",
    NORMAL = "normal",
    LOW = "low"
...
//# sourceMappingURL=multi-level-types.d.ts.map