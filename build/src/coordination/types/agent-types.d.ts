...
export type AgentType = 'researcher' | 'coder' | 'analyst' | 'optimizer' | 'coordinator' | 'tester' | 'architect' | 'specialist';
export type AgentStatus = 'idle' | 'busy' | 'offline' | 'error' | 'initializing';
...
export interface AgentRegistry {
    ...
    updateAgentPerformance(agentId: string, performance: Partial<AgentPerformance>): Promise<void>;
}
