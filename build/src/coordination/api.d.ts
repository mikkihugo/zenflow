 ...
 */
import type { Agent, CoordinationError, HealthStatus, PerformanceMetrics, SwarmConfig, Task } from './schemas.ts';
/**
 * @swagger
 * tags:
 *   - name: Agents
...
export declare class AgentAPI {
     ...
     *               $ref: '#/components/schemas/Error'
     */
    static getAgent(_agentId: string): Promise<Agent>;
    /**
     * @param _agentId
     * @swagger
     * /api/v1/agents/{agentId}:
     ...
     *               $ref: '#/components/schemas/Error'
     */
    static removeAgent(_agentId: string): Promise<void>;
}
/**
 * Task Management API
...
export declare class TaskAPI {
     ...
     *               $ref: '#/components/schemas/Task'
     */
    static getTask(_taskId: string): Promise<Task>;
}
/**
...
export declare class SwarmAPI {
     ...
     */
    static getConfig(): Promise<SwarmConfig>;
    /**
     * @param _config
     * @swagger
     * /api/v1/swarm/config:
     ...
     *               $ref: '#/components/schemas/Error'
     */
    static updateConfig(_config: SwarmConfig): Promise<SwarmConfig>;
}
/**
...
export declare class HealthAPI {
     ...
     *               $ref: '#/components/schemas/HealthStatus'
     */
    static getHealth(): Promise<HealthStatus>;
    /**
     * @param _timeRange
     * @swagger
     * /api/v1/metrics:
     ...
     */
    static getMetrics(_timeRange?: '1h' | '24h' | '7d' | '30d'): Promise<PerformanceMetrics>;
}
/**
 * API Error Handler.
...
export declare class APIErrorHandler {
    static createError(code: CoordinationError['code'], message: string, details?: Record<string, unknown>, traceId?: string): CoordinationError;
    static handleError(error: unknown, traceId?: string): CoordinationError;
}
export declare const CoordinationAPI: {
    readonly agents: typeof AgentAPI;
    readonly tasks: typeof TaskAPI;
    readonly swarm: typeof SwarmAPI;
    readonly health: typeof HealthAPI;
    readonly errors: typeof APIErrorHandler;
};
