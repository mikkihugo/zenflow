...
export class BatchPerformanceMonitor {
    ...
    recordBatchExecution(summary, resourceUsage) {
        const metrics = {
            ...
            successRate: summary.totalOperations > 0 ? summary.successfulOperations / summary.totalOperations : 0,
    ...
    comparePerformance(batchMetrics, sequentialMetrics) {
        const speedImprovement = sequentialMetrics.totalExecutionTime > 0
            ...
            : 1;
        const throughputImprovement = sequentialMetrics.throughput > 0 ? batchMetrics.throughput / sequentialMetrics.throughput : 1;
