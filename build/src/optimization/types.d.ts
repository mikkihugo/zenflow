...
export type OptimizationTarget = 'performance' | 'memory' | 'throughput' | 'latency' | 'accuracy' | 'energy' | 'cost' | 'quality';
...
export declare class OptimizationError extends Error {
    ...
    readonly target?: OptimizationTarget | undefined;
    constructor(message: string, code?: string | undefined, target?: OptimizationTarget | undefined);
}
export declare class OptimizationConfigError extends OptimizationError {
    readonly config?: Partial<OptimizationConfig> | undefined;
    constructor(message: string, config?: Partial<OptimizationConfig> | undefined);
}
export declare class OptimizationTimeoutError extends OptimizationError {
    readonly timeout?: number | undefined;
    constructor(message: string, timeout?: number | undefined);
}
export interface OptimizationEvent {
    readonly type: 'optimization_started' | 'optimization_completed' | 'optimization_failed' | 'strategy_applied' | 'metrics_updated' | 'recommendation_generated';
    readonly target?: OptimizationTarget;
