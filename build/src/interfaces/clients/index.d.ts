 ...
 * ```
 */
import { type ClientManager, ClientManagerHelpers } from './manager.ts';
import { type ClientInstance, ClientType, type HTTPClientConfig, type KnowledgeClientConfig, type MCPClientConfig, type WebSocketClientConfig } from './registry.ts';
...
export { createCustomKnowledgeClient, createFACTClient, KnowledgeClientAdapter, type KnowledgeClientConfig as UACLKnowledgeClientConfig, KnowledgeClientFactory, KnowledgeHelpers, type KnowledgeRequest, type KnowledgeResponse, } from './adapters/knowledge-client-adapter.ts';
export * from './adapters/websocket-index.ts';
export type { ClientConfig as CoreClientConfig, ClientMetrics as CoreClientMetrics, ClientResponse as CoreClientResponse, ClientStatus as CoreClientStatus, IClient, IClientFactory, RequestOptions as CoreRequestOptions, } from './core/interfaces.ts';
...
export { type BaseClientConfig, type ClientConfig, type ClientFactory, type ClientInstance, ClientRegistry, ClientRegistryHelpers, ClientType, globalClientRegistry, type HTTPClientConfig, type KnowledgeClientConfig, type MCPClientConfig, type WebSocketClientConfig, } from './registry.ts';
/**
 * UACL Main Interface.
 *
 ...
 * ```
 */
export declare const uacl: UACL;
/**
 ...
 * ```
 */
export declare const initializeUACL: (config?: ClientManagerConfig) => Promise<void>;
/**
 ...
 */
export declare const UACLHelpers: {
    /**
...
export { printValidationReport, UACLValidator, type ValidationReport, type ValidationResult, validateUACL, } from './validation.ts';
/**
