...
export declare class EventError extends Error {
     ...
     */
    constructor(message: string, code: string, manager: string, eventId?: string | undefined, cause?: Error | undefined);
}
/**
...
export declare class EventFilterError extends EventError {
...
export declare class EventRetryExhaustedError extends EventError {
...
export declare const EventTypeGuards: {
     ...
     */
    readonly isEventManagerType: (value: any) => value is EventManagerType;
    /**
     ...
     */
    readonly isEventPriority: (value: any) => value is EventPriority;
    /**
     ...
     */
    readonly isEventProcessingStrategy: (value: any) => value is EventProcessingStrategy;
    /**
     ...
     */
    readonly isSystemEvent: (value: any) => value is SystemEvent;
    /**
     ...
     */
    readonly isEventManagerConfig: (value: any) => value is EventManagerConfig;
};
