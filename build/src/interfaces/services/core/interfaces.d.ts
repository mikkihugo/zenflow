...
export declare class ServiceError extends Error {
    ...
    constructor(message: string, code: string, serviceName: string, cause?: Error | undefined);
}
export declare class ServiceInitializationError extends ServiceError {
    constructor(serviceName: string, cause?: Error);
}
export declare class ServiceConfigurationError extends ServiceError {
    constructor(serviceName: string, details: string, cause?: Error);
}
export declare class ServiceDependencyError extends ServiceError {
    constructor(serviceName: string, dependency: string, cause?: Error);
}
export declare class ServiceOperationError extends ServiceError {
