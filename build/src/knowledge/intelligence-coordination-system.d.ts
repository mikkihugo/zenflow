...
export type DiscoveryType = 'behavioral-analysis' | 'performance-tracking' | 'peer-assessment' | 'self-assessment' | 'collaborative-evaluation' | 'automated-testing';
...
export type RoutingAlgorithm = 'shortest-path' | 'load-balanced' | 'expertise-weighted' | 'multi-criteria' | 'reinforcement-learning' | 'genetic-algorithm';
export type LoadBalancingAlgorithm = 'round-robin' | 'weighted-round-robin' | 'least-connections' | 'least-response-time' | 'resource-based' | 'adaptive';
export type OptimizationObjective = 'minimize-latency' | 'maximize-accuracy' | 'balance-load' | 'minimize-cost' | 'maximize-reliability' | 'optimize-learning';
/**
...
export type EmergencePatternType = 'skill-clustering' | 'domain-specialization' | 'collaboration-patterns' | 'performance-optimization' | 'knowledge-concentration' | 'innovation-emergence';
export type EmergenceDetectionType = 'threshold-based' | 'trend-analysis' | 'clustering-analysis' | 'network-analysis' | 'statistical-testing' | 'machine-learning';
export type AdaptationType = 'task-reassignment' | 'capability-enhancement' | 'collaboration-restructuring' | 'learning-guidance' | 'resource-reallocation';
/**
...
export type AnalogyType = 'surface-similarity' | 'structural-analogy' | 'functional-analogy' | 'causal-analogy' | 'pragmatic-analogy' | 'systematic-analogy';
export type AbstractionLevel = 'concrete-instances' | 'specific-patterns' | 'general-principles' | 'abstract-concepts' | 'universal-laws' | 'meta-principles';
/**
...
export type RetrievalStrategy = 'associative-retrieval' | 'content-based-retrieval' | 'context-dependent-retrieval' | 'similarity-based-retrieval' | 'temporal-retrieval' | 'importance-based-retrieval';
/**
 * Main Intelligence Coordination System.
 *
 * @example
 */
export declare class IntelligenceCoordinationSystem extends EventEmitter {
    private logger;
    private eventBus;
    private config;
    private expertiseDiscovery;
    private knowledgeRouting;
    private specializationDetector;
    private crossDomainTransfer;
    private collectiveMemory;
    private expertiseProfiles;
    private routingTable;
    private emergentSpecializations;
    private knowledgeTransfers;
    private coordinationHistory;
     ...
     * @param agents
     */
    discoverSwarmExpertise(agents: string[]): Promise<ExpertiseDiscoveryResult>;
    /**
     ...
     */
    routeKnowledgeQuery(query: KnowledgeQuery, routingOptions?: RoutingOptions): Promise<RoutingResult>;
    /**
     * Detect and foster agent specialization emergence.
     *
     * @param observationPeriod
     */
    detectSpecializationEmergence(observationPeriod?: number): Promise<SpecializationEmergenceResult>;
    /**
    ...
    private getAverageExpertiseLevel;
    private getExpertiseCoverage;
    private getDiscoveryAccuracy;
    private getRoutingSuccessRate;
    private getAverageRoutingLatency;
    private getLoadBalanceEfficiency;
    private getEmergenceRate;
    private getAdaptationSuccessRate;
    private getSpecializationDiversity;
    private getTransferSuccessRate;
    private getAverageTransferEffectiveness;
    private getDomainCoverage;
    private getStoredMemoryCount;
    private getMemoryUtilization;
    private getRetrievalEfficiency;
    private getKnowledgeGrowthRate;
    private propagateMemoryInsights;
}
/**
...
export type TransferType = 'analogy-based' | 'abstraction-based' | 'case-based' | 'rule-based' | 'model-based' | 'pattern-based';
...
//# sourceMappingURL=intelligence-coordination-system.d.ts.map