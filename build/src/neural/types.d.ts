...
export type ActivationFunction = 'relu' | 'sigmoid' | 'tanh' | 'softmax' | 'leaky_relu' | 'elu' | 'swish' | 'gelu' | 'linear';
export type CognitivePatternType = 'convergent' | 'divergent' | 'lateral' | 'systems' | 'critical' | 'adaptive' | 'creative' | 'analytical' | 'holistic' | 'sequential';
...
export interface DAAAgent {
    ...
    readonly capabilities: readonly string[];
    readonly neuralNetworks: readonly string[];
    readonly learningRate: number;
...
export type DAAAgentStatus = 'idle' | 'learning' | 'processing' | 'collaborating' | 'adapting' | 'error';
...
export declare class NeuralError extends Error {
    ...
    constructor(message: string, code?: string | undefined, networkId?: string | undefined);
}
export declare class TrainingError extends NeuralError {
    readonly epoch?: number | undefined;
    readonly loss?: number | undefined;
    constructor(message: string, epoch?: number | undefined, loss?: number | undefined);
}
export declare class ModelError extends NeuralError {
    readonly modelConfig?: Partial<NeuralModelConfig> | undefined;
    constructor(message: string, modelConfig?: Partial<NeuralModelConfig> | undefined);
}
export declare class CognitivePatternError extends NeuralError {
    readonly patternType?: CognitivePatternType | undefined;
    constructor(message: string, patternType?: CognitivePatternType | undefined);
}
export interface NeuralEvent {
    readonly type: 'model_created' | 'training_started' | 'training_completed' | 'training_failed' | 'inference_completed' | 'pattern_evolved' | 'coordination_sync';
...
export interface NeuralUtilities {
    ...
    splitTrainValidation(data: TrainingData, split: number): {
        train: TrainingData;
