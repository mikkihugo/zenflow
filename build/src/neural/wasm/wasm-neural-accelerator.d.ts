 ...
 */
import type { WASMNeuralAccelerator as IWASMNeuralAccelerator, WASMBenchmarkResult, WASMModelDefinition, WASMNeuralConfig, WASMOptimizationOptions, WASMPerformanceMetrics, WASMPredictionInput, WASMPredictionOutput, WASMTrainingData } from '../types/wasm-types.ts';
/**
 ...
 * @example
 */
export declare class WASMNeuralAccelerator implements IWASMNeuralAccelerator {
    private config;
