...
class NeuralNetworkManager {
    ...
    async createAgentForUseCase(agentId, useCase, customConfig = {}) {
        ...
        if (!recommendedPreset) {
            ...
            return this.createAgentFromPreset(agentId, bestMatch?.type, // Use type instead of category
            bestMatch?.id, // Use id instead of presetName
            customConfig);
        }
        return this.createAgentFromPreset(agentId, recommendedPreset.type, // Use type instead of category
