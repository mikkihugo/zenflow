...
import { type IConfig, type ILogger } from '../../di/tokens/core-tokens.ts';
/**
...
export declare class MemoryProviderFactory {
    ...
    private config;
    private dalFactory;
    constructor(logger: ILogger, config: IConfig, dalFactory: DALFactory);
    /**
...
export declare class SqliteMemoryBackend implements MemoryBackend {
    ...
    private repository;
    private initialized;
    constructor(config: MemoryConfig, logger: ILogger, dalFactory: DALFactory);
    store(key: string, value: unknown): Promise<void>;
    retrieve<T = unknown>(key: string): Promise<T | null>;
    delete(key: string): Promise<boolean>;
    clear(): Promise<void>;
...
export declare class JsonMemoryBackend implements MemoryBackend {
    ...
    private data;
    private initialized;
    constructor(config: MemoryConfig, logger: ILogger);
    store(key: string, value: unknown): Promise<void>;
    retrieve<T = unknown>(key: string): Promise<T | null>;
    delete(key: string): Promise<boolean>;
    clear(): Promise<void>;
