 ...
 */
import type { MemoryConfig, MemoryProviderFactory } from '../providers/memory-providers.ts';
/**
...
export declare class MemoryController {
    ...
    constructor(_factory: MemoryProviderFactory, _config: MemoryConfig, _logger: ILogger);
    /**
