...
export declare class MCPValidationError extends MCPError {
    ...
    constructor(message: string, parameterName: string, expectedType: string, actualValue: any, toolName?: string);
}
...
export declare class WASMExecutionError extends WASMError {
    ...
    constructor(message: string, functionName: string, parameters?: any[] | undefined, severity?: 'low' | 'medium' | 'high' | 'critical');
}
...
export declare class ValidationError extends BaseClaudeZenError {
    ...
    readonly expectedValue?: any | undefined;
     ...
     */
    constructor(message: string, field?: string | undefined, expectedValue?: any | undefined, actualValue?: any | undefined);
}
...
export declare class ConfigurationError extends BaseClaudeZenError {
    ...
    readonly configValue?: any | undefined;
    constructor(message: string, configKey?: string | undefined, configValue?: any | undefined);
}
