...
export declare class MemorySystem extends EventEmitter {
    ...
    storeDocument(type: string, id: string, document: any, namespace?: string): Promise<StorageResult>;
    retrieveDocument(type: string, id: string, namespace?: string): Promise<any>;
    searchDocuments(type: string, namespace?: string): Promise<Record<string, any>>;
    storeVision(id: string, vision: any): Promise<StorageResult>;
    storeADR(id: string, adr: any): Promise<StorageResult>;
    storePRD(id: string, prd: any): Promise<StorageResult>;
    storeEpic(id: string, epic: any): Promise<StorageResult>;
    storeFeature(id: string, feature: any): Promise<StorageResult>;
    storeTask(id: string, task: any): Promise<StorageResult>;
}
