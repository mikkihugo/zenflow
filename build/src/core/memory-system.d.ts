...
export declare class MemorySystem extends EventEmitter {
     ...
     * @returns Storage result.
     */
    storeDocument(type: string, id: string, document: any): Promise<StorageResult>;
    /**
     ...
     */
    retrieveDocument(type: string, id: string): Promise<any>;
    /**
     ...
     */
    searchDocuments(type: string): Promise<Record<string, any>>;
    /**
     ...
     * @returns Storage result.
     */
    storeWorkflow(workflowId: string, workflow: any): Promise<StorageResult>;
    /**
     ...
     */
    retrieveWorkflow(workflowId: string): Promise<any>;
    /**
     ...
     */
    searchWorkflows(pattern?: string): Promise<Record<string, any>>;
}
