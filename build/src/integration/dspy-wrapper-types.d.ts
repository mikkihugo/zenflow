 ...
 */
export type DSPyOptimizationStrategy = 'auto' | 'bootstrap' | 'teleprompter' | 'manual' | 'gradient' | 'evolutionary';
/**
 ...
 * @example
 */
export declare class DSPyWrapperError extends Error {
    code: DSPyErrorCode;
    cause?: Error | undefined;
    metadata?: Record<string, any> | undefined;
    constructor(message: string, code: DSPyErrorCode, cause?: Error | undefined, metadata?: Record<string, any> | undefined);
}
export type DSPyErrorCode = 'PROGRAM_NOT_FOUND' | 'SIGNATURE_PARSE_ERROR' | 'EXECUTION_FAILED' | 'OPTIMIZATION_FAILED' | 'LM_DRIVER_ERROR' | 'CONFIGURATION_ERROR' | 'TIMEOUT_ERROR' | 'RATE_LIMIT_ERROR' | 'PARSING_ERROR' | 'VALIDATION_ERROR';
/**
...
export type DSPyProgramCategory = 'code_analysis' | 'code_generation' | 'error_diagnosis' | 'task_orchestration' | 'swarm_optimization' | 'text_processing' | 'data_extraction' | 'classification' | 'summarization' | 'translation' | 'custom';
/**
...
declare const _default: {
    DSPyWrapperError: typeof DSPyWrapperError;
};
export default _default;
//# sourceMappingURL=dspy-wrapper-types.d.ts.map