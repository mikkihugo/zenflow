...
import type { DatabaseConfig, DatabaseProviderFactory } from '../providers/database-providers.ts';
/**
...
export declare class DatabaseController {
    ...
    constructor(_factory: DatabaseProviderFactory, _config: DatabaseConfig, _logger: ILogger);
    /**
