 ...
 */
export type { ADREntity, BaseDocumentEntity, BaseEntity, CodeSnippetEntity, CompetitorAnalysisEntity, EpicEntity, ExecutionPlanEntity, FeatureEntity, ProductRequirementDocumentEntity, ProductVisionEntity, ProjectTemplateEntity, QueryResultEntity, RiskAssessmentEntity, StakeholderEntity, SWOTAnalysisEntity, TaskEntity, TestCaseEntity, UserStoryEntity, WorkflowRunEntity, WorkflowStepEntity, } from './entities/product-entities.ts';
...
export declare class MigrationError extends DatabaseError {
    readonly migrationVersion?: string | undefined;
    constructor(message: string, migrationVersion?: string | undefined);
}
export declare class ConnectionError extends DatabaseError {
    readonly connectionConfig?: Partial<DatabaseConfig> | undefined;
    constructor(message: string, connectionConfig?: Partial<DatabaseConfig> | undefined);
}
export declare class QueryError extends DatabaseError {
    readonly query?: string | undefined;
    readonly parameters?: unknown[] | undefined;
    constructor(message: string, query?: string | undefined, parameters?: unknown[] | undefined);
}
