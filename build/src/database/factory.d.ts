...
import type { IDataAccessObject, IGraphRepository, IRepository, IVectorRepository } from './interfaces.ts';
/**
 ...
 * ```
 */
export type RepositoryType<T> = IRepository<T> | IGraphRepository<T> | IVectorRepository<T> | IMemoryRepository<T> | ICoordinationRepository<T>;
/**
 ...
 * ```
 */
export declare class DALFactory {
    private _logger;
    private _config;
    ...
    constructor(_logger: ILogger, _config: IConfig, databaseProviderFactory: DatabaseProviderFactory);
    /**
     ...
     * ```
     */
    createRepository<T>(config: RepositoryConfig): Promise<RepositoryType<T>>;
    /**
     ...
     * ```
     */
    createDAO<T>(config: RepositoryConfig): Promise<IDataAccessObject<T>>;
    /**
     ...
     * ```
     */
    createKuzuGraphRepository<T>(entityType: string, tableName?: string): Promise<IGraphRepository<T>>;
    /**
     ...
     * ```
     */
    createLanceDBVectorRepository<T>(entityType: string, vectorDimension?: number): Promise<IVectorRepository<T>>;
    /**
     ...
     * ```
     */
    createCoordinationRepository<T>(entityType: string): Promise<ICoordinationRepository<T>>;
    /**
     ...
     * ```
     */
    createMemoryRepository<T>(entityType: string): Promise<IMemoryRepository<T>>;
    /**
     ...
     * ```
     */
    createMultiDatabaseDAO<T>(entityType: string, primaryConfig: RepositoryConfig, secondaryConfigs?: RepositoryConfig[]): Promise<MultiDatabaseDAO<T>>;
    /**
     * Clear all caches.
     */
    clearCaches(): void;
    ...
    private createRepositoryInstance;
    private createDAOInstance;
    private generateCacheKey;
    private generateAdapterCacheKey;
    private getDefaultKuzuConfig;
    private getDefaultLanceDBConfig;
    private initializeEntityRegistry;
}
/**
 ...
 * @example
 */
export declare class MultiDatabaseDAO<T> implements IDataAccessObject<T> {
    private primaryDAO;
    private secondaryDAOs;
    private logger;
    constructor(primaryDAO: IDataAccessObject<T>, secondaryDAOs: IDataAccessObject<T>[], logger: ILogger);
    getRepository(): IRepository<T>;
    executeTransaction<R>(operations: any[]): Promise<R>;
