    ...
    handler: async (params) => {
        try {
            ...
            const query = {
                ...
                type: operation.includes('search') || operation.includes('find') || operation.includes('get')
                    ? 'select'
            ...
            const response = {
                ...
                metadata: {
                    timestamp: Date.now(),
                    originalQuery: query,
                    optimizedQuery: optimizedQuery.id !== query.id
                        ? optimizedQuery
                        : undefined,
        ...
        try {
            ...
            const healthReport = {
                ...
                components: {
                    ...
                    engines: undefined,
                    cache: undefined,
                    clients: undefined, // Added UACL client health
                },
                issues: [],
                recommendations: [],
                repairs: [],
