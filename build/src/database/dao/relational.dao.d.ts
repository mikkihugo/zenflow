 ...
 * ```
 */
export declare class RelationalDao<T> extends BaseDao<T> implements IDao<T> {
    /**
     ...
     * ```
     */
    findWithJoin(joinTable: string, joinCondition: string, criteria?: Partial<T>, options?: any): Promise<T[]>;
    /**
     ...
     * ```
     */
    search(field: string, searchTerm: string, _options?: any): Promise<T[]>;
    /**
     ...
     * ```
     */
    findByDateRange(dateField: string, startDate: Date, endDate: Date, options?: any): Promise<T[]>;
    /**
