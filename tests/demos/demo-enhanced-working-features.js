...
async function demoQueenCoordinatorEnhancements() {
  ...
  try {
    ...
    console.warn(`✅ Enhanced decision-making: ${decision.choice}`);
    console.warn(`✅ Decision confidence: ${decision.confidence}%`);
    ...
    console.warn(`✅ Plugin coordination: ${coordinationResult.status}`);
    console.warn(`✅ Healthy plugins: ${coordinationResult.healthy.length}`);
    console.warn(`✅ Recovered plugins: ${coordinationResult.recovered.length}`);
...
async function demoSystemHealthMonitoring() {
  ...
  try {
    ...
    for (const check of healthChecks) {
      try {
        await check.test();
        console.warn(`✅ ${check.component}: Healthy`);
      } catch (_error) {
