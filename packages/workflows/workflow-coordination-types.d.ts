 ...
 */
export declare function createWorkflowGateRequest(gateId: string, workflowId: string, stepId: string, context: Record<string, unknown>, options?: Partial<Pick<WorkflowGateRequest, 'priority' | 'metadata'>>): WorkflowGateRequest;
/**
 * Factory function for creating workflow gate responses.
 */
export declare function createWorkflowGateResponse(request: WorkflowGateRequest, status: WorkflowGateResponse['status'], options?: Partial<Pick<WorkflowGateResponse, 'result' | 'message'>>): WorkflowGateResponse;
