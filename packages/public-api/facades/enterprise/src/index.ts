 ...
 * • @claude-zen/document-intelligence: SAFe artifact intelligence and database management
...
export * from './safe-artifact-intelligence';
...
export const enterpriseSystem = {
  ...
  safeArtifactIntelligence: () => import('./safe-artifact-intelligence'),
