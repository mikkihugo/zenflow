 ...
 */
import { type DatabaseConfig, type DatabaseConnection, type QueryResult, type SqlStorage, type TableSchema, type TransactionContext} from "../types/index.js";
export declare class SQLStorageImpl implements SqlStorage {
    ...
    getTableInfo(tableName:string): Promise<Array<{
        name:string;
        type:string;
        nullable:boolean;
}>>;
