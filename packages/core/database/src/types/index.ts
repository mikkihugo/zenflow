...
export enum IsolationLevel {
  ReadUncommitted = 'READ_UNCOMMITTED',  ReadCommitted = 'READ_COMMITTED',  RepeatableRead = 'REPEATABLE_READ',  Serializable = 'SERIALIZABLE',}
...
export interface GraphStorage {
  ...
  getConnections(
    nodeId:string,
    direction?:'in' | ' out' | ' both',    edgeType?:string
