...
export declare function createDatabase(type: 'sqlite' | 'memory', database: string): Promise<import("@claude-zen/foundation").SQLiteAdapter>;
...
export declare function createDatabaseAccess(config?: unknown): {
    createConnection: (dbConfig: {
        type?: string;
        database: string;
    }) => Promise<import("@claude-zen/foundation").SQLiteAdapter>;
...
export declare class DatabaseEventCoordinator extends EventEmitter {
    ...
    connect(type: 'sqlite' | 'memory', database: string): Promise<import("@claude-zen/foundation").SQLiteAdapter>;
...
export declare class DatabaseProvider extends DatabaseEventCoordinator {
    ...
    createConnection(type: 'sqlite' | 'memory', database: string): Promise<import("@claude-zen/foundation").SQLiteAdapter>;
