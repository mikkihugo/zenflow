 ...
 */
export declare function createResourceError(
  message: string,
  options?: {
    resourceId?: string;
    resourceType?: string;
 ...
 */
export declare function createError<E extends BaseError>(
  error: E
): ErrorResult<E>;
/**
 * Check if result is successful (type guard)
 */
export declare function isSuccess<T, E extends BaseError>(
  result: Result<T, E>
): result is SuccessResult<T>;
/**
 * Check if result is an error (type guard)
 */
export declare function isError<T, E extends BaseError>(
  result: Result<T, E>
