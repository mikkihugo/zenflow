 ...
 */
export declare function createPaginationMetadata(
  currentPage: number,
  pageSize: number,
  totalItems: number
): PaginationMetadata;
 ...
 */
export declare function createPaginated<T>(
  items: T[],
  currentPage: number,
  pageSize: number,
  totalItems: number
 ...
 */
export declare function createSuccessResult<T>(
  data: T,
  metadata?: Record<string, unknown>
): OperationResult<T>;
/**
 ...
 */
export declare function createErrorResult<E = Error>(
  error: E,
  metadata?: Record<string, unknown>
 ...
 */
export declare function isSuccessResult<T, E>(
  result: OperationResult<T, E>
): result is OperationResult<T, E> & {
  success: true;
  data: T;
};
/**
 ...
 */
export declare function isErrorResult<T, E>(
  result: OperationResult<T, E>
): result is OperationResult<T, E> & {
  success: false;
  error: E;
