...
export class WorkspaceDetector {
     ...
     */
    async detectWorkspaceRoot(startPath = process.cwd()) {
        try {
     ...
     */
    async getWorkspacePackages(rootDir) {
        try {
            ...
            return workspaces.map((workspace) => {
                ...
                const workspaceName = workspace.name || path.basename(workspace.location);
     ...
     */
    detectFramework(projectDir, packageFile) {
     ...
     */
    detectLanguage(_projectDir, packageFile) {
        if (!packageFile) {
            return undefined;
        }
        const languageMap = {
