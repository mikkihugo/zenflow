...
export declare function isErrorWithContext(
  value: unknown
 ...
 */
export declare function withTimeoutLegacy<T>(
  fn: () => Promise<T>,
  timeoutMs: number,
  timeoutMessage?: string
): Promise<Result<T, TimeoutError>>;
 ...
 */
export declare function executeAll<T>(
  operations: (() => Promise<T>)[]
): Promise<Result<T[], Error[]>>;
/**
 * Execute all operations and return only successful results
 */
export declare function executeAllSuccessful<T>(
  operations: (() => Promise<T>)[]
): Promise<Result<T[], Error[]>>;
/**
 * Transform errors in Result chains
 */
export declare function transformError<T, E, F>(
  result: Result<T, E>,
 ...
 */
export declare function createErrorRecovery<T>(
  fallbackValue: T,
 ...
 */
export declare function createErrorChain(
  baseError: Error,
