 ...
 *   query: 'react hooks best practices performance optimization', *   sources:['github',    'npm',    'docs',    'api-docs'],
 *   limit:20,
 *   includeCode:true,
 ...
 *   database:{
 *     backend: 'lancedb', *     vectorDimensions:1536,
 *     indexType: 'hnsw', *     metricType:'cosine') *},
 *   rustEngine:{
 *     enabled:true,
 *     parallelism:8,
 *     memoryLimit: '2GB', *     cacheStrategy:'aggressive') *},
 *   sources:{
 *     github:{
 *       useGraphQL:true,
 ...
 *},
 *     npm:{
 *       registry: 'https://registry.npmjs.org', *       includeDownloadStats:true,
 ...
 *   topic: 'typescript performance optimization', *   depth: 'comprehensive', *   includeMetrics:true,
 *   timeRange: '1y', // Last year only
 *   quality: 'high', *   sources:{
 ...
 *   naturalLanguage:{
 *     enabled:true,
 *     model: 'semantic-search-v2', *     queryExpansion:true,
 ...
 *   sources:[
 *     'https://react.dev/docs', *     'https://nodejs.org/docs', *     'https://developer.mozilla.org/en-US/docs') *],
 *   monitoring:{
 *     enabled:true,
 *     checkInterval:3600000, // 1 hour
 *     changeDetection: 'content-hash', *     alertOnChanges:true
 *},
 *   processing:{
 ...
 *   endpoints:[
 *     'https://api.github.com/search/repositories', *     'https://registry.npmjs.org/-/v1/search', *     'https://nvd.nist.gov/rest/json/cves/1.0') *],
 ...
 *   focus: 'security-analysis', *   database:{
 *     graphSchema: 'security-relationships', *     enableFullTextSearch:true,
 ...
 *   target:{
 *     type: 'npm-package', *     name: 'express', *     version:'latest') *},
 *   analysis:{
