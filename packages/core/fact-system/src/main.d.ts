...
export declare function createFactClient(
  config?: FactSystemConfig
): Promise<FactClient>;
export declare function createSQLiteFactClient(
  path?: string
): Promise<FactClient>;
export declare function createLanceDBFactClient(
  path?: string
): Promise<FactClient>;
export declare function createKuzuFactClient(
  path?: string
): Promise<FactClient>;
