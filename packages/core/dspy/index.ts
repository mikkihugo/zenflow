 ...
 *       signature: 'feedback -> sentiment', *       instructions:'Analyze customer feedback sentiment accurately') *});
 *}
 *
 ...
 *     new SentimentClassifier()
 *],
 *   aggregation: 'majority-vote', *   optimization:{
 ...
 *   teleprompter: 'bootstrap-fewshot', *   maxIterations:100,
 ...
 *   task: 'sentiment-classification', *   examples:trainingData,
 *   quality: 'high', *   constraints:{
 *     maxLatency:500,
 *     minAccuracy:0.9,
 *     budget:'medium') *}
 *});
 ...
 *   domain: 'healthcare', *   expertKnowledge:[
 *     'Consider medical context and terminology', *     'Prioritize patient safety in recommendations', *     'Account for regulatory compliance requirements') *],
