...
export type { Config, SharedLLMService, SharedLogger, SharedStorage, } from "./src/core/service.js";
export { type Adapter, BaseAdapter, type EvaluationDataInput, type EvaluationDataOutput, type FinetuneDataInput, type FinetuneDataOutput, type InferenceDataInput, type InferenceDataOutput, } from "./src/interfaces/adapter.js";
export { BaseLM, type GenerationOptions, type LMInterface, type ModelInfo, type ModelUsage, } from "./src/interfaces/lm.js";
export type { DSPyKV } from "./src/main";
export { createDSPyEngine, DSPyEngine, DSPyService, dspyUtils, getDSPyService, initializeDSPyService, } from "./src/main";
...
export type { DSPyConfig, DSPyConfigValidator, DSPyEngineStats, DSPyExample, DSPyExampleGenerator, DSPyMetrics, DSPyOptimizationResult, DSPyOptimizationStrategy, DSPyPattern, DSPyProgram, DSPyPromptEvaluator, DSPyPromptVariation, DSPyStorage, DSPyTaskConfig, } from "./src/types/interfaces.js";
import { createDSPyEngine, DSPyEngine } from "./src/main";
/**
 * Production DSPy Library
 */
export declare const DSPy: {
    readonly Engine: {
        readonly DSPyEngine: typeof DSPyEngine;
        readonly createDSPyEngine: typeof createDSPyEngine;
        readonly utils: {
            createExamples(data: Array<{
                input: string;
                output: string;
            }>): import("./index.js").DSPyExample[];
