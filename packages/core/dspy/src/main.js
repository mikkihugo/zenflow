...
// =============================================================================
export async function getDSPySystemAccess(_config) {
...
export async function getDSPyEngineAccess(_config) {
	const engine = createDSPyEngine();
	return {
		create: (engineConfig) => createDSPyEngine(engineConfig),
		compile: (module, examples, options) =>
			engine.compile(module, examples, options),
		evaluate: (module, examples, metrics) =>
			engine.evaluate(module, examples, metrics),
		train: (module, trainingData, config) =>
...
export async function getDSPyOptimization(config) {
	...
	return {
		optimize: (module, examples, options) =>
...
export async function getDSPyML(config) {
	...
	return {
		...
		evaluateModel: (module, examples, metrics) =>
