...
export async function getDSPySystemAccess(_config?:any): Promise<any> {
	...
	return {
		...
		optimizeModule:async (module: any, examples:any[], options?:any) => engine.compile(module, examples, options),
		evaluateModule:async (module: any, examples:any[], metrics:any[]) => engine.evaluate(module, examples, metrics),
		trainModule:async (module: any, trainingData:any, config?:any) => engine.train(module, trainingData, config),
