...
Description: ${task.description}
	...
	evaluateVariantForTask(variant, task, _analysis) {
	...
	async enrichSelection(selection, task, _evaluations) {
	...
	async enhancePerformanceEstimate(variant, _task) {
