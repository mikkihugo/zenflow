...
export declare class MLNeuralCoordinator extends TypedEventBase {
   ...
   */
  predictCoordinationPerformance(
   ...
   */
  adaptCoordinationStrategy(): Promise<
    MLResult<{
      new_strategy: string;
      adaptations: string[];
    }>
