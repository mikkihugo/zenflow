...
export declare class MemoryConnectionError extends MemoryError {
    constructor(message: string, backend: string, context?: Record<string, unknown>);
}
...
export declare class MemoryCapacityError extends MemoryError {
    constructor(message: string, currentSize: number, maxSize: number, context?: Record<string, unknown>);
}
