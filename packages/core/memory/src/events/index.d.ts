 ...
 */
export declare function isCoordinationEvent(event: MemoryEventType): event is MemorySystemSyncEvent;
/**
 * Type guard for cache events
 */
export declare function isCacheEvent(event: MemoryEventType): event is CacheCoordinationEvent;
