...
export type { MemoryEvent, MemorySystemSyncEvent, CacheCoordinationEvent, MemoryEventType, } from './events';
...
export declare class MemoryFactory {
     ...
     */
    static createSessionStore(sessionId: string, options?: any): Promise<any>;
    /**
     * Create a safe memory store
     */
    static createSafeStore(config?: any): Promise<any>;
    /**
     * Create a context store
     */
    static createContextStore(config?: any): Promise<any>;
}
/**
 ...
 * instead of the database package. The correct pattern is memory -> database package.
 */
export declare function getMemorySystem(config?: MemoryConfig): Promise<any>;
/**
