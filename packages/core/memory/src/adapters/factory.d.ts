...
export declare class MemoryBackendFactory {
     ...
     */
    createDatabaseBackend(config: DatabaseMemoryConfig, instanceId?: string): Promise<DatabaseBackedAdapter>;
    /**
     ...
     * @param loader
     */
    registerBackend(type: MemoryBackendType, loader: () => Promise<new (config: MemoryConfig) => BaseMemoryBackend>): void;
    /**
