...
export async function analyzeRepository(
  ...
  options?:import('./types/index.js').AnalysisOptions')):Promise<import('./types/index.js').AnalysisResult> {
    ')  const { RepositoryAnalyzer} = await import('./repository-analyzer.js');')  const analyzer = new RepositoryAnalyzer(repositoryPath);
...
export async function getRepositoryHealthScore(
  repositoryPath:string,
  options?:import('./types/index.js').AnalysisOptions')):Promise<{
  score:number;
...
export async function createRepositoryAnalyzer(
  repositoryPath:string
    ...
    ')  const { RepositoryAnalyzer} = await import('./repository-analyzer.js');')  return new RepositoryAnalyzer(repositoryPath);
}
...
export const DEFAULT_ANALYSIS_OPTIONS:import('./types/index.js').AnalysisOptions =')  {
    ...
    performanceMode: 'balanced',    complexityThresholds:
