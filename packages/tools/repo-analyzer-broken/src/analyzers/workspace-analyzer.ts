...
export class WorkspaceAnalyzer {
  ...
  async analyzeWorkspace(
    ...
    switch (tool) {
      case 'nx': ')'        return this.analyzeNxWorkspace(rootPath, configFiles, options);
      case 'bazel': ')'        return this.analyzeBazelWorkspace(rootPath, configFiles, options);
      case 'moon': ')'        return this.analyzeMoonWorkspace(rootPath, configFiles, options);
      case 'turbo': ')'        return this.analyzeTurboWorkspace(rootPath, configFiles, options);
      case 'rush': ')'        return this.analyzeRushWorkspace(rootPath, configFiles, options);
      case 'lerna': ')'        return this.analyzeLernaWorkspace(rootPath, configFiles, options);
      case 'yarn-workspaces': ')'      case 'pnpm-workspaces': ')'      case 'npm-workspaces': ')'        return this.analyzePackageManagerWorkspace(
          rootPath,
          configFiles,
          tool,
          options
        );
      case 'nix': ')'        return this.analyzeNixWorkspace(rootPath, configFiles, options);
      default:
