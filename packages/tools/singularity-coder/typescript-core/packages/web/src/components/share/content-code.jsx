...
const content_code_module_css_1 = require("./content-code.module.css")
function ContentCode(props) {
  const _this = this
  const html = (0, solid_js_1.createResource)(
    () => {
      return [props.code, props.lang]
    },
    (_a) => {
  ...
  return (
    <solid_js_1.Suspense>
      <div
        innerHTML={html()}
        class={content_code_module_css_1.default.root}
