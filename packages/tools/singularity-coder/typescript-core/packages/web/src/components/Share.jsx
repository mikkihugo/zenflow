...
function Share(props) {
            ...
            socket.onmessage = function (event) {
                ...
                try {
                    ...
                    if (type === "message") {
                        ...
                        d_1.content.parts = (_c = (_a = d_1.content.parts) !== null && _a !== void 0 ? _a : (_b = store.messages[messageID]) === null || _b === void 0 ? void 0 : _b.parts) !== null && _c !== void 0 ? _c : [];
    ...
    return (<main classList={_a = {}, _a[share_module_css_1.default.root] = true, _a["not-content"] = true, _a}>
          ...
          <div class={share_module_css_1.default.parts}>
            ...
            return (<solid_js_1.Suspense>
                    ...
                    var last = (0, solid_js_1.createMemo)(function () {
                        return data().messages.length === msgIndex() + 1 && filteredParts().length === partIndex() + 1;
                    });
                    (0, solid_js_1.onMount)(function () {
      ...
      <solid_js_1.Show when={showScrollButton()}>
        <button type="button" class={share_module_css_1.default["scroll-button"]} onClick={function () { return document.body.scrollIntoView({ behavior: "smooth", block: "end" }); }} onMouseEnter={function () {
