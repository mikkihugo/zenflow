...
function GrepTool(props) {
    var _a, _b;
    var matchesLabel = (0, solid_js_1.createMemo)(function () {
        var _a, _b;
        var count = (_b = (_a = props.state.metadata) === null || _a === void 0 ? void 0 : _a.matches) !== null && _b !== void 0 ? _b : 0;
        return count === 1 ? '1 match' : "".concat(count, " matches");
    });
    return (<>
      <div data-component="tool-title">
      ...
      <solid_js_1.Switch>
        <solid_js_1.Match when={((_a = props.state.metadata) === null || _a === void 0 ? void 0 : _a.count) && ((_b = props.state.metadata) === null || _b === void 0 ? void 0 : _b.count) > 0}>
          <div data-component="tool-result">
            ...
            ? '1 result'
            : "".concat((_e = (_d = props.state.metadata) === null || _d === void 0 ? void 0 : _d.count) !== null && _e !== void 0 ? _e : 0, " results")}>
              <content_text_1.ContentText expand compact text={props.state.output}/>
            </ResultsButton>
          </div>
        </solid_js_1.Match>
...
function ToolFooter(props) {
    return props.time > MIN_DURATION ? (<Footer title={"".concat(String(props.time), "ms")}>{(0, common_1.formatDuration)(props.time)}</Footer>) : null;
}
...
function flattenToolArgs(obj, prefix) {
    ...
    for (var _i = 0, _a = Object.entries(obj); _i < _a.length; _i++) {
        ...
        var path = prefix ? "".concat(prefix, ".").concat(String(key)) : String(key);
