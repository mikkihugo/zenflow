 ...
 * - **Real-Time System Metrics**: Live CPU, memory, and performance monitoring
 * 
 * @example Basic Usage
 * ```typescript
 * import { getTelemetry, recordMetric, startTrace } from '@claude-zen/foundation';
 * 
 ...
 * ```typescript
 * import { TelemetryManager } from '@claude-zen/foundation';
 * 
...
export default {
  ...
  // Real System Metrics (integrated from main app)
  RealCpuMetrics,
  RealMemoryMetrics,
