...
export class MIPROv2 extends Teleprompter {
   ...
   */
  private setNumTrialsFromNumCandidates(program: DSPyModule, zeroshot_opt: boolean, num_candidates: number): number {
   ...
   */
  private setAndValidateDatasets(trainset: Example[], valset: Example[] | null): { trainset: Example[]; valset: Example[] } {
