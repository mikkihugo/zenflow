  ...
  switch (providerId) {
    case 'github-models-api':
      ...
      return new GitHubModelsAPI({
        token:process.env['GITHUB_TOKEN'] || ',        ...options,
} as any);
...
export function listAPIProviders():Array<{
  ...
  return [
    {
      id: 'github-models-api',      name: 'GitHub Models API',      available:true,
      description: 'Access to GitHub Models marketplace',},
    {
      id: 'github-copilot-api',      name: 'GitHub Copilot Chat API',      available:true,
      description: 'GitHub Copilot conversational AI',},
    {
      id: 'anthropic-api',      name: 'Anthropic API',      available:false,
      description: 'Direct Anthropic Claude API',},
    {
      id: 'openai-api',      name: 'OpenAI API',      available:false,
