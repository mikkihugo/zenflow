...
export interface APIRequest {
  messages:APIMessage[];
  model?:LiteralUnion<
    'claude-3-5-sonnet' | ' gpt-4' | ' gemini-pro' | ' gpt-4o' | ' gpt-4-turbo',    string
  >;
  temperature?:number;
  maxTokens?:number;
...
export interface APIProviderFactory {
  createProvider(
    type:LiteralUnion<
      'github-copilot' | ' openai' | ' anthropic' | ' github-models',      string
    >,
...
export const API_ERROR_CODES = {
  VALIDATION_ERROR: 'VALIDATION_ERROR',  TIMEOUT_ERROR: 'TIMEOUT_ERROR',  NETWORK_ERROR: 'NETWORK_ERROR',  AUTH_ERROR: 'AUTH_ERROR',  RATE_LIMIT_ERROR: 'RATE_LIMIT_ERROR',  MODEL_ERROR: 'MODEL_ERROR',  UNKNOWN_ERROR: 'UNKNOWN_ERROR',} as const;
