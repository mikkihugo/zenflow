 ...
 * @example
 */
export declare class MemoryDao<T> extends BaseDao<T> implements MemoryRepository<T> {
    private memoryStore;
    private keyStore;
    private ttlTimers;
    private accessCount;
    ...
    constructor(adapter: DatabaseAdapter, logger: Logger, tableName: string, entitySchema?: Record<string, unknown>, options?: {
        maxSize?: number;
        ttlDefault?: number;
