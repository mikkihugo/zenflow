...
import type { ClusteringOptions, ClusterResult, CustomQuery, VectorRepository, VectorDocument, VectorIndexConfig, VectorInsertResult, VectorSearchOptions, VectorSearchResult, VectorStats } from '../interfaces';
/**
 ...
 * @example
 */
export declare class VectorDao<T> extends BaseDao<T> implements VectorRepository<T> {
