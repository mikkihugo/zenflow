 ...
 * @example
 */
export declare function getInjectionToken(constructor: unknown, parameterIndex: number): DIToken<any> | undefined;
/**
 ...
 * @example
 */
export declare function hasInjectionToken(constructor: unknown, parameterIndex: number): boolean;
