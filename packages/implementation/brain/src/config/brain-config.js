...
function getBrainConfig() {
    try {
        ...
        const brainConfig = __assign(__assign(__assign({}, exports.DEFAULT_BRAIN_CONFIG), neuralConfig), { 
            ...
            dspy: __assign(__assign({}, exports.DEFAULT_BRAIN_CONFIG.dspy), { maxTokens: environment === 'production' ? 2000 : 4000, optimizationSteps: environment === 'production' ? 25 : 50 }) });
        ...
        throw new Error("Brain configuration failed: ".concat(error instanceof Error ? error.message : String(error)));
    }
}
/**
...
function validateBrainConfig(config) {
    ...
    try {
        ...
        if (((_a = config.dspy) === null || _a === void 0 ? void 0 : _a.maxTokens) && (config.dspy.maxTokens < 100 || config.dspy.maxTokens > 10000)) {
