  ...
  describe('Performance and Scaling Scenarios', () => {'
    ...
    it('should handle mixed priority workloads', async () => {'
      const tasks = [
        ...
        {
          text: 'Standard user query for information retrieval',
          priority: 'medium' as const,
        },
        {
          text: 'Background batch processing document 1',
          priority: 'low' as const,
        },
        {
          text: 'Important business logic validation',
          priority: 'high' as const,
        },
        {
          text: 'Background batch processing document 2',
          priority: 'low' as const,
        },
      ];
