...
const SPARCMultiSwarmExecutor = /** @class */ (function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 5:
              ...
              endTime = new Date();
              totalWorktreesCreated = results.filter(function (r) {
                return r.gitTreeInfo.worktreePath;
              }).length;
              multiSwarmResult = {
                testId: testId,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        promises = strategies.map(function (strategy) {
          return _this.executeSingleSPARCStrategy(
            taskDescription,
            strategy,
            gitConfig,
            options
          ...
          case 0:
            ...
            return [
              ...
              new Promise(function (resolve) {
                return setTimeout(resolve, executionDelay);
              }),
            ];
          case 1:
            _a.sent();
   ...
   */
  SPARCMultiSwarmExecutor.prototype.getMethodologyMultiplier = function (
    methodology
  ) {
    switch (methodology) {
      case 'full-sparc':
  ...
  SPARCMultiSwarmExecutor.prototype.analyzeSPARCResults = function (results) {
    ...
    const winner = successfulResults.reduce(function (best, current) {
      return current.sparcMetrics.overallSPARCScore >
    ...
    const scores = successfulResults.map(function (r) {
      return r.sparcMetrics.overallSPARCScore;
    });
    const avgScore =
   ...
   */
  SPARCMultiSwarmExecutor.prototype.generateSPARCRecommendations = function (
    results,
    comparison
  ) {
    const winner = results.find(function (r) {
      return r.strategy.id === comparison.winner.id;
    });
    if (!winner) {
    ...
    const gitTreeResults = results.filter(function (r) {
      return r.gitTreeInfo.worktreePath;
    });
    if (gitTreeResults.length > 0) {
      const successfulMerges = gitTreeResults.filter(function (r) {
        return r.gitTreeInfo.mergedToMain;
      }).length;
      reasoning.push(
        'Git tree isolation: '
    ...
    const withIntelligence = results.filter(function (r) {
      return Object.values(r.strategy.sparcConfig.intelligentSystems).some(
        function (enabled) {
          return enabled;
        }
      );
    ...
    if (withIntelligence.length > 0 && withoutIntelligence.length > 0) {
      const avgWithIntelligence =
        withIntelligence.reduce(function (sum, r) {
          return sum + r.sparcMetrics.overallSPARCScore;
        }, 0) / withIntelligence.length;
      const avgWithoutIntelligence =
        withoutIntelligence.reduce(function (sum, r) {
          return sum + r.sparcMetrics.overallSPARCScore;
        }, 0) / withoutIntelligence.length;
      reasoning.push(
