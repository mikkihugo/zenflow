...
// Use nanoid from foundation instead of direct require
...
const MultiSwarmABTesting = /** @class */ (function () {
  function MultiSwarmABTesting(codingPrinciplesResearcher, promptGenerator) {
    ...
    if (codingPrinciplesResearcher) {
      ...
      const dspyBridge = {
        ...
        processCoordinationTask: function () {
          return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
      ...
      this.codingPrinciplesResearcher =
        new coding_principles_researcher_1.CodingPrinciplesResearcher(
          dspyBridge
        );
    }
   ...
   */
  MultiSwarmABTesting.prototype.executeABTest = function (
    taskDescription_1,
    strategies_1
  ) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function (taskDescription, strategies, options) {
        let testId,
          startTime,
          worktreePaths,
          results,
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              testId = 'ab-test-'.concat((0, foundation_1.generateNanoId)());
              startTime = new Date();
              logger.info('\uD83E\uDDEA Starting A/B test: '.concat(testId));
              logger.info('\uD83D\uDCCB Task: '.concat(taskDescription));
              logger.info(
                '\uD83D\uDD2C Testing '
                  .concat(strategies.length, ' strategies: ')
                  .concat(
                    strategies
                      .map(function (s) {
                        return s.name;
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.prepareGitWorktrees(strategies, options.gitConfig),
              ];
            case 2:
              ...
              return [
                4 /*yield*/,
                this.executeStrategiesParallel(
                  taskDescription,
                  strategies,
                  worktreePaths,
                  options
            ...
            case 4:
              return [
                4 /*yield*/,
                this.executeStrategiesSequential(
                  taskDescription,
                  strategies,
                  worktreePaths,
                  options
            ...
            case 7:
              _d.sent();
              if (
                !((_c = options.gitConfig) === null || _c === void 0
                  ? void 0
                  : _c.cleanupAfterTest)
              )
                return [3 /*break*/, 9];
    ...
    switch (scenario) {
      ...
      case 'comprehensive':
        return __spreadArray(
          __spreadArray(
            __spreadArray([], this.createStrategySet('performance'), true),
  ...
  MultiSwarmABTesting.prototype.getRecommendations = function (taskType) {
    ...
    if (relevantTests.length === 0) {
      const allWinners = this.testHistory.map(function (test) {
        return test.comparison.winner;
      });
    ...
    const winners = relevantTests.map(function (test) {
      return test.comparison.winner;
    });
    const recommended = this.findMostSuccessfulStrategy(winners);
    const successRate =
      winners.filter(function (w) {
        return (
          w.id ===
          (recommended === null || recommended === void 0
            ? void 0
            : recommended.id)
        );
    ...
    return {
      ...
      reasoning: [
        'Based on '
          .concat(relevantTests.length, ' historical tests for "')
          .concat(taskType, '"'),
        ...
        'Topology: '.concat(
          recommended === null || recommended === void 0
            ? void 0
            : recommended.swarmConfig.topology
        ),
      ],
    };
  };
   ...
   */
  MultiSwarmABTesting.prototype.prepareGitWorktrees = function (
    strategies,
    gitConfig
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        worktreePaths = {};
        if (
          !(gitConfig === null || gitConfig === void 0
            ? void 0
            : gitConfig.useGitWorktrees)
        ) {
          logger.debug(
            'Git worktrees disabled, using current working directory'
          );
        ...
        cleanupAfterTest =
          (_a = gitConfig.cleanupAfterTest) !== null && _a !== void 0
            ? _a
            : true;
        ...
        if (strategies.length > maxWorktrees) {
          logger.warn(
            'Strategy count '
              .concat(strategies.length, ' exceeds max worktrees ')
              .concat(maxWorktrees),
            {
        ...
        for (
          _i = 0, strategiesToProcess_1 = strategiesToProcess;
          _i < strategiesToProcess_1.length;
          _i++
        ) {
  ...
  MultiSwarmABTesting.prototype.executeStrategiesParallel = function (
    taskDescription,
    strategies,
    worktreePaths,
    options
  ...
  MultiSwarmABTesting.prototype.executeStrategiesSequential = function (
    taskDescription,
    strategies,
    worktreePaths,
    options
    ...
    return __awaiter(this, void 0, void 0, function () {
      let enableProgressLogging,
        delayBetweenStrategies,
        enableContinueOnFailure,
        results,
        i,
        strategy,
        result,
        ...
        switch (_a.label) {
          case 0:
            ...
            if (enableProgressLogging) {
              ...
              logger.info(
                '\uD83D\uDCCA Sequential options: delay='
                  .concat(delayBetweenStrategies, 'ms, continueOnFailure=')
                  .concat(enableContinueOnFailure)
              );
            } else {
              logger.info(
                '\u23ED\uFE0F Executing '.concat(
          ...
          case 3:
            ...
            if (enableProgressLogging) {
              logger.info(
                '\u2705 Strategy '
                  .concat(i + 1, ' completed: ')
                  .concat(strategy.name, ' (')
                  .concat(result.success ? 'SUCCESS' : 'FAILED', ')')
              );
            }
            return [3 /*break*/, 5];
          case 4:
          ...
          case 5:
            ...
            return [
              ...
              new Promise(function (resolve) {
                return setTimeout(resolve, delayBetweenStrategies);
              }),
            ];
          case 6:
            _a.sent();
  ...
  MultiSwarmABTesting.prototype.executeStrategy = function (
    taskDescription_1,
    strategy_1,
    worktreePath_1
  ) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function (taskDescription, strategy, worktreePath, options) {
        let startTime,
          ...
          switch (_a.label) {
            case 0:
              ...
              if (enableVerboseLogging) {
                ...
                logger.info(
                  '\uD83D\uDCCA Options: timeout='
                    .concat(timeoutMs, 'ms, retries=')
                    .concat(retryCount, ', verbose=')
                    .concat(enableVerboseLogging)
                );
              }
              lastError = null;
                        ...
                        Promise.race([
                          ...
                          new Promise(function (_, reject) {
                            return setTimeout(function () {
                              return reject(
                                new Error(
                                  'Strategy execution timeout after '.concat(
                                    timeoutMs,
                                    'ms'
                                  )
                                )
                        ...
                        2 /*return*/,
                        {
                          value: {
                            ...
                            modelMetadata: {
                              ...
                              avgResponseTime:
                                duration_1 /
                                (executionResult.requestCount || 1),
            ...
            case 4:
              ...
              logger.info(
                '\u274C All attempts failed for strategy: '.concat(
                  strategy.name
                )
              );
              return [
  ...
  MultiSwarmABTesting.prototype.generateStrategyPrompt = function (
    taskDescription,
    strategy
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.codingPrinciplesResearcher.getAdaptivePrinciples(
                __assign(
                  {
                    language: 'typescript',
                    domain: 'rest-api',
            ...
            if (adaptivePrinciples) {
              return [
                ...
                '# A/B Test Strategy: '
                  ...
                  .concat(
                    strategy.modelBackend,
                    '\n## Swarm Configuration:\n- Topology: '
                  )
                  .concat(strategy.swarmConfig.topology, '\n- Max Agents: ')
                  .concat(strategy.swarmConfig.maxAgents, '\n- Strategy: ')
                  .concat(strategy.swarmConfig.strategy, '\n- Coordination: ')
                  .concat(
                    strategy.swarmConfig.coordinationApproach,
                    '\n\n## Style Variation:\n- Style: '
                  )
                  .concat(
                    ((_a = strategy.promptVariations) === null || _a === void 0
                      ? void 0
                      : _a.style) || 'standard',
                    '\n- Focus: '
                  )
                  .concat(
                    ((_b = strategy.promptVariations) === null || _b === void 0
                      ? void 0
                      : _b.focus) || 'balanced',
                  ...
                  .concat(
                    adaptivePrinciples.qualityMetrics.complexity.threshold,
                    '\n- Coverage: '
                  )
                  .concat(
                    adaptivePrinciples.qualityMetrics.coverage.threshold,
                    '%\n- Maintainability: '
                  )
                  .concat(
                    adaptivePrinciples.qualityMetrics.maintainability.threshold,
                    '\n- Performance: '
                  )
                  .concat(
                    adaptivePrinciples.qualityMetrics.performance.threshold,
          ...
          case 2:
            ...
            return [
              ...
              '# A/B Test Strategy: '
                ...
                .concat(strategy.modelBackend, '\n## Configuration: ')
                .concat(
                  JSON.stringify(strategy.swarmConfig, null, 2),
  ...
  MultiSwarmABTesting.prototype.simulateSwarmExecution = function (
    strategy_1,
    prompt_2,
    worktreePath_1
  ) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function (strategy, prompt, worktreePath, options) {
        let qualityBoost,
          speedMultiplier,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              topologyMultiplier = this.getTopologyMultiplier(
                strategy.swarmConfig.topology
              );
              agentMultiplier = Math.min(
                1.2,
              ...
              return [
                4 /*yield*/,
                new Promise(function (resolve) {
                  return setTimeout(resolve, adjustedDelay);
                }),
              ];
            case 1:
              _a.sent();
                ...
                2 /*return*/,
                {
                  ...
                  tokenUsage: Math.floor(
                    (5000 + Math.random() * 10000) *
                      (enableDetailedMetrics ? 1.2 : 1.0)
                  ),
                  requestCount: Math.floor(
                    (3 + Math.random() * 7) *
                      (enableDetailedMetrics ? 1.3 : 1.0)
                  ),
                },
              ];
          }
  ...
  MultiSwarmABTesting.prototype.analyzeResults = function (results) {
    ...
    const winner = successfulResults.reduce(function (best, current) {
      return current.qualityMetrics.overallScore >
        best.qualityMetrics.overallScore
        ? current
        : best;
    });
    // Calculate confidence based on score difference
    const scores = successfulResults.map(function (r) {
      return r.qualityMetrics.overallScore;
    });
    const avgScore =
  ...
  MultiSwarmABTesting.prototype.generateInsights = function (
    results,
    comparison
  ) {
    const insights = [];
    ...
    if (comparison.winner) {
      insights.push(
        '\uD83C\uDFC6 Winner: '
          .concat(comparison.winner.name, ' with ')
          .concat(comparison.confidence.toFixed(1), '% confidence')
      );
      if (comparison.significance === 'high') {
        insights.push(
          '\uD83D\uDCCA High statistical significance - reliable results'
        );
      } else if (
        comparison.significance === 'low' ||
        comparison.significance === 'none'
      ) {
        insights.push(
          '\u26A0\uFE0F  Low statistical significance ('.concat(
      ...
      if (winnerDelta && winnerDelta > 10) {
        insights.push(
          '\u26A1 Significant performance advantage: '.concat(
            winnerDelta.toFixed(1),
            '% improvement'
          )
        );
      } else if (winnerDelta && winnerDelta > 0) {
        insights.push(
          '\uD83D\uDCC8 Moderate performance advantage: '.concat(
            winnerDelta.toFixed(1),
            '% improvement'
          )
        );
    ...
    Object.entries(modelPerformance).forEach(function (_a) {
      ...
      insights.push(
        ''.concat(model, ': Average quality score ').concat(avgScore.toFixed(1))
      );
    });
    // Topology insights
    ...
    insights.push(
      'Best topology: '
        .concat(bestTopology.topology, ' (')
        .concat(bestTopology.avgScore.toFixed(1), ' avg score)')
    );
    ...
    const fastest = speedVsQuality.sort(function (a, b) {
      return b.speed - a.speed;
    })[0];
    insights.push(
      'Fastest execution: '
        .concat(fastest.strategy, ' (')
        .concat(fastest.speed.toFixed(2), ' ops/sec)')
    );
    ...
    const avgEfficiency =
      agentEfficiency.reduce(function (sum, item) {
        return sum + item.efficiency;
      }, 0) / agentEfficiency.length;
    insights.push(
      'Average efficiency: '.concat(
        avgEfficiency.toFixed(1),
        ' quality points per agent'
      )
    );
    return insights;
  };
  MultiSwarmABTesting.prototype.findMostSuccessfulStrategy = function (
    strategies
  ) {
    ...
    // Find most frequent
    const mostFrequentId = Object.entries(counts).sort(function (_a, _b) {
      const a = _a[1];
      const b = _b[1];
      return b - a;
    })[0][0];
  ...
  MultiSwarmABTesting.prototype.cleanupGitWorktrees = function (worktreePaths) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        logger.debug(
          '\uD83E\uDDF9 Cleaning up '.concat(
            Object.keys(worktreePaths).length,
            ' git worktrees...'
          )
        );
        ...
        for (_i = 0, _a = Object.entries(worktreePaths); _i < _a.length; _i++) {
          ...
          try {
            ...
            logger.debug(
              '\uD83D\uDDD1\uFE0F Cleaning up worktree for strategy '
                .concat(strategyId, ': ')
                .concat(path)
            );
            ...
            logger.info(
              '\u2705 Successfully cleaned up worktree for strategy '.concat(
                strategyId
              )
            );
          } catch (error) {
            logger.error(
              '\u274C Failed to cleanup worktree for strategy '.concat(
                strategyId,
                ':'
              ),
              error
  ...
  MultiSwarmABTesting.prototype.recordCleanupMetrics = function (
    strategyId,
    path
  ) {
  ...
  MultiSwarmABTesting.prototype.persistTestResult = function (testResult) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        ...
        logger.info(
          '\uD83D\uDCBE Persisted A/B test result: '.concat(testResult.testId)
        );
        return [2 /*return*/];
      });
    });
