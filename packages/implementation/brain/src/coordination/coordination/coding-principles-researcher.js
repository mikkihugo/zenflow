...
const CodingPrinciplesResearcher = /** @class */ (function () {
   ...
   */
  CodingPrinciplesResearcher.prototype.getRoleSpecificResearchAreas = function (
    role
  ) {
    const roleAreas = {
      'backend-developer': [
   ...
   */
  CodingPrinciplesResearcher.prototype.getAdvancedResearchAreas = function (
    role,
    domain
  ) {
    const baseAdvanced = [
   ...
   */
  CodingPrinciplesResearcher.prototype.generateReviewableTemplate = function (
    principles
  ) {
    return '# '
  ...
  CodingPrinciplesResearcher.prototype.getDefaultTypeSystem = function (
    language
  ) {
    switch (language) {
      case 'typescript':
  ...
  CodingPrinciplesResearcher.prototype.getDefaultMemoryManagement = function (
    language
  ) {
    switch (language) {
      case 'rust':
  ...
  CodingPrinciplesResearcher.prototype.getDefaultConcurrency = function (
    language
  ) {
    switch (language) {
      case 'go':
  ...
  CodingPrinciplesResearcher.prototype.getDefaultPackageManagement = function (
    language
  ) {
    switch (language) {
      case 'typescript':
  ...
  CodingPrinciplesResearcher.prototype.getDefaultBuildTools = function (
    language
  ) {
    switch (language) {
      case 'typescript':
  ...
  CodingPrinciplesResearcher.prototype.calculatePatternSuccessRate = function (
    ...
    try {
      if (Array.isArray(patterns)) {
        ...
        const successCount = patterns.filter(function (p) {
          return p.success === true || p.successful === true;
        }).length;
      ...
      try {
        ...
        if (patterns.commonPatterns) {
          (_a = principles.bestPractices).push.apply(
            _a,
            patterns.commonPatterns.filter(function (p) {
              return (
                typeof p === 'string' &&
                p.length > 10 &&
  ...
  CodingPrinciplesResearcher.prototype.enhanceConfigWithFeedback = function (
    ...
    if (feedbacks.length > 0) {
      ...
      const missingAreas = feedbacks.flatMap(function (f) {
        return f.missingAreas;
      });
      const commonMissing = this.getMostCommon(missingAreas);
      // Increase depth if complexity is often too low
      const avgComplexity =
        feedbacks.reduce(function (sum, f) {
          return (
            sum +
      ...
      if (
        commonMissing.some(function (area) {
          return area.toLowerCase().includes('performance');
        })
      ) {
      ...
      if (
        commonMissing.some(function (area) {
          return area.toLowerCase().includes('security');
        })
      ) {
      ...
      if (
        commonMissing.some(function (area) {
          return area.toLowerCase().includes('test');
        })
      ) {
  ...
  CodingPrinciplesResearcher.prototype.evaluateImprovementNeeds = function (
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        recentAvgAccuracy =
          recentFeedbacks.reduce(function (sum, f) {
            return sum + f.accuracy;
          }, 0) / recentFeedbacks.length;
        recentAvgUsefulness =
          recentFeedbacks.reduce(function (sum, f) {
            return sum + f.usefulness;
          }, 0) / recentFeedbacks.length;
        ...
        confidence.needsImprovement =
          ...
          feedbacks.some(function (f) {
            return f.missingAreas.length > 2;
          }); // Many missing areas
