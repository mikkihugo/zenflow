...
const IntelligentPromptGenerator = /** @class */ (function () {
   ...
   */
  IntelligentPromptGenerator.prototype.generateCodingStandards = function (
    config
  ) {
   ...
   */
  IntelligentPromptGenerator.prototype.generatePhaseGuidelines = function (
    phase,
    context,
    config
  ) {
   ...
   */
  IntelligentPromptGenerator.prototype.generateQualityMetrics = function (
    phase,
    config
  ) {
    const baseMetrics = [
   ...
   */
  IntelligentPromptGenerator.prototype.buildPromptContent = function (
    phase,
    context,
    codingStandards,
    phaseGuidelines
   ...
   */
  IntelligentPromptGenerator.prototype.calculateComplexityScore = function (
    context,
    phase
  ) {
    let _a, _b;
        ...
        switch (_c.label) {
          case 0:
            ...
            return [
              ...
              Promise.resolve().then(function () {
                return require('../../coordination/dspy-llm-bridge');
              }),
            ];
          case 1:
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              Promise.resolve().then(function () {
                return require('@claude-zen/foundation');
              }),
            ];
          case 3:
   ...
   */
  IntelligentPromptGenerator.prototype.getPhaseExampleGuidelines = function (
    phase
  ) {
    switch (phase) {
      case 'specification':
   ...
   */
  IntelligentPromptGenerator.prototype.assessProjectComplexity = function (
    context
  ) {
   ...
   */
  IntelligentPromptGenerator.prototype.inferDomainFromContext = function (
    context
  ) {
    let _a;
    const domain =
  ...
  IntelligentPromptGenerator.prototype.buildMetaLearningPromptContent =
    function (phase, context, principles) {
      let _a, _b;
      return '# \uD83D\uDE80 '
        .concat(
          phase.charAt(0).toUpperCase() + phase.slice(1),
   ...
   */
  IntelligentPromptGenerator.prototype.convertPrinciplesToMetrics = function (
    principles
  ) {
    const metrics = [];
   ...
   */
  IntelligentPromptGenerator.prototype.generatePrinciplesId = function (
    config
  ) {
    return ''
      .concat(config.language, '-')
