    ...
    return (<div class={part_module_css_1.default.root} id={id()} data-component="part" data-type={props.part.type} data-role={props.message.role} data-copied={copied() ? true : undefined}>
            ...
            setTimeout(function () { return setCopied(false); }, 3000);
						...
						<solid_js_1.Switch>
							...
							<solid_js_1.Match when={props.part.type === "step-start" &&
			...
			<div data-component="content">
				...
				{props.message.role === "assistant" && props.part.type === "text" && (<div data-component="assistant-text">
						...
						{props.last &&
                props.message.role === "assistant" &&
                props.message.time.completed && (<Footer title={luxon_1.DateTime.fromMillis(props.message.time.completed).toLocaleString(luxon_1.DateTime.DATETIME_FULL_WITH_SECONDS)}>
            ...
            props.message.role === "assistant" && (<div data-component="step-start">
...
function getDiagnostics(diagnosticsByFile, currentFile) {
    var result = [];
    if (diagnosticsByFile === undefined ||
...
function TodoWriteTool(props) {
    ...
    var todos = (0, solid_js_1.createMemo)(function () {
        var _a, _b;
        return ((_b = (_a = props.state.input) === null || _a === void 0 ? void 0 : _a.todos) !== null && _b !== void 0 ? _b : [])
            .slice()
            .sort(function (a, b) { return priority[a.status] - priority[b.status]; });
    });
			...
			<div data-component="tool-result">
				<solid_js_1.Switch>
					<solid_js_1.Match when={((_a = props.state.metadata) === null || _a === void 0 ? void 0 : _a.matches) && ((_b = props.state.metadata) === null || _b === void 0 ? void 0 : _b.matches) > 0}>
						<ResultsButton showCopy={((_c = props.state.metadata) === null || _c === void 0 ? void 0 : _c.matches) === 1
            ? "1 match"
    ...
    return (<>
			...
			<div data-component="tool-result">
				<solid_js_1.Switch>
					...
					<solid_js_1.Match when={typeof ((_e = props.state.metadata) === null || _e === void 0 ? void 0 : _e.preview) !== "string" &&
            props.state.output}>
						<ResultsButton>
							<content_text_1.ContentText expand compact text={props.state.output}/>
						</ResultsButton>
...
function WriteTool(props) {
    var _a, _b, _c, _d;
    var filePath = (0, solid_js_1.createMemo)(function () { var _a; return stripWorkingDirectory((_a = props.state.input) === null || _a === void 0 ? void 0 : _a.filePath, props.message.path.cwd); });
    var diagnostics = (0, solid_js_1.createMemo)(function () {
        var _a;
        return getDiagnostics((_a = props.state.metadata) === null || _a === void 0 ? void 0 : _a.diagnostics, props.state.input.filePath);
    });
    return (<>
			<div data-component="tool-title">
...
function EditTool(props) {
    var _a, _b, _c, _d, _e;
    var filePath = (0, solid_js_1.createMemo)(function () {
    ...
    return (<>
			...
			<solid_js_1.Switch>
				<solid_js_1.Match when={((_a = props.state.metadata) === null || _a === void 0 ? void 0 : _a.count) && ((_b = props.state.metadata) === null || _b === void 0 ? void 0 : _b.count) > 0}>
					<div data-component="tool-result">
						<ResultsButton showCopy={((_c = props.state.metadata) === null || _c === void 0 ? void 0 : _c.count) === 1
            ? "1 result"
