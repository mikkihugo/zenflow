...
export class MemorySystemManager extends TypedEventBase {
    ...
    getSystemStatus() {
        ...
        return {
            ...
            nodes: {
                ...
                unhealthy: (coordinationStatus?.totalNodes || 0) -
    ...
    shouldInitializeCacheEviction() {
        return (this.config.coordination.strategy === 'intelligent' || this.config.optimization?.strategies.compression || this.config.performance?.actions.adjustCacheSize || false);
    }
    startMonitoring() {
