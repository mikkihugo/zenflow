...
export class MemoryOptimizationEngine extends TypedEventBase {
    ...
    getTrend(recent, older, target, inverse = false) {
        if (older === 0)
            return 'stable';
    ...
    updateOptimizationMetrics(sample, applied) {
    ...
    getPerformanceSamples(limit = 100) {
