...
export async function getWorkflowSystemAccess(config) {
	...
	return {
		...
		startWorkflow: (definition, initialContext) =>
		...
		scheduleWorkflow: (cronExpression, workflowId) =>
			engine.scheduleWorkflow(cronExpression, workflowId),
		generateVisualization: (workflow) =>
...
export async function getWorkflowOrchestration(config) {
	...
	return {
		...
		schedule: (cronExpression, workflowId) =>
...
export async function getWorkflowVisualization(config) {
	...
	return {
		...
		export: (workflow, _format = "mermaid") =>
