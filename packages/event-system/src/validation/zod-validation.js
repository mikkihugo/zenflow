 ...
 */
import { z } from 'zod';
import { getLogger, ok, err, safeAsync } from '@claude-zen/foundation';
...
export class EventValidator {
    schema;
    name;
    constructor(schema, name = 'Unknown') {
        this.schema = schema;
        this.name = name;
    }
    /**
 ...
 */
export function createEventValidator(schema, name) {
 ...
 */
export function createTypedEventValidator(eventType) {
    return new EventValidator(EventSchemas[eventType], eventType);
}
/**
