...
describe('Foundation Utilities', () => {
  describe('Common Utilities', () => {
    ...
    it('should provide utility functions', async () => {
      const utilities = await import('../../src/utilities/common/common.utilities');
  ...
  describe('System Utilities', () => {
    ...
    it('should provide capability provider', async () => {
      const capabilityProvider = await import('../../src/utilities/system/capability.provider');
      
      expect(capabilityProvider).toBeDefined();
    });

    it('should provide monorepo detector', async () => {
      const monorepoDetector = await import('../../src/utilities/system/monorepo.detector');
  ...
  describe('Project Utilities', () => {
    ...
    it('should provide project manager', async () => {
      const projectManager = await import('../../src/utilities/project/project.manager');
  ...
  describe('Validation Utilities', () => {
    ...
    it('should provide schema validator', async () => {
      const schemaValidator = await import('../../src/utilities/validation/schema.validator');
      
      expect(schemaValidator).toBeDefined();
    });

    it('should provide prompt validator', async () => {
      const promptValidator = await import('../../src/utilities/validation/prompt.validator');
