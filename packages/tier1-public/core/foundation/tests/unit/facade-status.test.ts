...
describe('Facade Status Manager', () => {
  ...
  it('should have basic exports', async () => {
    const facade = await import('../../src/infrastructure/facades/facade.status.manager');
    expect(facade).toBeDefined();
    expect(typeof facade).toBe('object');
  });

  it('should provide status functions', async () => {
    const { getSystemStatus } = await import('../../src/infrastructure/facades/facade.status.manager');
  ...
  it('should provide health functions', async () => {
    const { getHealthSummary } = await import('../../src/infrastructure/facades/facade.status.manager');
  ...
  it('should provide service functions', async () => {
    const { getService, hasService } = await import('../../src/infrastructure/facades/facade.status.manager');
