...
export class NeuralMLEngine {
  ...
  private gpuCircuitBreaker: CircuitBreakerWithMonitoring<any[], any>; // Circuit breaker for GPU operations
  private cpuCircuitBreaker: CircuitBreakerWithMonitoring<any[], any>; // Circuit breaker for CPU operations
