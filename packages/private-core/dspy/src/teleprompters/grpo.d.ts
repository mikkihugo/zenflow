...
export declare class GRPO extends FinetuneTeleprompter {
    ...
    private epoch;
    private id_freqs;
    constructor({ metric, multitask, train_kwargs, adapter, exclude_demos, num_threads, num_train_steps, seed, num_dspy_examples_per_grpo_step, num_rollouts_per_grpo_step, use_train_as_val, num_steps_for_val, report_train_scores, failure_score, format_failure_score, variably_invoked_predictor_grouping_mode, variably_invoked_predictor_fill_strategy, }?: GRPOConfig);
    /**
