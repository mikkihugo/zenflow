 ...
 */
import { DSPyModule, Example } from '../lib/index.js';
/**
 ...
 * @abstract
 */
export declare abstract class Teleprompter {
    /**
     ...
     */
    abstract compile(student: DSPyModule, config: {
        trainset: Example[];
...
//# sourceMappingURL=teleprompter.d.ts.map