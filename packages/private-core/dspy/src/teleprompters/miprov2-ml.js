...
export class MIPROv2ML extends Teleprompter {
	...
	async evaluateAccuracy(_student, params, _options) {
	...
	async evaluateSpeed(_student, params, _options) {
	...
	async evaluateMemoryUsage(_student, params, _options) {
	...
	async evaluateFinalPerformance(_module, _options) {
