...
export class MIPROv2 extends Teleprompter {
    ...
    setAndValidateDatasets(trainset, valset) {
        ...
        if (valset === null) {
            ...
            const valset_size = Math.min(1000, Math.max(1, Math.floor(trainset.length * 0.8)));
