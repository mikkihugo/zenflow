 ...
 */
export type DSPyOptimizationStrategy = 'few-shot-optimization';
/**
 ...
 */
export type DSPyExampleGenerator = (task: string, count: number, context?: any) => Promise<DSPyExample[]>;
/**
 * DSPy Prompt Evaluator Function
 */
export type DSPyPromptEvaluator = (prompt: string, examples: DSPyExample[]) => Promise<number>;
/**
 ...
 * DSPy Utility Types
 */
export declare namespace DSPyUtils {
    /** Create examples from raw data */
    type CreateExamples = (data: Array<{
        input: string;
        output: string;
    }>) => DSPyExample[];
    /** Validate configuration */
    type ValidateConfig = (config: any) => {
        valid: boolean;
        errors: string[];
    };
    /** Extract patterns from results */
    type ExtractPatterns = (results: DSPyOptimizationResult[]) => DSPyPattern[];
}
