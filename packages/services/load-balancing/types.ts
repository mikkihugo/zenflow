...
export enum AgentStatus {
  HEALTHY = 'healthy',  DEGRADED = 'degraded',  UNHEALTHY = 'unhealthy',  OFFLINE = 'offline',  MAINTENANCE = 'maintenance',}
...
export enum LoadBalancingAlgorithmType {
  ROUND_ROBIN = 'round_robin',  WEIGHTED_ROUND_ROBIN = 'weighted_round_robin',  LEAST_CONNECTIONS = 'least_connections',  RESOURCE_AWARE = 'resource_aware',  ML_PREDICTIVE = 'ml_predictive',  ADAPTIVE_LEARNING = 'adaptive_learning',}
