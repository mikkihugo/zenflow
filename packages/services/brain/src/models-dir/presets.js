...
export const NEURAL_PRESETS = {
    ...
    transformer: {
        id: 'transformer', name: 'Transformer Model', type: 'nlp', architecture: 'transformer', layers: [512, 256],
        activation: 'gelu', outputActivation: 'softmax', learningRate: 0.0001,
        batchSize: 16,
        useCase: ['machine_translation', 'text_classification'],
    },
    gnn: {
        id: 'gnn', name: 'Graph Neural Network', type: 'graph', architecture: 'gnn', layers: [64, 32, 16],
        activation: 'relu', outputActivation: 'sigmoid', learningRate: 0.001,
        batchSize: 32,
        useCase: ['node_classification', 'graph_classification'],
    },
    vae: {
        id: 'vae', name: 'Variational Autoencoder', type: 'generative', architecture: 'vae', layers: [128, 64, 32, 64, 128],
        activation: 'relu', outputActivation: 'sigmoid', learningRate: 0.001,
        batchSize: 32,
