 ...
 */
export declare function createMLEnterpriseCoordinator(overrides?:Partial<MLEnterpriseConfig>): MLEnterpriseCoordinator;
export { type MLTrainingProgressEvent, type MLInferenceResultEvent, type MLWorkflowStateEvent, type MLPerformanceMetricsEvent, type MLModelValidationEvent, type MLEnterpriseConfig};
