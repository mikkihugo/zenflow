...
export enum StorageStrategy {
  MEMORY = 'memory', // Fast access in brain package memory')  DATABASE = 'database', // Persistent via foundation SQLite')  VECTOR = 'vector', // High-dimensional via foundation LanceDB')  GRAPH = 'graph', // Relationship via foundation Kuzu')  HYBRID = 'hybrid', // Multiple storage backends')}
