 ...
 */
 ...
 logger.error(`❌ Complexity estimation failed:`, error);// Return safe default estimate
 return {
 ...
 */
 ...
 // High complexity tasks benefit from DSPy's sophisticated optimizationif (complexity > 0.7) {
 return 'dspy;
}
