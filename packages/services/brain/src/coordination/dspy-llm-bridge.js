...
export class DSPyLLMBridge {
    ...
    neuralBridge // Optional neural bridge parameter
         ...
         */
        async;
        executeCoordinationTask(task, DSPyCoordinationTask, config, DSPyOptimizationConfig = {});
         ...
         */
        async;
        processCoordinationTask(task, DSPyCoordinationTask, config ?  : DSPyOptimizationConfig);
        Promise < CoordinationResult > {
         ...
         */
        async;
        learnFromCoordination(task, DSPyCoordinationTask, _result, any, feedback, { success: boolean, improvements: string[] });
        Promise < void  > {
