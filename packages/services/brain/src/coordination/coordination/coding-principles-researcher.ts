...
Respond in JSON format with structured guidelines that cover all research areas comprehensively.`;`
  ...
  private getDomainSpecificResearchAreas(domain?:TaskDomain): string[] {
    const domainAreas:Record<TaskDomain, string[]> = {
      'rest-api':[')        'RESTful API design principles and OpenAPI specification',        'Authentication and authorization patterns (JWT, OAuth2, API keys)',        'Rate limiting and API versioning strategies',        'Input validation and sanitization for API endpoints',        'Error response formatting and HTTP status code usage',        'API documentation and testing strategies',        'Microservices communication patterns',],
      'web-app':[')        'Component-based architecture and state management',        'Client-side routing and navigation patterns',        'Performance optimization (lazy loading, code splitting)',        'Accessibility (WCAG) compliance and semantic HTML',        'Progressive Web App (PWA) implementation',        'Browser compatibility and polyfill strategies',        'SEO optimization and meta tag management',],
      'mobile-app':[')        'Mobile-first design principles and responsive layouts',        'Touch interaction patterns and gesture handling',        'Device-specific optimization (iOS/Android guidelines)',        'Offline functionality and local storage strategies',        'Push notification implementation',        'App store deployment and versioning',        'Performance optimization for mobile devices',],
      'desktop-app':[')        'Native desktop UI patterns and platform guidelines',        'File system integration and local data management',        'Cross-platform compatibility strategies',        'Desktop-specific security considerations',        'System integration (notifications, shortcuts)',        'Application packaging and distribution',        'Auto-update mechanisms',],
      microservices:[
        'Service decomposition and bounded context design',        'Inter-service communication patterns (sync/async)',        'Service discovery and event coordination',        'Distributed transaction management',        'Monitoring and observability across services',        'Container orchestration and deployment strategies',        'Data consistency and eventual consistency patterns',],
      'data-pipeline':[')        'ETL/ELT pipeline design and data flow optimization',        'Data validation and quality assurance',        'Stream processing and batch processing patterns',        'Data schema evolution and versioning',        'Error handling and data recovery strategies',        'Monitoring and alerting for data pipelines',        'Scalability and partitioning strategies',],
      'ml-model':[')        'Model training pipeline and experiment tracking',        'Feature engineering and data preprocessing',        'Model validation and performance metrics',        'Model deployment and serving infrastructure',        'A/B testing and model monitoring',        'Data versioning and model lineage',        'MLOps and continuous integration for models',],
      blockchain:[
        'Smart contract design patterns and security',        'Gas optimization and transaction efficiency',        'Decentralized application (dApp) architecture',        'Blockchain integration and wallet connectivity',        'Consensus mechanism considerations',        'Token economics and governance patterns',        'Security auditing and formal verification',],
      'game-dev':[')        'Game loop architecture and frame timing',        'Asset management and resource optimization',        'Physics simulation and collision detection',        'State management for game objects',        'Multiplayer networking and synchronization',        'Performance profiling for real-time systems',        'Platform-specific optimization (console/PC/mobile)',],
      embedded:[
        'Resource-constrained programming patterns',        'Real-time system design and timing constraints',        'Hardware abstraction layer design',        'Power management and energy efficiency',        'Interrupt handling and concurrency',        'Memory management in constrained environments',        'Testing strategies for embedded systems',],
};
  ...
  private getRoleSpecificResearchAreas(role?:DevelopmentRole): string[] {
    ...
    'backend-developer':[')        'Database design and query optimization',        'Server architecture and scalability patterns',        'Caching strategies and session management',        'Background job processing and queue management',        'Logging, monitoring, and observability',        'Configuration management and environment handling',        'Third-party service integration patterns',],
      'frontend-developer':[')        'Component lifecycle and state management',        'Browser performance optimization and rendering',        'CSS architecture and maintainable styling',        'Cross-browser compatibility and testing',        'Build tools and asset optimization',        'User experience (UX) implementation patterns',        'Internationalization (i18n) and localization',],
      'fullstack-developer':[')        'Full-stack architecture and layer separation',        'Frontend-backend communication patterns',        'End-to-end testing strategies',        'Development workflow and toolchain integration',        'Cross-cutting concerns (authentication, logging)',        'Technology stack selection and integration',        'DevOps practices for full-stack applications',],
      'mobile-developer':[')        'Platform-specific development guidelines (iOS/Android)',        'Mobile UI/UX patterns and native components',        'Device capability integration (camera, GPS, sensors)',        'App lifecycle management and background processing',        'Mobile security and data protection',        'App store guidelines and submission processes',        'Cross-platform development strategies',],
      'devops-engineer':[')        'Infrastructure as Code (IaC) and configuration management',        'CI/CD pipeline design and automation',        'Container orchestration and service mesh',        'Monitoring, logging, and alerting systems',        'Security scanning and vulnerability management',        'Disaster recovery and backup strategies',        'Cost optimization and resource management',],
      'ml-engineer':[')        'Machine learning pipeline design and automation',        'Model versioning and experiment tracking',        'Feature stores and data pipeline integration',        'Model serving and inference optimization',        'A/B testing and model monitoring',        'MLOps practices and continuous deployment',        'Distributed training and model parallelization',],
      architect:[
        'System architecture patterns and trade-offs',        'Technology evaluation and decision frameworks',        'Scalability planning and capacity management',        'Cross-functional requirement analysis',        'Technical debt management and refactoring strategies',        'Team coordination and technical leadership',        'Documentation and architectural decision records (ADRs)',],
      'tech-lead':[')        'Code review processes and quality standards',        'Team mentoring and knowledge sharing',        'Technical decision making and consensus building',        'Project planning and estimation techniques',        'Risk assessment and mitigation strategies',        'Stakeholder communication and requirement gathering',        'Agile/Scrum practices and team productivity',],
};
  ...
  private getAdvancedResearchAreas(
    ...
    const baseAdvanced = ['Design patterns and architectural patterns',      'SOLID principles and clean code practices',      'Domain-driven design (DDD) concepts',      'Test-driven development (TDD) and behavior-driven development (BDD)',      'Continuous integration and deployment strategies',      'Code review and pair programming practices',      'Technical documentation and knowledge sharing',];
    ...
    const domainAdvanced:Partial<Record<TaskDomain, string[]>> = {
      microservices:[
        'Service mesh architecture and implementation',        'Distributed tracing and observability',        'Event sourcing and eventual consistency',        'Circuit breaker and bulkhead patterns',        'Service decomposition strategies',],
      'ml-model':[')        'Advanced model architectures and hyperparameter tuning',        'Distributed training and model parallelization',        'Model interpretation and explainability',        'Federated learning and privacy-preserving ML',        'AutoML and neural architecture search',],
};
  ...
  private async parseResearchResult(
    ...
    try {
      ...
      const principles:CodingPrinciples = {
        ...
        coreStandards:{
          repositoryStructure:parsed.coreStandards?.repositoryStructure || [
            `Use standard $config.languageproject structure`,'Separate source, tests, and documentation',            'Include clear configuration files',],
          fileNaming:parsed.coreStandards?.fileNaming || [
            `Use descriptive $config.languagefile names`,'Follow kebab-case convention',            'Include purpose in filename',],
          folderOrganization:parsed.coreStandards?.folderOrganization || ['Group by feature or domain',            'Use consistent folder structure',            'Separate utilities and shared code',],
          functionComplexity:parsed.coreStandards?.functionComplexity || ['Keep functions under 30 lines',            'Single responsibility principle',            'Maximum 5 parameters',],
          codeOrganization:parsed.coreStandards?.codeOrganization || ['Group related functionality',            'Use consistent folder structure',            'Separate concerns clearly',],
          errorHandling:parsed.coreStandards?.errorHandling || ['Handle errors gracefully',            'Use appropriate error types',            'Provide meaningful error messages',],
          documentation:parsed.coreStandards?.documentation || ['Document public APIs',            'Use inline comments for complex logic',            'Keep documentation up to date',],
          codeQuality:parsed.coreStandards?.codeQuality || ['Follow consistent coding style',            'Use linting and formatting tools',            'Regular code review practices',],
          testingStrategy:parsed.coreStandards?.testingStrategy || ['Write unit tests for core logic',            'Include integration tests',            'Maintain high test coverage',],
},
        ...
        qualityMetrics:{
          ...
          maintainability:parsed.qualityMetrics?.maintainability || {
            metric: 'maintainability_index',            threshold:70,
},
          performance:parsed.qualityMetrics?.performance || {
            metric: 'response_time',            threshold:100,
},
},
      ...
      this.logger.warn('Failed to parse research result:', error);')      return this.getFallbackPrinciples(config);
}
}
...
${principles.domain ? `## Domain:${principles.domain}` :'}')${principles.role ? `## Role:${principles.role}` :'}')`
...
> Please provide feedback to improve future research.`;`
  ...
  private getDefaultTypeSystem(language:ProgrammingLanguage): string[] {
    switch (language) {
      case 'typescript': ')'        return [
          'Use explicit types',          'Avoid any',          'Define interfaces',          'Use union types',];
      case 'python': ')'        return [
          'Use type hints',          'Import from typing',          'Use Protocol for interfaces',];
      case 'rust': ')'        return [
          'Leverage ownership system',          'Use appropriate lifetimes',          'Prefer Result over panic',];
      default:
  ...
  private getDefaultMemoryManagement(language:ProgrammingLanguage): string[] {
    switch (language) {
      case 'rust': ')'        return [
          'Understand ownership',          'Use smart pointers appropriately',          'Avoid memory leaks',];
      case 'go': ')'        return [
          'Let GC handle memory',          'Avoid goroutine leaks',          'Use sync.Pool for object reuse',];
      default:
  ...
  private getDefaultConcurrency(language:ProgrammingLanguage): string[] {
    switch (language) {
      case 'go': ')'        return [
          'Use goroutines and channels',          'Avoid race conditions',          'Use context for cancellation',];
      case 'rust': ')'        return [
          'Use async/await',          'Leverage Send/Sync traits',          'Use Arc/Mutex for shared state',];
      case 'javascript': ')'      case 'typescript': ')'        return [
          'Use async/await',          'Handle Promise rejections',          'Avoid blocking operations',];
      default:
  ...
  private getDefaultPackageManagement(language:ProgrammingLanguage): string[] {
    switch (language) {
      case 'typescript': ')'      case 'javascript': ')'        return [
          'Use npm/yarn/pnpm',          'Lock dependency versions',          'Audit for vulnerabilities',];
      case 'rust': ')'        return [
          'Use Cargo.toml',          'Specify feature flags',          'Use workspace for multi-crate projects',];
      case 'python': ')'        return [
          'Use pip/poetry',          'Create requirements.txt',          'Use virtual environments',];
      default:
  ...
  private getDefaultBuildTools(language:ProgrammingLanguage): string[] {
    switch (language) {
      case 'typescript': ')'        return [
          'Use TypeScript compiler',          'Configure tsconfig.json',          'Use bundler like Vite/Webpack',];
      case 'rust': ')'        return [
          'Use cargo build',          'Configure Cargo.toml',          'Use cargo clippy for linting',];
      default:
  ...
  private getFallbackPrinciples(
    ...
    return {
      ...
      coreStandards:{
        repositoryStructure:[
          'Use clear directory structure',          'Separate concerns into folders',],
        fileNaming:['Use descriptive filenames',    'Follow naming conventions'],
        folderOrganization:[
          'Group related files',          'Use consistent folder structure',],
        functionComplexity:['Keep functions simple',    'Single responsibility'],
        codeOrganization:[
          'Organize code logically',          'Group related functionality',],
        errorHandling:[
      ...
      template: 'Fallback template - requires research',      researchMetadata:{
        researchedAt:new Date(),
        sources:['Fallback'],
        confidence:0.5,
        humanReviewed:false,
...
'    ')      principlesId:feedback.principlesId
  ...
  private async enhancePrinciplesWithLearning(
    ...
    ')      try {
        ...
        this.logger.warn(
          'Error analyzing patterns for principles enhancement: ','          error
        );
}
}
}
