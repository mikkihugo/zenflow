...
export class SPARCMultiSwarmExecutor {
   ...
   */
  async executeSPARCMultiSwarmTest(taskDescription: string,
   ...
   */
  private async executeSPARCStrategiesParallel(taskDescription: string,
    strategies: SPARCStrategy[],
   ...
   */
  private async executeSPARCStrategiesSequential(taskDescription: string,
    strategies: SPARCStrategy[],
    gitConfig: GitTreeConfig,
    options: any
  ): Promise<SPARCExecutionResult[]> {
   ...
   */
  private async executeSingleSPARCStrategy(taskDescription: string,
    strategy: SPARCStrategy,
    gitConfig: GitTreeConfig,
    options:any
  ): Promise<SPARCExecutionResult> {
   ...
   */
  private async simulateSPARCExecution(taskDescription: string,
    strategy: SPARCStrategy,
    gitConfig: GitTreeConfig
  ): Promise<{
