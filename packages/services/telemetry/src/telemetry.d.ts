...
export declare function recordHistogram(
  name: string,
  value: number,
  attributes?: Record<string, any>
): void;
export declare function recordGauge(
  name: string,
  value: number,
  attributes?: Record<string, any>
): void;
export declare function recordEvent(name: string, data?: any): void;
export declare function startTrace(
  name: string,
  options?: SpanOptions
): unknown;
...
export declare function withAsyncTrace<T>(
  name: string,
  fn: () => Promise<T>
): Promise<T>;
export declare function traced(
  name?: string
): (
  target: unknown,
  propertyKey: string,
...
export declare function tracedAsync(
  name?: string
): (
  target: unknown,
  propertyKey: string,
...
export declare function metered(
  name?: string
): (
  target: unknown,
  propertyKey: string,
...
export declare function setTraceAttributes(
