...
export declare function startTrace(name: string, options?: SpanOptions): unknown;
...
export declare function traced(name?: string): (target: unknown, propertyKey: string, descriptor: PropertyDescriptor) => void;
export declare function tracedAsync(name?: string): (target: unknown, propertyKey: string, descriptor: PropertyDescriptor) => void;
export declare function metered(name?: string): (target: unknown, propertyKey: string, descriptor: PropertyDescriptor) => void;
export declare function setTraceAttributes(attributes: Record<string, unknown>): void;
