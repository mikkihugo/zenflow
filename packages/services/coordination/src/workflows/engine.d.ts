...
export declare class WorkflowEngine extends EventBus3 {
  private config;
  ...
  /**
   * Convert entity to document content (deprecated - use document-intelligence).
   */
