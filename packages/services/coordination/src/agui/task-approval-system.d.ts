...
export interface TaskDocumentEntity extends BaseDocumentEntity {
    /** Type discriminator, always 'task' for task documents */ ': any;
    type: 'task;;
...
export interface FeatureDocumentEntity extends BaseDocumentEntity {
    /** Type discriminator, always 'feature' for feature documents */ ': any;
    type: 'feature;;
...
export interface EpicDocumentEntity extends BaseDocumentEntity {
    /** Type discriminator, always 'epic' for epic documents */ ': any;
    type: 'epic;;
 ...
 */
export declare class TaskApprovalSystem extends EventBus {
    private agui;
    private config;
    private logger;
