...
*/
export declare enum SafeGateCategories {
...
PLANNING_INTERVAL_PLANNING = 'planning_interval_planning',
...
VALUE_STREAM_ORGANIZATION = 'value_stream_organization',
BUSINESS_TEAM_LAUNCH = 'business_team_launch',
CONTINUOUS_VALUE_DELIVERY = 'continuous_value_delivery'
}
/**
