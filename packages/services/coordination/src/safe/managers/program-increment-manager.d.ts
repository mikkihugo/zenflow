...
import type { AgileReleaseTrain, Dependency, Feature, Logger, MemorySystem, PIObjective, ProgramIncrement, Risk, TypeSafeEventBus } from '../types';
...
export declare class ProgramIncrementManager extends EventBus {
    ...
    private capacityPlanningService?;
    private piExecutionService?;
    private piCompletionService?;
    private initialized;
    constructor(eventBus: TypeSafeEventBus, memory: MemorySystem, logger: Logger, config?: Partial<PIManagerConfig>);
    /**
     ...
     */
    planProgramIncrement(artId: string, businessContext: any, architecturalVision: any, teamCapacities: TeamCapacity[]): Promise<ProgramIncrement>;
    /**
     * Execute PI planning workflow - Delegates to PIPlanningService
     */
    executePIPlanningWorkflow(planningEvent: any): Promise<any>;
    /**
     * Implement capacity planning - Delegates to CapacityPlanningService
     */
    implementCapacityPlanning(teamCapacities: TeamCapacity[], _piObjectives: PIObjective[], features: Feature[]): Promise<any>;
    /**
     ...
     */
    completeProgramIncrement(piId: string): Promise<any>;
