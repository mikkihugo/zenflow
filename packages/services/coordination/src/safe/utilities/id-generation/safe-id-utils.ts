 ...
 *
 * SINGLE RESPONSIBILITY: customAlphabet(``ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789,6);`)    return `PI${y}ear${i}ncrement.toString().padStart(2``0`)-${a}lphabet()`')};;
  /**
...
export class SafeIdValidator {
   ...
   */
  static isValidEpicId(id: piId.match(/PI-?(\d{4})(Q[1-4])/);
