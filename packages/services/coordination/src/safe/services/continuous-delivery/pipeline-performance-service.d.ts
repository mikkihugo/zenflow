...
import type { PipelineExecution } from './sparc-cd-mapping-service';
/**
...
export declare class PipelinePerformanceService {
     ...
     */
    analyzePipelinePerformance(execution: PipelineExecution): Promise<PerformanceAnalysisResult>;
    /**
     * Get performance insights with intelligent analysis
     */
    getPerformanceInsights(pipelineId?: string): Promise<{
     ...
     */
    optimizePipelinePerformance(pipelineId: string, _optimizationGoals?: string[]): Promise<{
