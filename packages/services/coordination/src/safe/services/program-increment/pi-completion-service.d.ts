...
export declare class PICompletionService extends EventBus {
     ...
     */
    completeProgramIncrement(piId: string, finalMetrics: PIExecutionMetrics, stakeholders: CompletionStakeholder[]): Promise<PICompletionReport>;
    /**
     * Generate comprehensive completion report with AI insights
     */
    generateCompletionReportWithAI(piId: string, finalMetrics: PIExecutionMetrics, workflowConfig: PICompletionWorkflowConfig): Promise<PICompletionReport>;
    /**
     * Schedule Inspect & Adapt workshops
     */
    scheduleInspectAndAdaptWorkshops(workshops: InspectAndAdaptWorkshop[], completionReport: PICompletionReport): Promise<void>;
    /**
     ...
     */
    analyzeCompletionTrends(periodMonths?: number): Promise<CompletionTrendAnalysis>;
    /**
     ...
     */
    private generateCompletionDeliverables;
    /**
     * Plan Inspect & Adapt workshops
     */
    private planInspectAndAdaptWorkshops;
    feedback: any;
    push(mockFeedback: any): any;
}
