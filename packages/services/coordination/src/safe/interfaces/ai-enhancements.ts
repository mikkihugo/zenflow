...
export interface IBrainCoordinator {
  ...
  analyzeTechnicalDebt(
    input: TechnicalDebtAnalysisInput
  ): Promise<TechnicalDebtAnalysisResult>;
  analyzeArchitectureDecision(
    input: ArchitectureDecisionAnalysisInput
  ): Promise<ArchitectureDecisionAnalysisResult>;
  analyzeCapability(
  ...
  predictDeliveryOutcomes(
    input: DeliveryPredictionInput
  ): Promise<DeliveryPredictionResult>;
}
 ...
 * Implementation provided by ../../teamwork package
 */
