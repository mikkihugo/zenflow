 ...
 * @version 1.0.0
 */
import { type WorkflowKanban, type TaskFlowConfig as WorkflowKanbanConfig, type WorkflowTask } from '@claude-zen/taskmaster';
 ...
 */
export declare function createSafePortfolioKanban(logger: Logger, eventBus?: EventEmitter): Promise<WorkflowKanban>;
/**
 * Create Program Kanban for Feature flow management
 */
export declare function createSafeProgramKanban(logger: Logger, eventBus?: EventEmitter): Promise<WorkflowKanban>;
/**
 * Create Team Kanban for Story/Task flow management
 */
export declare function createSafeTeamKanban(logger: Logger, eventBus?: EventEmitter): Promise<WorkflowKanban>;
/**
