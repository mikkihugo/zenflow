...
export interface EpicBlocker {
 ...
 category: 'technical' | 'organizational' | 'resource' | 'dependency';
 impact: string;
 owner: string;
...
export interface EpicRisk {
 ...
 title: string;
 description: string;
 category: 'technical' | 'market' | 'financial' | 'operational' | 'regulatory';
...
export interface EpicMilestone {
 ...
 description: string;
 dueDate: Date;
 status: 'upcoming' | 'achieved' | 'delayed' | 'cancelled';
 achievedDate?: Date;
 deliverables: string[];
}
/**
