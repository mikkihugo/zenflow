 ...
 * ````
 */
// Event-driven integration - SPARC types defined locally, not imported
 ...
 */
export type SAFeAgentRole = 'javascript' | 'typescript' | 'python' | 'java' | 'csharp' | 'cpp' | 'go' | 'ruby' | 'swift' | 'kotlin';
/**
 ...
 */
export type ExperienceLevel = 'novice';
/**
