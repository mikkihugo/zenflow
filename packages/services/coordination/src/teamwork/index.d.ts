...
export declare class ConversationManager extends EventBus {
     ...
     */
    completeSAFeMeeting(meetingId: string, outcomes: MeetingOutcome[]): Promise<void>;
    /**
     * Request cross-team coordination
     */
    requestTeamworkCoordination(request: TeamworkCoordinationRequest): Promise<string>;
    /**
     * Get SAFe team by ID
     */
     ...
     */
    updateMemberAvailability(agentId: string, availability: AgentAvailability): Promise<void>;
    /**
...
export declare class TeamworkOrchestrator {
     ...
     */
    scheduleSAFeCeremony(teamId: string, ceremonyType: SAFeMeeting['type'], duration: number, agenda: MeetingAgenda[]): Promise<string>;
    /**
