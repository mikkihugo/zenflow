...
export const FLOW_PACKAGE_INFO = {
  ...
  useCases: [
   'TaskMaster: Enterprise task management with approval gates,
   'SAFe: Portfolio/Program/Team flow workflows,
   'Workflows: Process orchestration with flow patterns,
   'General workflow coordination and optimization,
