...
export class CompleteSafeFlowIntegration {
   ...
   */
  async continueToARTFlow(flowId: string, programIncrement: any): Promise<{
    gates: any[];
   ...
   */
  async continueToTeamFlow(flowId: string, sprint: any): Promise<{
    gates: any[];
   ...
   */
  async continueToContinuousDeliveryFlow(flowId: string, deployment: any): Promise<{
    gates: any[];
   ...
   */
  private createBasicGate(category: CompleteSafeGateCategory, entity: SafeEntity): any {
    return {
