...
// Event-driven policy: do not import other internal packages; define local types
type DocumentType = string;
import { getLogger} from '@claude-zen/foundation';
interface IDocumentManager {
	getDocumentsByProject: (projectId: string, opts?: any) => Promise<{ success: boolean; data?: any }>;
	createDocument: (...args: any[]) => Promise<{ success: boolean; data?: any }>;
	updateDocument: (...args: any[]) => Promise<{ success: boolean; data?: any }>;
	getDocument: (...args: any[]) => Promise<{ success: boolean; data?: any }>;
	searchDocuments: (...args: any[]) => Promise<{ success: boolean; data?: any }>;
	initialize: () => Promise<void> | void;
	store: (...args: any[]) => Promise<void> | void;
}
