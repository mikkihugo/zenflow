...
export class DocumentTaskVisionCoordinator {
   ...
   */
  async generateTasksFromVision(projectId: string,
    saveToDatabase = true
  ): Promise<{
   ...
   */
  async linkDocumentsToStrategicGoals(projectId: string,
  ...
  private async extractAndGenerateStrategicTasks(vision: StrategicVisionAnalysis,
