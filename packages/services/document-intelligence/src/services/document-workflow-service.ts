...
'      return {
   ...
   */
  private async executeDocumentWorkflow(workflowName: string,
   ...
   */
  private async extractProductRequirements(context: Record<string, unknown>,
    params: Record<string, unknown>
  ): Promise<Record<string, unknown>> {
   ...
   */
  private async createPRDDocument(context: Record<string, unknown>,
    params: Record<string, unknown>
  ): Promise<Record<string, unknown>> {
...
' + requirements?.nonFunctionalRequirements?.map((req:string) => '- ${req).join('Analyzing requirements for epic extraction');
   ...
   */
  private async createEpicDocuments(context: Record<string, unknown>,
    params: Record<string, unknown>
  ): Promise<Record<string, unknown>> {
