/**
 * @fileoverview Agent Types for Teamwork System
 *
 ...
 * and coordination across all packages in the teamwork/swarm system.
 *
 * Key Features:
 ...
 * - Team coordination and swarm management
 *
 * @package @claude-zen/teamwork
 * @since 2.1.0
 * @version 1.0.0
 *
 * @example Basic Usage
