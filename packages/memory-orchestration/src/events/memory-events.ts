 ...
 */
export function isCoordinationEvent(event: MemoryEventType): event is MemorySystemSyncEvent {
 ...
 */
export function isCacheEvent(event: MemoryEventType): event is CacheCoordinationEvent {
