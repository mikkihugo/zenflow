 ...
 */
import type { CoordinationFact, CoordinationFactQuery, FactSearchResult } from './fact-system';
 ...
 */
export declare function storeCoordinationFact(fact: Omit<CoordinationFact, 'id' | 'timestamp'>): Promise<string>;
/**
 * Query coordination facts based on criteria
 */
export declare function queryCoordinationFacts(query?: CoordinationFactQuery): Promise<CoordinationFact[]>;
/**
 ...
 */
export declare function getCoordinationFacts(limit?: number): Promise<CoordinationFact[]>;
/**
 * Store a coordination event as a fact
 */
export declare function storeCoordinationEvent(eventType: string, eventData: unknown, agentId?: string): Promise<string>;
/**
 * Convenience functions for agent integration
 */
export declare function storeAgentFact(agentId: string, type: string, data: unknown, confidence?: number, tags?: string[]): Promise<string>;
export declare function queryAgentFacts(agentId?: string, type?: string, limit?: number): Promise<CoordinationFact[]>;
/**
 * Search external facts (NPM, GitHub, security, etc.) using foundation fact system
 */
export declare function searchExternalFacts(query: string, sources?: string[], limit?: number): Promise<FactSearchResult[]>;
/**
 * Get NPM package information using high-performance Rust fact bridge
 */
export declare function getNPMPackageInfo(packageName: string, version?: string): Promise<unknown>;
/**
 * Get GitHub repository information using high-performance Rust fact bridge
 */
export declare function getGitHubRepoInfo(owner: string, repo: string): Promise<unknown>;
