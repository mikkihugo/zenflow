...
export declare abstract class BaseKnowledgeError extends EnhancedError {
    ...
    constructor(message: string, category: string, severity?: 'low' | 'medium' | 'high' | 'critical', context?: Partial<KnowledgeErrorContext>, recoverable?: boolean);
    private logError;
...
export declare class FACTError extends BaseKnowledgeError {
    constructor(message: string, severity?: 'low' | 'medium' | 'high' | 'critical', context?: Partial<KnowledgeErrorContext>);
}
/**
 ...
 */
export declare function getKnowledgeErrorSeverity(error: Error): 'low' | 'medium' | 'high' | 'critical';
/**
 * Creates a knowledge error with proper context wrapping.
 */
export declare function createKnowledgeError(message: string, category: 'FACT' | 'RAG', context?: Partial<KnowledgeErrorContext>, severity?: 'low' | 'medium' | 'high' | 'critical'): BaseKnowledgeError;
