 ...
 */
import { LLMApprovalConfig, LLMApprovalDecision, LLMApprovalContext, LLMApprovalResult, AutoApprovalRule, LLMApprovalMetrics, HumanOverride } from '../types/llm-approval.js';
export declare class LLMApprovalService {
     ...
     */
    evaluateForApproval(context: LLMApprovalContext, config: LLMApprovalConfig, rules: AutoApprovalRule[]): Promise<LLMApprovalResult>;
    /**
     ...
     */
    learnFromHumanFeedback(taskId: string, llmDecision: LLMApprovalDecision, humanOverride: HumanOverride): Promise<void>;
    /**
