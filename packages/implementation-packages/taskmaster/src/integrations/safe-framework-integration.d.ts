...
import type { QualityGateExecutionConfig } from '@claude-zen/safe-framework/services/continuous-delivery/quality-gate-service';
/**
...
export declare class SafeFrameworkIntegration {
     ...
     */
    createQualityGate(qualityGateConfig: QualityGateExecutionConfig, context: {
        projectId: string;
        artifacts: any[];
        stakeholders: string[];
    }): Promise<{
     ...
     */
    getTraceabilityRecord(traceabilityId: string): Promise<SafeGateTraceabilityRecord | null>;
    /**
     * Get learning insights from all gate decisions
     */
    getLearningInsights(timeframe?: string): Promise<{
    ...
    private shouldUseLLMApproval;
    private processLLMApproval;
    private processLLMQualityApproval;
    private createAGUIApprovalTask;
    private completeTraceabilityRecord;
    private extractLearningPatterns;
    private updateLearningModels;
    private persistTraceabilityRecord;
    private loadTraceabilityRecord;
    ...
    private triggerSafeStateTransition;
    private triggerSafeEscalation;
    private extractDecisionPatterns;
    private calculateAIPerformance;
    private analyzeHumanBehavior;
