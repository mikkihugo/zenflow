...
export type ApprovalGateId = string & {
  readonly __brand: 'ApprovalGateId';
};
/**
 ...
 */
export declare enum WIPViolationSeverity {
  INFO = 'info',
  WARNING = 'warning',
  CRITICAL = 'critical',
  EMERGENCY = 'emergency',
 ...
 */
export declare function isTaskId(value: unknown): value is TaskId;
/**
 ...
 */
export declare function createApprovalGateId(value: string): ApprovalGateId;
/**
 * Helper to create WorkflowId from string
 */
export declare function createWorkflowId(value: string): WorkflowId;
