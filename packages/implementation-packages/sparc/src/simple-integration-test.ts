...
async function testSafe6Core(): Promise<{
  ...
  try {
    ...
    try {
      ...
      const solutionTrainStatus = await manager.getSolutionTrainStatus('test-solution-train');
    ...
    try {
      ...
      results.sparcExports = { 
        ...
        exports: {
          ...
          createSafe6DevelopmentManager: !!sparcExports.createSafe6DevelopmentManager,
          createSafe6SolutionTrainManager: !!sparcExports.createSafe6SolutionTrainManager,
          createSafe6BusinessAgilityManager: !!sparcExports.createSafe6BusinessAgilityManager
        }
      };
