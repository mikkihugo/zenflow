...
export class IntelligentCache {
    ...
    hitCount = 0;
    missCount = 0;
    constructor(namespace = 'intelligent-cache') {
     ...
     */
    async initializeDatabase(namespace) {
        try {
