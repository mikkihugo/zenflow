...
export function createPatternLearner(_config: any): PatternLearner {
  return {
    async initialize(_cfg: any): Promise<void> {
      // Initialization handled in learnPatterns call
    },
    async learnPatterns(_data: any[]): Promise<PatternResult> {
      return {
    ...
    async trainPatterns(data: any[], _labels?: any[]): Promise<PatternResult> {
...
export function createOnlineLearner(_config: any): OnlineLearner {
  return {
    async initialize(_cfg: any): Promise<void> {
      // Initialization handled in configure call
    },
    async configure(_params: OnlineLearnerConfig): Promise<void> {
      // Configuration handled by Rust
    },
    async updateModel(_data: any, _target?: any): Promise<void> {
      // Update handled by Rust
    },
    ...
    async detectDrift(_predictions: number[], _targets: number[]): Promise<ConceptDriftDetection> {
    ...
    async reset(_keepHistory: boolean): Promise<void> {
