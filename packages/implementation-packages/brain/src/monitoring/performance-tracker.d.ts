...
export declare class PerformanceTracker {
     ...
     */
    completeTracking(agentId: string, operation: string, startTime: number, success?: boolean, error?: string, metadata?: Record<string, unknown>): PerformanceSnapshot;
    /**
 ...
 */
export declare function createPerformanceTracker(config?: Partial<PerformanceTrackerConfig>): PerformanceTracker;
/**
 ...
 */
export declare function withPerformanceTracking<T>(operation: string, agentId: string, fn: () => Promise<T>, metadata?: Record<string, unknown>): Promise<T>;
