...
export declare class RetrainingMonitor {
     ...
     */
    manualRetrain(reason: string, additionalMetrics?: Record<string, number>): Promise<RetrainingResult>;
    /**
     ...
     */
    getRetrainingHistory(limit?: number): Promise<Array<RetrainingTrigger & RetrainingResult>>;
    /**
