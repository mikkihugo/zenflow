...
export declare class DSPyLLMBridge {
     ...
     */
    executeCoordinationTask(task: DSPyCoordinationTask, config?: DSPyOptimizationConfig): Promise<CoordinationResult>;
    /**
     * Process coordination task (alias for backward compatibility)
     */
    processCoordinationTask(task: DSPyCoordinationTask, config?: DSPyOptimizationConfig): Promise<CoordinationResult>;
    /**
     * Learn from coordination feedback (fallback)
     */
    learnFromCoordination(task: DSPyCoordinationTask, result: any, feedback: {
        success: boolean;
        improvements?: string[];
    }): Promise<void>;
    /**
