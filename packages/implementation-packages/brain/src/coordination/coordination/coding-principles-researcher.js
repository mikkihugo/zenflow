...
var CodingPrinciplesResearcher = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.dspyBridge.processCoordinationTask(researchTask)];
                    case 2:
                        researchResult = _a.sent();
                        if (!(researchResult.success && researchResult.result)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.parseResearchResult(researchResult.result, config)];
                    case 3:
                        principles = _a.sent();
                        // Cache the result
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.enhancePrinciplesWithLearning(existing, successPatterns)];
                    case 1:
                        // Enhance existing principles with learned patterns
                        _a.sent();
        ...
        return __awaiter(this, arguments, void 0, function (config, targetConfidence) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        principles = _a.sent();
                        return [4 /*yield*/, this.evaluateResearchQuality(principles, config)];
                    case 4:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.updateConfidenceFromAgentFeedback(feedback)];
                    case 1:
                        // Update confidence based on agent feedback
                        _a.sent();
                        // Check if principles need improvement
                        return [4 /*yield*/, this.evaluateImprovementNeeds(feedback.principlesId)];
                    case 2:
                        // Check if principles need improvement
                        _a.sent();
                        return [2 /*return*/];
     ...
     * Get comprehensive research areas based on role and domain
     */
    CodingPrinciplesResearcher.prototype.getComprehensiveResearchAreas = function (role, domain) {
        return {
            ...
            return __generator(this, function (_z) {
                try {
                    ...
                    principles = {
                        ...
                        role: config.role,
                        coreStandards: {
                            repositoryStructure: ((_a = parsed.coreStandards) === null || _a === void 0 ? void 0 : _a.repositoryStructure) || [
                            ...
                            fileNaming: ((_b = parsed.coreStandards) === null || _b === void 0 ? void 0 : _b.fileNaming) || [
                                "Use descriptive ".concat(config.language, " file names"),
                                'Follow kebab-case convention',
                                'Include purpose in filename'
                            ],
                            folderOrganization: ((_c = parsed.coreStandards) === null || _c === void 0 ? void 0 : _c.folderOrganization) || [
                                'Group by feature or domain',
                                'Use consistent folder structure',
                                'Separate utilities and shared code'
                            ],
                            functionComplexity: ((_d = parsed.coreStandards) === null || _d === void 0 ? void 0 : _d.functionComplexity) || [
                                'Keep functions under 30 lines',
                                'Single responsibility principle',
                                'Maximum 5 parameters'
                            ],
                            codeOrganization: ((_e = parsed.coreStandards) === null || _e === void 0 ? void 0 : _e.codeOrganization) || [
                                'Group related functionality',
                                'Use consistent folder structure',
                                'Separate concerns clearly'
                            ],
                            errorHandling: ((_f = parsed.coreStandards) === null || _f === void 0 ? void 0 : _f.errorHandling) || [
                                'Handle errors gracefully',
                                'Use appropriate error types',
                                'Provide meaningful error messages'
                            ],
                            documentation: ((_g = parsed.coreStandards) === null || _g === void 0 ? void 0 : _g.documentation) || [
                                'Document public APIs',
                                'Use inline comments for complex logic',
                                'Keep documentation up to date'
                            ],
                            codeQuality: ((_h = parsed.coreStandards) === null || _h === void 0 ? void 0 : _h.codeQuality) || [
                                'Follow consistent coding style',
                                'Use linting and formatting tools',
                                'Regular code review practices'
                            ],
                            testingStrategy: ((_j = parsed.coreStandards) === null || _j === void 0 ? void 0 : _j.testingStrategy) || [
                        ...
                        languageSpecific: {
                            typeSystem: ((_k = parsed.languageSpecific) === null || _k === void 0 ? void 0 : _k.typeSystem) || this.getDefaultTypeSystem(config.language),
                            memoryManagement: ((_l = parsed.languageSpecific) === null || _l === void 0 ? void 0 : _l.memoryManagement) || this.getDefaultMemoryManagement(config.language),
                            concurrency: ((_m = parsed.languageSpecific) === null || _m === void 0 ? void 0 : _m.concurrency) || this.getDefaultConcurrency(config.language),
                            packageManagement: ((_o = parsed.languageSpecific) === null || _o === void 0 ? void 0 : _o.packageManagement) || this.getDefaultPackageManagement(config.language),
                            buildTools: ((_p = parsed.languageSpecific) === null || _p === void 0 ? void 0 : _p.buildTools) || this.getDefaultBuildTools(config.language)
                        },
                        domainSpecific: config.domain ? {
                            architecture: ((_q = parsed.domainSpecific) === null || _q === void 0 ? void 0 : _q.architecture) || [],
                            dataHandling: ((_r = parsed.domainSpecific) === null || _r === void 0 ? void 0 : _r.dataHandling) || [],
                            apiDesign: ((_s = parsed.domainSpecific) === null || _s === void 0 ? void 0 : _s.apiDesign) || [],
                            userInterface: ((_t = parsed.domainSpecific) === null || _t === void 0 ? void 0 : _t.userInterface) || [],
                            deployment: ((_u = parsed.domainSpecific) === null || _u === void 0 ? void 0 : _u.deployment) || []
                        } : undefined,
                        qualityMetrics: {
                            complexity: ((_v = parsed.qualityMetrics) === null || _v === void 0 ? void 0 : _v.complexity) || { metric: 'cyclomatic', threshold: 10 },
                            coverage: ((_w = parsed.qualityMetrics) === null || _w === void 0 ? void 0 : _w.coverage) || { metric: 'line', threshold: 80 },
                            maintainability: ((_x = parsed.qualityMetrics) === null || _x === void 0 ? void 0 : _x.maintainability) || { metric: 'maintainability_index', threshold: 70 },
                            performance: ((_y = parsed.qualityMetrics) === null || _y === void 0 ? void 0 : _y.performance) || { metric: 'response_time', threshold: 100 }
                        },
     ...
     */
    CodingPrinciplesResearcher.prototype.generateReviewableTemplate = function (principles) {
        return "# ".concat(principles.language.toUpperCase(), " Coding Principles\n").concat(principles.domain ? "## Domain: ".concat(principles.domain) : '', "\n").concat(principles.role ? "## Role: ".concat(principles.role) : '', "\n\n## \uD83D\uDCC1 File Naming & Organization\n").concat(principles.coreStandards.fileNaming.map(function (item) { return "- ".concat(item); }).join('\n'), "\n\n## \u26A1 Function Guidelines  \n").concat(principles.coreStandards.functionComplexity.map(function (item) { return "- ".concat(item); }).join('\n'), "\n\n## \uD83D\uDD27 ").concat(principles.language.charAt(0).toUpperCase() + principles.language.slice(1), "-Specific\n### Type System\n").concat(principles.languageSpecific.typeSystem.map(function (item) { return "- ".concat(item); }).join('\n'), "\n\n### Package Management\n").concat(principles.languageSpecific.packageManagement.map(function (item) { return "- ".concat(item); }).join('\n'), "\n\n## \uD83D\uDCCA Quality Metrics\n- **Complexity**: ").concat(principles.qualityMetrics.complexity.metric, " < ").concat(principles.qualityMetrics.complexity.threshold, "\n- **Coverage**: ").concat(principles.qualityMetrics.coverage.metric, " > ").concat(principles.qualityMetrics.coverage.threshold, "%\n- **Maintainability**: ").concat(principles.qualityMetrics.maintainability.metric, " > ").concat(principles.qualityMetrics.maintainability.threshold, "\n\n---\n**Research Date**: ").concat(principles.researchMetadata.researchedAt.toISOString(), "\n**Confidence**: ").concat((principles.researchMetadata.confidence * 100).toFixed(1), "%\n**Human Reviewed**: ").concat(principles.researchMetadata.humanReviewed ? 'Yes' : 'No', "\n\n> This template is AI-generated and should be reviewed by human experts.\n> Please provide feedback to improve future research.");
    };
    // Helper methods for language-specific defaults
    CodingPrinciplesResearcher.prototype.getDefaultTypeSystem = function (language) {
        switch (language) {
            case 'typescript':
    ...
    CodingPrinciplesResearcher.prototype.getDefaultMemoryManagement = function (language) {
        switch (language) {
            case 'rust':
    ...
    CodingPrinciplesResearcher.prototype.getDefaultConcurrency = function (language) {
        switch (language) {
            case 'go':
    ...
    CodingPrinciplesResearcher.prototype.getDefaultPackageManagement = function (language) {
        switch (language) {
            case 'typescript':
            case 'javascript':
    ...
    CodingPrinciplesResearcher.prototype.getDefaultBuildTools = function (language) {
        switch (language) {
            case 'typescript':
    ...
    CodingPrinciplesResearcher.prototype.generateTemplate = function (parsed) {
        return parsed.template || 'AI-generated coding principles template';
    };
    CodingPrinciplesResearcher.prototype.generateCacheKey = function (config) {
    ...
    CodingPrinciplesResearcher.prototype.incorporateFeedback = function (feedback) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (patterns && typeof patterns === 'object') {
                    try {
                        ...
                        if (patternKeys.length > 0) {
                            ...
                            principles.researchMetadata.sources.push("pattern-analysis-".concat(patternKeys.length, "-patterns"));
                        }
                    }
                    catch (error) {
     ...
     */
    CodingPrinciplesResearcher.prototype.calculatePatternSuccessRate = function (patterns) {
        try {
    ...
    CodingPrinciplesResearcher.prototype.extractBestPracticesFromPatterns = function (principles, patterns) {
        ...
        try {
            ...
            if (patterns.commonPatterns) {
                (_a = principles.bestPractices).push.apply(_a, patterns.commonPatterns.filter(function (p) {
                    return typeof p === 'string' && p.length > 10 && !principles.bestPractices.includes(p);
                }));
            }
            if (patterns.recommendations) {
                (_b = principles.antiPatterns).push.apply(_b, ((_c = patterns.recommendations.avoid) === null || _c === void 0 ? void 0 : _c.filter(function (p) {
                    return typeof p === 'string' && p.length > 10 && !principles.antiPatterns.includes(p);
                })) || []);
            }
            // Extract quality metrics if available
            if (patterns.qualityMetrics) {
                principles.researchMetadata.confidence = Math.min(principles.researchMetadata.confidence + (patterns.qualityMetrics.score || 0) * 0.1, 1.0);
            }
        }
        catch (error) {
     ...
     */
    CodingPrinciplesResearcher.prototype.getPromptConfidence = function (cacheKey) {
    ...
    CodingPrinciplesResearcher.prototype.evaluateResearchQuality = function (principles, config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                filledCoreAreas = requiredCoreAreas.filter(function (area) {
                    return principles.coreStandards[area].length > 0;
                });
                ...
                filledLangAreas = requiredLangAreas.filter(function (area) {
                    return principles.languageSpecific[area].length > 0;
                });
                ...
                if (config.domain && principles.domainSpecific) {
                    ...
                    filledDomainAreas = requiredDomainAreas.filter(function (area) {
                        return principles.domainSpecific[area].length > 0;
                    });
                    qualityScore += (filledDomainAreas.length / Math.max(requiredDomainAreas.length, 1)) * 0.2;
                }
                maxScore += 0.2;
                hasValidMetrics = Object.values(principles.qualityMetrics).every(function (metric) {
                    return metric.threshold > 0 && metric.metric.length > 0;
                });
    ...
    CodingPrinciplesResearcher.prototype.enhanceConfigWithFeedback = function (config, confidence) {
        ...
        if (feedbacks.length > 0) {
            ...
            if (commonMissing.some(function (area) { return area.toLowerCase().includes('performance'); })) {
                enhancedConfig.includePerformance = true;
            }
            if (commonMissing.some(function (area) { return area.toLowerCase().includes('security'); })) {
                enhancedConfig.includeSecurity = true;
            }
            if (commonMissing.some(function (area) { return area.toLowerCase().includes('test'); })) {
    ...
    CodingPrinciplesResearcher.prototype.updateConfidenceFromAgentFeedback = function (feedback) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                confidence.overallConfidence = (confidence.initialConfidence * 0.3 +
    ...
    CodingPrinciplesResearcher.prototype.evaluateImprovementNeeds = function (principlesId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                recentAvgAccuracy = recentFeedbacks.reduce(function (sum, f) { return sum + f.accuracy; }, 0) / recentFeedbacks.length;
                recentAvgUsefulness = recentFeedbacks.reduce(function (sum, f) { return sum + f.usefulness; }, 0) / recentFeedbacks.length;
                // Mark for improvement if performance is declining or below threshold
                confidence.needsImprovement = (confidence.overallConfidence < this.minimumConfidenceThreshold ||
                    recentAvgAccuracy < 0.7 ||
                    recentAvgUsefulness < 0.7 ||
                    feedbacks.some(function (f) { return f.missingAreas.length > 2; }) // Many missing areas
                );
