...
export declare class CodingPrinciplesResearcher {
    ...
    private logger;
    constructor(dspyBridge: DSPyLLMBridge, behavioralIntelligence?: BehavioralIntelligence);
    /**
     ...
     */
    learnFromSuccess(config: PrinciplesResearchConfig, successPatterns: {
     ...
     */
    researchPrinciplesWithConfidence(config: PrinciplesResearchConfig, targetConfidence?: number): Promise<CodingPrinciples>;
    /**
     ...
     */
    getAdaptivePrinciples(config: PrinciplesResearchConfig): Promise<CodingPrinciples>;
    /**
