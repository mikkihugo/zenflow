...
export declare class NeuralSafetyBridge extends EventEmitter {
     ...
     */
    learnFromFeedback(interactionData: any, actualDeception: boolean, feedback: string): Promise<void>;
    /**
 ...
 */
export declare function createNeuralSafetyBridge(config: NeuralSafetyConfig): NeuralSafetyBridge;
