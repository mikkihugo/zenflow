...
export declare class TaskComplexityEstimator {
     ...
     */
    learnFromOutcome(task: string, prompt: string, context: Record<string, any>, actualComplexity: number, actualDuration: number, actualSuccess: boolean, agentRole?: string): Promise<void>;
    /**
