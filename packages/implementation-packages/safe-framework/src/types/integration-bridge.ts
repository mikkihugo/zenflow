...
import type { Feature, PIObjective, ProgramIncrement, ArchitecturalDriver } from '../types';
import type { SPARCProject, SPARCPhase, ProjectSpecification } from '@claude-zen/sparc';
