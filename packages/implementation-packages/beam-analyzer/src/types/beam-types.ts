...
export type BeamFindingCategory = 
  | 'security'
  | 'performance' 
  | 'reliability'
  | 'maintainability'
...
export type DialyzerWarningType =
  | 'no_return'
  | 'unused_fun' 
  | 'undef'
  | 'unknown_function'
...
export type BeamAnalysisExecutionResult = Result<BeamAnalysisResult, BeamAnalysisError>;
