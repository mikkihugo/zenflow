...
export declare class BootstrapFinetuneML extends Teleprompter {
     ...
     */
    compileML(student: DSPyModule, teacher?: DSPyModule, trainset?: any[], valset?: any[]): Promise<BootstrapFinetuneMLResult>;
    /**
 ...
 */
export declare function createBootstrapFinetuneML(config?: Partial<BootstrapFinetuneMLConfig>): BootstrapFinetuneML;
