 ...
 */
export type { MemoryStore, MemoryStats, StoreOptions, MemoryConfig, SessionState, SessionMemoryStoreOptions, CacheEntry, MemoryBackendType, MemoryError, MemoryConnectionError, MemoryStorageError, MemoryCapacityError, } from './types';
...
export declare function getMemorySystemAccess(config?: MemoryConfig): Promise<any>;
export declare function getMemoryManager(config?: MemoryConfig): Promise<MemoryManager>;
export declare function getMemoryStorage(storeId: string, config?: MemoryConfig): Promise<any>;
export declare function getSessionMemory(sessionId: string, config?: MemoryConfig): Promise<any>;
export declare function getMemoryCoordination(config?: MemoryConfig): Promise<any>;
