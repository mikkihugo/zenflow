 ...
 */
import type { MemoryConfig, MemoryProviderFactory } from '../providers/memory-providers';
/**
...
export declare class MemoryController {
    ...
    constructor(_factory: MemoryProviderFactory, _config: MemoryConfig, _logger: Logger);
    /**
