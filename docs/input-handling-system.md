...
This document specifies the design for a unified user input handling system that seamlessly processes commands from both CLI and web UI interfaces while maintaining full compatibility with existing claude-zen operations.
...
class AliasRegistry {
  ...
  private loadDefaultAliases(): void {
    // Common shortcuts for claude-zen commands
    this.aliases.set('cf', 'claude-zen');
    this.aliases.set('start', 'claude-zen start');
    this.aliases.set('status', 'claude-zen status');
    this.aliases.set('agents', 'claude-zen agent list');
    this.aliases.set('tasks', 'claude-zen task list');
    this.aliases.set('mem', 'claude-zen memory');
    this.aliases.set('cfg', 'claude-zen config');
    
    // Development shortcuts
    this.aliases.set('dev', 'claude-zen start --mode development');
    this.aliases.set('test', 'claude-zen start --mode testing');
    this.aliases.set('prod', 'claude-zen start --mode production');
...
The architecture ensures that users can interact with claude-zen through both CLI and web interfaces seamlessly, with full security and performance optimization while maintaining complete compatibility with existing CLI operations.