...
### Core Swarm Tools (12)
- `mcp__claude-zen__swarm_init` - Initialize swarms
- `mcp__claude-zen__swarm_status` - Get swarm status
- `mcp__claude-zen__swarm_monitor` - Monitor swarm activity
- `mcp__claude-zen__agent_spawn` - Spawn new agents
- `mcp__claude-zen__agent_list` - List active agents
- `mcp__claude-zen__agent_metrics` - Agent performance metrics
- `mcp__claude-zen__task_orchestrate` - Orchestrate tasks
- `mcp__claude-zen__task_status` - Check task progress
- `mcp__claude-zen__task_results` - Get task results
- `mcp__claude-zen__memory_usage` - Memory management
- `mcp__claude-zen__neural_status` - Neural network status
- `mcp__claude-zen__neural_train` - Train neural agents

### Neural & Advanced Tools (5)
- `mcp__claude-zen__neural_patterns` - Cognitive patterns
- `mcp__claude-zen__benchmark_run` - Performance benchmarks
- `mcp__claude-zen__features_detect` - Feature detection

### DAA (Decentralized Autonomous Agents) Tools (6)
- `mcp__claude-zen__daa_init` - Initialize DAA service
- `mcp__claude-zen__daa_agent_create` - Create autonomous agents
- `mcp__claude-zen__daa_workflow_create` - Create DAA workflows
- `mcp__claude-zen__daa_learning_status` - Learning progress
- `mcp__claude-zen__daa_metrics` - DAA metrics
- `mcp__claude-zen__daa_optimization` - DAA optimization

### Performance Tools (4)
- `mcp__claude-zen__performance_analyze` - Analyze performance
- `mcp__claude-zen__performance_optimize` - Optimize performance
- `mcp__claude-zen__performance_monitor` - Monitor performance
- `mcp__claude-zen__performance_report` - Generate reports
...
mcp__claude-zen__swarm_init {"topology": "mesh", "maxAgents": 5, "strategy": "balanced"}
```
...
# MCP tool
mcp__claude-zen__agent_spawn {"type": "researcher", "name": "Research-Agent-1"}
```
...
# MCP tool
mcp__claude-zen__task_orchestrate {"task": "Analyze project structure", "strategy": "parallel"}
```
