...
mcp__claude-zen__swarm_init { topology: "star", maxAgents: 3 }
mcp__claude-zen__agent_spawn { type: "coordinator", name: "Issue Coordinator" }
mcp__claude-zen__agent_spawn { type: "researcher", name: "Requirements Analyst" }
mcp__claude-zen__agent_spawn { type: "coder", name: "Implementation Planner" }
...
[Single Message - Issue Lifecycle Management]:
  ...
  mcp__claude-zen__agent_spawn { type: "coordinator", name: "Issue Manager" }
  mcp__claude-zen__agent_spawn { type: "analyst", name: "Progress Tracker" }
  mcp__claude-zen__agent_spawn { type: "researcher", name: "Context Gatherer" }
