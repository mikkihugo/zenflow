 ...
 */
const MultiSwarmABTesting = /** @class */ (() => {
            ...
            case 0:
              ...
              logger.info(
                '\uD83D\uDD2C Testing '
                  ...
                  .concat(strategies.map((s) => s.name).join(', '))
              );
              _d.label = 1;
            case 1:
                  ...
                  switch (_b.label) {
                    ...
                    case 3:
                      ...
                      return [
                        4 /*yield*/,
                        new Promise((resolve) =>
                          setTimeout(resolve, retryDelay_1)
                        ),
                      ];
                    case 4:
                      _b.sent();
  ...
  MultiSwarmABTesting.prototype.simulateSwarmExecution = function (
    ...
    return __awaiter(
      ...
      arguments,
      void 0,
      function (strategy, _prompt, _worktreePath, options) {
        let qualityBoost,
          speedMultiplier,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                new Promise((resolve) => setTimeout(resolve, adjustedDelay)),
              ];
            case 1:
              _a.sent();
              return [
  ...
  MultiSwarmABTesting.prototype.getBaseQualityForModel = (model) => {
    switch (model) {
      case 'claude-opus':
        return 92;
      case 'claude-sonnet':
  ...
  MultiSwarmABTesting.prototype.getTopologyMultiplier = (topology) => {
    switch (topology) {
      case 'mesh':
        return 1.1;
      case 'hierarchical':
  ...
  MultiSwarmABTesting.prototype.analyzeResults = (results) => {
  ...
  MultiSwarmABTesting.prototype.generateInsights = (results, comparison) => {
    ...
    Object.entries(modelPerformance).forEach((_a) => {
      const model = _a[0],
        scores = _a[1];
      const avgScore =
        scores.reduce((sum, score) => sum + score, 0) / scores.length;
  ...
  MultiSwarmABTesting.prototype.findMostSuccessfulStrategy = (strategies) => {
    ...
    // Find most frequent
    const mostFrequentId = Object.entries(counts).sort((_a, _b) => {
      const a = _a[1];
      const b = _b[1];
      return b - a;
    })[0][0];
 ...
 */
function quickABTest(_taskDescription_1) {
  return __awaiter(
    this,
    arguments,
    void 0,
