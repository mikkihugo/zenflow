...
const SessionMemoryStore = (() => {
    ...
    var SessionMemoryStore = class extends _classSuper {
        ...
        async initialize() {
            ...
            return withTrace('memory-store-initialize', () => withRetry(async () => safeAsync(async () => {
        ...
        async store(sessionIdOrKey, keyOrData, dataOrOptions, options) {
            ...
            return withTrace('memory-store-operation', async () => withRetry(async () => safeAsync(async () => {
        ...
        async retrieve(sessionIdOrKey, key) {
            ...
            return withTrace('memory-retrieve-operation', async () => withRetry(async () => safeAsync(async () => {
        ...
        async delete(sessionIdOrKey, key) {
            ...
            return withTrace('memory-delete-operation', async () => withRetry(async () => safeAsync(async () => {
...
const MemoryManager = (() => {
    ...
    var MemoryManager = class {
        ...
        async initialize() {
            ...
            return withTrace('memory-manager-initialize', async () => withRetry(async () => safeAsync(async () => {
        ...
        async storeData(key, data, options) {
            ...
            return withTrace('memory-manager-store', async () => withRetry(async () => safeAsync(async () => {
                await this.circuitBreaker.execute({
                    operation: 'store',
                    key,
                    data,
        ...
        async retrieve(key) {
            ...
            return withTrace('memory-manager-retrieve', async () => withRetry(async () => safeAsync(async () => {
