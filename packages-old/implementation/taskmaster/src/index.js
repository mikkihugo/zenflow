...
export { createHighThroughputWorkflowKanban, createWorkflowKanban, WorkflowKanban, } from './api/workflow-kanban';
...
// =============================================================================
export { createConfiguredWorkflowMachine, createDefaultWorkflowConfig, createWorkflowMachine, WorkflowContextUtils, } from './state-machines/workflow';
// =============================================================================
...
export const isValidWorkflowState = (state) => {
    return ALL_WORKFLOW_STATES.includes(state);
};
/**
 ...
 */
export const isValidOptimizationStrategy = (strategy) => {
    return OPTIMIZATION_STRATEGIES.includes(strategy);
};
/**
 * Get next state in workflow (or null if at end)
 */
export const getNextWorkflowState = (currentState) => {
 ...
 */
export const getPreviousWorkflowState = (currentState) => {
    const currentIndex = DEFAULT_WORKFLOW_STATES.indexOf(currentState);
    if (currentIndex <= 0) {
        return null;
    }
