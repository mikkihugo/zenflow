...
export const DefaultEventManagerConfigs = {
  system: {
    ...
    maxListeners: 100,
    processing: { strategy: 'immediate' as const },
  },
  coordination: {
    name: 'default-coordination',
    type: 'coordination' as const,
    maxListeners: 50,
    processing: { strategy: 'queued' as const, queueSize: 1000 },
  },
  communication: {
    name: 'default-communication',
    type: 'communication' as const,
    maxListeners: 75,
    processing: { strategy: 'throttled' as const, throttleMs: 100 },
  },
  monitoring: {
    name: 'default-monitoring',
    type: 'monitoring' as const,
    maxListeners: 200,
    processing: { strategy: 'batched' as const, batchSize: 10 },
  },
  interface: {
  ...
  neural: {
    ...
    maxListeners: 25,
    processing: { strategy: 'queued' as const, queueSize: 500 },
  },
  database: {
    name: 'default-database',
    type: 'database' as const,
    maxListeners: 100,
    processing: { strategy: 'batched' as const, batchSize: 20 },
  },
  memory: {
    name: 'default-memory',
  ...
  workflow: {
    ...
    maxListeners: 75,
    processing: { strategy: 'queued' as const, queueSize: 200 },
  },
} as const;
