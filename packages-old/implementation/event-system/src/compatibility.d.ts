...
import type { EventManagerType } from './core/interfaces';
...
export declare class UELCompatibleEventEmitter extends EventEmitter {
     ...
     */
    enableUEL(manager?: EventManager, options?: {
    ...
    listeners<K extends string>(eventName: K): ((data: unknown) => void)[];
    /**
...
export declare class CompatibilityFactory {
     ...
     * @param logger
     */
    initialize(eventManager: EventManager, logger?: Logger): Promise<void>;
    /**
...
export { UELCompatibleEventEmitter as CompatibleEventEmitter, type EventEmitterMigrationHelper as MigrationHelper, };
