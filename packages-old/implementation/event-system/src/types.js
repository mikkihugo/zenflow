...
export const UELTypeGuards = {
    isSystemLifecycleEvent: (event) => event.type.startsWith('system:'),
    isCoordinationEvent: (event) => event.type.startsWith('coordination:'),
    isCommunicationEvent: (event) => event.type.startsWith('communication:'),
    isMonitoringEvent: (event) => event.type.startsWith('monitoring:'),
    isInterfaceEvent: (event) => event.type.startsWith('interface:'),
    isNeuralEvent: (event) => event.type.startsWith('neural:'),
    isDatabaseEvent: (event) => event.type.startsWith('database:'),
    isMemoryEvent: (event) => event.type.startsWith('memory:'),
    isWorkflowEvent: (event) => event.type.startsWith('workflow:'),
    isOrchestrationEvent: (event) => event.type.startsWith('orchestration:'),
    isSafeEvent: (event) => event.type.startsWith('safe:'),
    isMemoryOrchestrationEvent: (event) => event.type.startsWith('memory_orchestration:'),
    isUELEvent: (event) => {
