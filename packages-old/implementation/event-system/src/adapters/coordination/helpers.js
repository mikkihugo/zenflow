...
export class CoordinationEventUtils {
     ...
     */
    static extractCoordinationOperation(eventType) {
     ...
     */
    static extractTargetId(data) {
        if (data && typeof data === 'object') {
            const obj = data;
            return ((typeof obj.swarmId === 'string' ? obj.swarmId : undefined) ||
     ...
     */
    static determineEventPriority(eventType) {
