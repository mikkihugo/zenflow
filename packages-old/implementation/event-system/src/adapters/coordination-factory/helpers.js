 ...
 */
export function createDefaultCoordinationConfig(name, overrides) {
    return {
        name,
        type: 'coordination',
        enabled: true,
 ...
 */
export function logCoordinationEvent(logger, event, data) {
    logger.debug(`Coordination event: ${event}`, data);
}
/**
 * Helper function to generate coordination event IDs.
 */
export function generateCoordinationEventId() {
