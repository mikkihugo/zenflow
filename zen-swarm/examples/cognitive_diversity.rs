...
async fn main() -> Result<()> {
  ...
  let analysts = vec![
    swarm
      .spawn_agent_with_style(AgentType::Worker, CognitiveStyle::Analytical)
      .await?,
    swarm
      .spawn_agent_with_style(AgentType::Worker, CognitiveStyle::Analytical)
      .await?,
  ...
  println!(
    "Analytical Agents ({}): Focus on data analysis and optimization",
    analysts.len()
  );
  ...
  println!(
    "Creative Agents ({}): Focus on innovative solutions",
    creatives.len()
  );
  ...
  println!(
    "Strategic Agents ({}): Focus on planning and coordination",
    strategists.len()
  );
  ...
  println!(
    "Practical Agents ({}): Focus on implementation",
    practitioners.len()
  );
  ...
  println!(
    "Detail-Oriented Agents ({}): Focus on quality and precision",
    detail_oriented.len()
  );
  ...
  let start_time = Instant::now();
  let impl_result = swarm
    .orchestrate_with_diversity(implementation_task)
    .await?;
  println!("  Completed in {:?}", start_time.elapsed());
  println!("  Lead agents: {:?}", impl_result.lead_agents);
  println!(
    "  Components built: {} modules\n",
