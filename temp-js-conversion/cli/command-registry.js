...
const hive_mind_optimize_js_1 = require("./simple-commands/hive-mind-optimize.js");
...
First-time users should run: npx claude-flow@latest init --sparc`
    ...
    exports.commandRegistry.set('start-ui', {
        handler: async (args, flags) => {
            ...
            const { launchUI } = await Promise.resolve().then(() => require('./simple-commands/start-ui.js'));
    ...
    exports.commandRegistry.set('hive', {
        handler: async (args, flags) => {
            try {
                ...
                const { hiveAction } = await Promise.resolve().then(() => require('./commands/hive.js'));
