...
class Dashboard {
    ...
    generateMockEvents() {
        ...
        const eventTypes = [
            { type: 'task_completed', message: 'Research task completed successfully', level: 'info' },
            { type: 'agent_spawned', message: 'New implementer agent spawned', level: 'info' },
            { type: 'task_assigned', message: 'Task assigned to coordinator agent', level: 'info' },
            { type: 'system_warning', message: 'High memory usage detected', level: 'warn' },
            { type: 'task_failed', message: 'Analysis task failed due to timeout', level: 'error' },
