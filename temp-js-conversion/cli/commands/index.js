...
function setupCommands(cli) {
        ...
        action: async (ctx) => {
            try {
                ...
                for (const file of files) {
                    const { access } = await Promise.resolve().then(() => require("fs/promises"));
    ...
    cli.command({
        ...
        action: async (ctx) => {
            ...
            const { agentCommand } = await Promise.resolve().then(() => require("./agent.js"));
            ...
            try {
                ...
                switch (subcommand) {
                    ...
                    case "health":
                        ...
                        const { EventBus } = await Promise.resolve().then(() => require("../../core/event-bus.js"));
                        const { Logger } = await Promise.resolve().then(() => require("../../core/logger.js"));
                        const { DistributedMemorySystem } = await Promise.resolve().then(() => require("../../memory/distributed-memory.js"));
    ...
    cli.command({
        ...
        action: async (ctx) => {
            try {
                ...
                const { hiveMindCommand } = await Promise.resolve().then(() => require('./hive-mind/index.js'));
                // Execute the appropriate subcommand
                switch (subcommand) {
                    case "init":
                        const { initCommand } = await Promise.resolve().then(() => require('./hive-mind/init.js'));
                        await initCommand.parseAsync(process.argv.slice(3));
                        break;
                    case "spawn":
                        const { spawnCommand } = await Promise.resolve().then(() => require('./hive-mind/spawn.js'));
                        await spawnCommand.parseAsync(process.argv.slice(3));
                        break;
                    case "status":
                        const { statusCommand } = await Promise.resolve().then(() => require('./hive-mind/status.js'));
                        await statusCommand.parseAsync(process.argv.slice(3));
                        break;
                    case "task":
                        const { taskCommand } = await Promise.resolve().then(() => require('./hive-mind/task.js'));
                        await taskCommand.parseAsync(process.argv.slice(3));
                        break;
                    case "stop":
                        const { stopCommand } = await Promise.resolve().then(() => require('./hive-mind/stop.js'));
                        await stopCommand.parseAsync(process.argv.slice(3));
                        break;
                    case "pause":
                        const { pauseCommand } = await Promise.resolve().then(() => require('./hive-mind/pause.js'));
                        await pauseCommand.parseAsync(process.argv.slice(3));
                        break;
                    case "resume":
                        const { resumeCommand } = await Promise.resolve().then(() => require('./hive-mind/resume.js'));
                        await resumeCommand.parseAsync(process.argv.slice(3));
                        break;
                    case "ps":
                        const { psCommand } = await Promise.resolve().then(() => require('./hive-mind/ps.js'));
                        await psCommand.parseAsync(process.argv.slice(3));
                        break;
                    case "wizard":
                    default:
                        const { wizardCommand } = await Promise.resolve().then(() => require('./hive-mind/wizard.js'));
