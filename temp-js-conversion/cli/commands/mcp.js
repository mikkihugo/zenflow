...
exports.mcpCommand = new command_1.Command()
    ...
    .command('stop', new command_1.Command()
    ...
    .command('status', new command_1.Command()
    ...
    .command('tools', new command_1.Command()
    ...
    .command('config', new command_1.Command()
    ...
    .command('restart', new command_1.Command()
