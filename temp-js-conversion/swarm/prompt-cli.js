...
program
    ...
    try {
        ...
        const copyFunction = options.enhanced ? prompt_copier_enhanced_js_1.copyPromptsEnhanced : prompt_copier_enhanced_js_1.copyPrompts;
...
program
    ...
    try {
        const { PromptCopier } = await Promise.resolve().then(() => require('./prompt-copier.js'));
