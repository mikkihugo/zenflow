...
exports.createIsolatedCache = createIsolatedCache;
exports.getIsolatedNpxEnv = getIsolatedNpxEnv;
...
function createIsolatedCache() {
    ...
    const cacheDir = path_1.default.join(os_1.default.tmpdir(), '.npm-cache', cacheName);
    // Track for cleanup
 ...
 */
function getIsolatedNpxEnv(additionalEnv = {}) {
