...
async function initializeTaskManagement(config = {}) {
    ...
    const { TaskEngine } = await Promise.resolve().then(() => require('./engine.js'));
    const { TaskCoordinator } = await Promise.resolve().then(() => require('./coordination.js'));
    const { createTaskCreateCommand, createTaskListCommand, createTaskStatusCommand, createTaskCancelCommand, createTaskWorkflowCommand } = await Promise.resolve().then(() => require('./commands.js'));
