...
class ClaudeCodeMCPWrapper {
    constructor() {
        this.sparcModes = new Map();
        this.swarmExecutions = new Map();
    ...
    async handleSparcTool(toolName, args) {
        ...
        try {
            ...
            const executeSparcMode = (mode, task, tools, context) => {
...
Use the appropriate tools for each phase and maintain progress in TodoWrite.`;
    ...
    planSwarmAgents(objective, strategy, maxAgents) {
        ...
        switch (strategy) {
            case 'research':
                agents.push({ id: generateId(), mode: 'researcher', task: `Research: ${objective}`, status: 'pending' }, { id: generateId(), mode: 'analyst', task: `Analyze findings for: ${objective}`, status: 'pending' }, { id: generateId(), mode: 'documenter', task: `Document research results: ${objective}`, status: 'pending' });
                break;
            case 'development':
                agents.push({ id: generateId(), mode: 'architect', task: `Design architecture: ${objective}`, status: 'pending' }, { id: generateId(), mode: 'coder', task: `Implement: ${objective}`, status: 'pending' }, { id: generateId(), mode: 'tester', task: `Test implementation: ${objective}`, status: 'pending' }, { id: generateId(), mode: 'reviewer', task: `Review code: ${objective}`, status: 'pending' });
                break;
            case 'analysis':
                agents.push({ id: generateId(), mode: 'analyst', task: `Analyze: ${objective}`, status: 'pending' }, { id: generateId(), mode: 'optimizer', task: `Optimize based on analysis: ${objective}`, status: 'pending' });
                break;
            case 'testing':
                agents.push({ id: generateId(), mode: 'tester', task: `Create test suite: ${objective}`, status: 'pending' }, { id: generateId(), mode: 'debugger', task: `Debug issues: ${objective}`, status: 'pending' });
                break;
            case 'optimization':
                agents.push({ id: generateId(), mode: 'analyst', task: `Performance analysis: ${objective}`, status: 'pending' }, { id: generateId(), mode: 'optimizer', task: `Optimize: ${objective}`, status: 'pending' });
                break;
            case 'maintenance':
                agents.push({ id: generateId(), mode: 'reviewer', task: `Code review: ${objective}`, status: 'pending' }, { id: generateId(), mode: 'debugger', task: `Fix issues: ${objective}`, status: 'pending' }, { id: generateId(), mode: 'documenter', task: `Update documentation: ${objective}`, status: 'pending' });
                break;
        }
        // Limit to maxAgents
