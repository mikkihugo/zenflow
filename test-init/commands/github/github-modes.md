...
mcp__claude-zen__agent_spawn { type: "coordinator", name: "GitHub Coordinator" }
mcp__claude-zen__agent_spawn { type: "reviewer", name: "Code Reviewer" }
mcp__claude-zen__agent_spawn { type: "tester", name: "QA Agent" }

// Execute GitHub workflow with coordination
mcp__claude-zen__task_orchestrate { task: "GitHub workflow", strategy: "parallel" }
```