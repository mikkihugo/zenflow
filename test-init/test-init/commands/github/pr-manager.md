...
mcp__claude-zen__agent_spawn { type: "tester", name: "Testing Agent" }
mcp__claude-zen__agent_spawn { type: "coordinator", name: "PR Coordinator" }
...
[Single Message - Complete PR Management]:
  ...
  mcp__claude-zen__agent_spawn { type: "coordinator", name: "Merge Coordinator" }
