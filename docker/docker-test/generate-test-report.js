...
function generateTestReport() {
  ...
  for (const version of versions) {
    ...
    console.warn(`${statusIcon} Node.js ${version}: ${envResult.status}`);

    if (envResult.testResults) {
      console.warn(
        `   Tests: ${envResult.testResults.numPassedTests}/${envResult.testResults.numTotalTests} passed`
      );
      console.warn(
        `   Suites: ${envResult.testResults.numPassedTestSuites}/${envResult.testResults.numTotalTestSuites} passed`
      );
    }
