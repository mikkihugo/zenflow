...
This directory contains specialized swarm coordination agents designed to work with the claude-zen hive-mind system. Each agent implements a different coordination topology and strategy.
