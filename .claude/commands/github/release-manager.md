...
- `mcp__claude-zen__*` (all swarm coordination tools)
...
mcp__claude-zen__swarm_init { topology: "hierarchical", maxAgents: 6 }
mcp__claude-zen__agent_spawn { type: "coordinator", name: "Release Coordinator" }
mcp__claude-zen__agent_spawn { type: "tester", name: "QA Engineer" }
mcp__claude-zen__agent_spawn { type: "reviewer", name: "Release Reviewer" }
mcp__claude-zen__agent_spawn { type: "coder", name: "Version Manager" }
mcp__claude-zen__agent_spawn { type: "analyst", name: "Deployment Analyst" }
...
[Single Message - Complete Release Management]:
  ...
  mcp__claude-zen__swarm_init { topology: "star", maxAgents: 8 }
  mcp__claude-zen__agent_spawn { type: "coordinator", name: "Release Director" }
  mcp__claude-zen__agent_spawn { type: "tester", name: "QA Lead" }
  mcp__claude-zen__agent_spawn { type: "reviewer", name: "Senior Reviewer" }
  mcp__claude-zen__agent_spawn { type: "coder", name: "Version Controller" }
  mcp__claude-zen__agent_spawn { type: "analyst", name: "Performance Analyst" }
  mcp__claude-zen__agent_spawn { type: "researcher", name: "Compatibility Checker" }
  ...
  release-validation:
    ...
    steps:
      ...
      - name: Validate Release
        run: npx claude-zen release validate
```
