...
async function testAIProviderSelection() {
  ...
  console.log('Command: node scripts/ai-eslint/zen-ai-fixer-complete.js --phase=compile --ai=gemini --dry-run');
  ...
  console.log('\n# Test Gemini:');
  console.log('node scripts/ai-eslint/zen-ai-fixer-complete.js --phase=eslint --ai=gemini --quick --dry-run');
