...
export const CLAUDE_ZEN_SCHEMA = {
  ...
  visions: {
    description: '🎯 Strategic product visions with phases, ROI, and approval status',
    category: 'strategy',
    args: [],
    options: {
      status: { 
        ...
        description: 'Filter by vision status'
      },
      priority: { 
        type: 'string', 
        choices: ['low', 'medium', 'high', 'critical'],
        description: 'Filter by vision priority'
      },
      category: { 
        type: 'string', 
        description: 'Filter by vision category (AI/ML, Blockchain, etc.)'
      }
    },
    interfaces: {
    ...
    storage: 'visions',
    hierarchy: 'strategic',
    description_extended: 'Strategic visions define high-level product direction with phases, ROI projections, and approval workflows'
  },
