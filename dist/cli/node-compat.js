/**
 * Node.js compatibility layer for node APIs
 * This module provides Node.js equivalents for node-specific APIs
 */
...
// Build information (Node.js equivalent of process.build)
export const build = {
...
// Export a node-like object for easier migration
export const node = {
  args,
  cwd,
  readDir,
