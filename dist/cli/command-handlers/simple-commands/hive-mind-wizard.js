...
async function runInteractiveWizard() {
  ...
  try {
    ...
    if (result.success) {
      ...
      console.log(chalk.gray('  • View status: claude-zen hive-mind status'));
      console.log(chalk.gray('  • Monitor progress: claude-zen hive-mind metrics'));
      console.log(chalk.gray('  • Create another swarm: claude-zen hive-mind wizard'));
      console.log(chalk.gray('  • Learn more: claude-zen help hive-mind\n'));
    ...
    console.log(chalk.gray('You can try manual setup with: claude-zen hive-mind init'));
  }
}
