...
async function listTasks(subArgs, flags) {
  ...
  if (verbose) {
    console.log('\nTo create tasks:');
    console.log('  claude-zen task create research "Market analysis"');
    console.log('  claude-zen task create code "Implement API"');
    console.log('  claude-zen task create analysis "Data processing"');
  }
}
...
function showTaskHelp() {
  ...
  console.log('  claude-zen task create research "Market analysis" --priority 8');
  console.log('  claude-zen task list --filter running');
  console.log('  claude-zen task workflow examples/development-workflow.json');
  console.log('  claude-zen task coordination status');
}
