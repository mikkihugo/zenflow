# Claude Code Configuration for Claude Zen
...
1. **MCP**: `mcp__claude-zen__swarm_init` (coordination setup)
2. **MCP**: `mcp__claude-zen__agent_spawn` (planning agents)
3. **MCP**: `mcp__claude-zen__task_orchestrate` (task coordination)
...
7. **MCP**: `mcp__claude-zen__memory_usage` (store results)

**❌ WRONG Workflow:**

1. **MCP**: `mcp__claude-zen__terminal_execute` (DON'T DO THIS)
...
- Use `mcp__claude-zen__agent_spawn` tool to create specialized coordinators
- Agent types represent different thinking patterns, not actual coders
- They help Claude Code approach problems from different angles

**Orchestrate tasks:**

- Use `mcp__claude-zen__task_orchestrate` tool to coordinate complex workflows
...
- `mcp__claude-zen__swarm_init` - Set up coordination topology for Claude Code
- `mcp__claude-zen__agent_spawn` - Create cognitive patterns to guide Claude Code
- `mcp__claude-zen__task_orchestrate` - Break down and coordinate complex tasks

### Monitoring Tools:

- `mcp__claude-zen__swarm_status` - Monitor coordination effectiveness
- `mcp__claude-zen__agent_list` - View active cognitive patterns
- `mcp__claude-zen__agent_metrics` - Track coordination performance
- `mcp__claude-zen__task_status` - Check workflow progress
- `mcp__claude-zen__task_results` - Review coordination outcomes

### Memory & Neural Tools:

- `mcp__claude-zen__memory_usage` - Persistent memory across sessions
- `mcp__claude-zen__neural_status` - Neural pattern effectiveness
- `mcp__claude-zen__neural_train` - Improve coordination patterns
- `mcp__claude-zen__neural_patterns` - Analyze thinking approaches

### GitHub Integration Tools (NEW!):

- `mcp__claude-zen__github_swarm` - Create specialized GitHub management swarms
- `mcp__claude-zen__repo_analyze` - Deep repository analysis with AI
- `mcp__claude-zen__pr_enhance` - AI-powered pull request improvements
- `mcp__claude-zen__issue_triage` - Intelligent issue classification
- `mcp__claude-zen__code_review` - Automated code review with swarms

### System Tools:

- `mcp__claude-zen__benchmark_run` - Measure coordination efficiency
...
2. Each agent MUST use Claude Flow hooks for coordination:
   - `npx claude-zen@alpha hooks pre-task` before starting
   - `npx claude-zen@alpha hooks post-edit` after each file operation
   - `npx claude-zen@alpha hooks post-edit` to track progress
...
- Tool: `mcp__claude-zen__github_swarm`
...
1. **Check CLI Arguments First**: If user runs `npx claude-zen@alpha --agents 5`, use 5 agents
...
```javascript
// If CLI args provided: npx claude-zen@alpha --agents 6
...
npx claude-zen@alpha hooks pre-task --description "[agent task]" --auto-spawn-agents false
npx claude-zen@alpha memory query "[session context]" --namespace "swarm-[id]"
```
...
npx claude-zen@alpha hooks post-edit --file "[filepath]" --memory-key "swarm/[agent]/[step]"

# Store decisions and findings
npx claude-zen@alpha hooks post-edit --file "[filepath]" --memory-key "progress/[step]"

# Check coordination with other agents
npx claude-zen@alpha memory query "[what to check]" --namespace "swarm-[id]"
```
...
npx claude-zen@alpha hooks post-task --task-id "[task]" --analyze-performance true
npx claude-zen@alpha hooks session-end --export-metrics true --generate-summary true
```
...
1. START: Run `npx claude-zen@alpha hooks pre-task --description "[your task]"`
2. DURING: After EVERY file operation, run `npx claude-zen@alpha hooks post-edit --file "[file]" --memory-key "agent/[step]"`
3. MEMORY: Store ALL decisions using `npx claude-zen@alpha hooks post-task --task-id "[task]"`
4. END: Run `npx claude-zen@alpha hooks post-task --task-id "[task]" --analyze-performance true`
...
Message 1: [BatchTool]
  ...
  - mcp__claude-zen__agent_spawn (researcher)
  - mcp__claude-zen__agent_spawn (coder)
  - mcp__claude-zen__agent_spawn (analyst)
...
[BatchTool]:
  ...
  - mcp__claude-zen__agent_spawn { type: "architect", name: "System Designer" }
  - mcp__claude-zen__agent_spawn { type: "coder", name: "API Developer" }
  - mcp__claude-zen__agent_spawn { type: "coder", name: "Frontend Dev" }
  - mcp__claude-zen__agent_spawn { type: "analyst", name: "DB Designer" }
  - mcp__claude-zen__agent_spawn { type: "tester", name: "QA Engineer" }
  - mcp__claude-zen__agent_spawn { type: "researcher", name: "Tech Lead" }
  - mcp__claude-zen__agent_spawn { type: "coordinator", name: "PM" }
  - TodoWrite { todos: [multiple todos at once] }

STEP 2: PARALLEL TASK EXECUTION (Single Message!)
[BatchTool]:
  - mcp__claude-zen__task_orchestrate { task: "main task", strategy: "parallel" }
  - mcp__claude-zen__memory_usage { action: "store", key: "init", value: {...} }
...
[BatchTool - Message 1]:
  ...
  mcp__claude-zen__swarm_init { topology: "hierarchical", maxAgents: 8, strategy: "parallel" }
  mcp__claude-zen__agent_spawn { type: "architect", name: "System Designer" }
  mcp__claude-zen__agent_spawn { type: "coder", name: "API Developer" }
  mcp__claude-zen__agent_spawn { type: "coder", name: "Auth Expert" }
  mcp__claude-zen__agent_spawn { type: "analyst", name: "DB Designer" }
  mcp__claude-zen__agent_spawn { type: "tester", name: "Test Engineer" }
  mcp__claude-zen__agent_spawn { type: "coordinator", name: "Lead" }
  ...
  // Start orchestration
  mcp__claude-zen__task_orchestrate { task: "Build REST API", strategy: "parallel" }

  // Store initial memory
  mcp__claude-zen__memory_usage { action: "store", key: "project/init", value: { started: Date.now() } }
...
Message 1: mcp__claude-zen__swarm_init
Message 2: mcp__claude-zen__agent_spawn (just one agent)
Message 3: mcp__claude-zen__agent_spawn (another agent)
Message 4: TodoWrite (single todo)
...
4. **Monitor Progress**: Use mcp**claude-zen**swarm_monitor for real-time tracking
...
- Issues: https://github.com/ruvnet/claude-zen/issues
- Examples: https://github.com/ruvnet/claude-zen/tree/main/examples

---

Remember: **Claude Flow coordinates, Claude Code creates!** Start with `mcp__claude-zen__swarm_init` to enhance your development workflow.
