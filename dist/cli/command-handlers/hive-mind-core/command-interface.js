...
export function parseHiveMindArgs(args, rawFlags) {
  const parsedFlags = parseFlags(rawFlags);
  const flagsWithDefaults = { 
    ...
    ...parsedFlags // Apply parsed flags after defaults
  };

  // Simple validation (simplified)
  if (flagsWithDefaults.workers < 1 || flagsWithDefaults.workers > 32) {
